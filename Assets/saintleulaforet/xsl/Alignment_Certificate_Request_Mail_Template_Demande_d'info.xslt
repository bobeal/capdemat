				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block-container position="absolute" top="12cm" left="3.12cm" height="15.0cm" width="15.0cm">
						...
						<fo:block space-after.optimum="12.0pt" text-align="justify" font-size="12.0pt" font-family="serif">
							...
							pour vous informer que j'ai besoin d'information complémentaire pour traiter votre requête :
						</fo:block>
						...
						<fo:block space-after.optimum="12.0pt" text-align="justify" font-size="12.0pt" font-family="serif">
							...
							<fo:basic-link color="blue">
							 ...
							 ou par courrier à la Direction de l'urbanisme et de l'aménagement. Dans tous 
							les cas, veuillez rappeler le numéro de votre demande.
						</fo:block>											
						<fo:block space-after.optimum="12.0pt" text-align="justify" font-size="12.0pt" font-family="serif">
							A défaut de réception de ce document dans un délai de deux mois, votre demande serait considérée sans suite.
						</fo:block>
