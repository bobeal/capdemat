			...
			<fo:page-sequence master-reference="Section1-ps">
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block-container position="absolute" top="12cm" left="3.12cm" height="15.0cm" width="15.0cm">
						...
						<fo:block space-after.optimum="12.0pt" text-align="justify" font-size="12.0pt" font-family="serif">
							Pour une bonne gestion des commandes de repas, toute annulation doit être signalée le plus rapidement possible en mairie en appelant au 01 30 40 22 00. A défaut, le repas commandé vous sera facturé sauf sur production d'un certificat médical.
						</fo:block>
