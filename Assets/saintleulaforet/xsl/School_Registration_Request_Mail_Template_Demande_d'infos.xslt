				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block-container position="absolute" top="12cm" left="3.12cm" height="15.0cm" width="15.0cm">
						...
						<fo:block space-after.optimum="12.0pt" text-align="justify" font-size="12.0pt" font-family="serif">
							...
							pour vous informer que j'ai besoin d'informations complémentaires pour la traiter :
						</fo:block>
						...
						<fo:block space-after.optimum="12.0pt" text-align="justify" font-size="12.0pt" font-family="serif">
							...
							<fo:basic-link color="blue">
								<xsl:attribute name="external-destination">url("mailto:dej@saint-leu-la-foret.fr?subject=<xsl:for-each select="//cert:type_demande">
										<xsl:apply-templates />
									</xsl:for-each> - <xsl:for-each select="//cert:numero_demande">
										<xsl:apply-templates />
									</xsl:for-each>
								")</xsl:attribute>
								dej@saint-leu-la-foret.fr
							</fo:basic-link>
							 ou par courrier à la Direction de l'éducation et de la jeunesse, pôle scolaire. Dans tous 
