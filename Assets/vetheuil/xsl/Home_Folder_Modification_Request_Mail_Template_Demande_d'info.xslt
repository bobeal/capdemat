				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block-container position="absolute" top="6.5cm" left="0cm" height="2.5cm" width="14.0cm">
						...
						<fo:block font-size="11.0pt" font-family="serif">
							...
							: Demande de modification de compte foyer
						</fo:block>
						<fo:block font-size="11.0pt" font-family="serif">
					...
					<fo:block-container position="absolute" top="10cm" left="1cm" height="15.0cm" width="16cm">
						...
						<fo:block space-after.optimum="12.0pt" text-align="justify" font-size="12.0pt" font-family="serif">
							...
							pour vous informer que j'ai besoin d’informations complémentaires pour traiter votre requête :
						</fo:block>
						...
						<fo:block space-after.optimum="12.0pt" text-align="justify" font-size="12.0pt" font-family="serif">
							...
							<fo:basic-link color="blue">
								<xsl:attribute name="external-destination">url("mailto:mairiedevetheuil@orange.fr?subject=<xsl:for-each select="//cert:type_demande">
										<xsl:apply-templates />
									</xsl:for-each> - <xsl:for-each select="//cert:numero_demande">
										<xsl:apply-templates />
									</xsl:for-each>
								")</xsl:attribute>
								mairiedevetheuil@orange.fr
							</fo:basic-link>
							 ou par courrier à la mairie. Dans tous 
