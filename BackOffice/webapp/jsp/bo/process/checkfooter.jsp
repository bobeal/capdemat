...
<div class="grid_cell grid_column_right">
  <div class="block006">
    <p class="text004 pictoInformation">Suivi des tâches</p>
  </div>

  <div class="block007">
    <cvq:displayTasks name="stateManager" property="selectedRecord.tasks.all" scope="session"/>
  </div>
</div>
...
<div class="grid_cell grid_column_left">
  ...
  <div class="block005">
    <fieldset class="fieldset006">
      ...
      <div class="form_cell">
        <span class="input">
          <cvq:textarea name="stateManager" property="selectedRecord.instructionExternal" id="instructionExternal" rows="5" cols="50" styleClass="input_textarea" profile="profile" />
        </span>
      </div>
      <div class="form_cell form_cell003">
        <span class="input_button">
...
<div class="grid_cell grid_column_right">
  ...
  <div class="block007">
    <fieldset class="fieldset003">
      <div class="form_cell">
        <span class="input">
          <cvq:textarea name="stateManager" property="selectedRecord.instructionInternal" id="instructionInternal" rows="5" cols="20" styleClass="input_textarea" profile="profile"/>
        </span>
      </div>
      <div class="form_cell form_cell003">
        <span class="input">
