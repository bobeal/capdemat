 ...
 <div class="grid_cell">
   ...
   <div class="block010">
     <fieldset class="fieldset005">
         ...
         <label for="certificate" class="label">Nature de l'acte :</label>
         <span class="input">
   
    

    	 <cvq:toggleInput name="record" property="certificate" id="id" profile="profile"/>
    	</span>
       </div>
           <div class="form_cell form_cell1">
...
<script type="text/javascript">
	function selectionData() {
              		this.certificate = new Function("key","this.values=new Array('Naissance','Mariage','Décès'); return this[key];");
