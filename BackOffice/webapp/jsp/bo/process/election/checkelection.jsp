 ...
 <div class="grid_cell">
      <fieldset class="fieldset004">
         ...
         <span class="input">
          	 ...
          	 <cvq:input name="record" property="electoralNumber" scope="page" type="text"
         ...
         <span class="input">
          	 ...
          	 <cvq:input name="record" property="pollingStation" scope="page" type="text"
	     styleClass="saisie" profile="profile"/>
         ...
         <span class="input">
          	 ...
          	 <cvq:input name="record" property="pollingSchoolName" scope="page" type="text"
	     styleClass="saisie" profile="profile"/>
