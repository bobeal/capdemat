     ...
     <fieldset class="fieldset005">
       ...
       <div class="form_cell form_cell1">
		...
		<cvq:toggleInput name="record" property="subjectIndividualAddressCity" id="id" profile="profile" />
         ...
         <label for="activity" class="label">Activités :</label>
         <span class="input">
   
    

    	 <cvq:toggleInput name="record" property="activity" id="id" profile="profile"/>
    	</span>
       </div>
           <div class="form_cell form_cell1">
...
<script type="text/javascript">
	function selectionData() {
                            		this.activity = new Function("key","this.multiple=true;this.values=new Array(); return this[key];");
