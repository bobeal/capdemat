 ...
 <div class="grid_cell">
      <fieldset class="fieldset004">
         ...
         <span class="input">
                   ...
                   <cvq:referenceSelect name="record" property="list(recreationcenters)" value="recreationCenterName" 
             scope="page" id="recreationCenterName" styleClass="saisie2" profile="profile"/>
