 ...
 <div class="grid_cell">
   ...
   <div class="block010">
     <fieldset class="fieldset005">
    	 ...
    	 <cvq:toggleInput name="record" property="perischoolActivity" id="id" profile="profile"/>
    	</span>
       </div>
           <div class="form_cell form_cell1">
...
<script type="text/javascript">
	function selectionData() {
                                        		this.perischoolActivity = new Function("key","this.multiple=true;this.values=new Array(); return this[key];");
