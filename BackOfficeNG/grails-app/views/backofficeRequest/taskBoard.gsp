<html>
  <head>
    ...
    <link rel="stylesheet" href="${resource(dir:'css/backoffice',file:'taskBoard.css')}" />
    <script type="text/javascript" src="${resource(dir:'js/backoffice',file:'requestTaskBoard.js')}"></script>
  </head>
  <body>
    <div id="yui-main">
      <div class="yui-b">
