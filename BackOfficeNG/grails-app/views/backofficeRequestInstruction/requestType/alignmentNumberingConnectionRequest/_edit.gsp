      ...
      <div id="page1">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required">${message(code:'ancr.property.isAlignment.label')} * :</dt><dd id="isAlignment" class="action-editField validate-boolean required-true i18n-ancr.property.isAlignment" ><span class="value-${rqt?.isAlignment}"><g:message code="message.${rqt?.isAlignment ? 'yes' : 'no'}" /></span></dd>
              </dl>
              
            
              
              <dl>
                <dt class="required">${message(code:'ancr.property.isNumbering.label')} * :</dt><dd id="isNumbering" class="action-editField validate-boolean required-true i18n-ancr.property.isNumbering" ><span class="value-${rqt?.isNumbering}"><g:message code="message.${rqt?.isNumbering ? 'yes' : 'no'}" /></span></dd>
              </dl>
              
            
              
              <dl>
                <dt class="required">${message(code:'ancr.property.isConnection.label')} * :</dt><dd id="isConnection" class="action-editField validate-boolean required-true i18n-ancr.property.isConnection" ><span class="value-${rqt?.isConnection}"><g:message code="message.${rqt?.isConnection ? 'yes' : 'no'}" /></span></dd>
              </dl>
          ...
          <div class="yui-u">
              ...
              <dl>
                <dt class="required">${message(code:'ancr.property.moreThanTwoYears.label')} * :</dt><dd id="moreThanTwoYears" class="action-editField validate-boolean required-true i18n-ancr.property.moreThanTwoYears" ><span class="value-${rqt?.moreThanTwoYears}"><g:message code="message.${rqt?.moreThanTwoYears ? 'yes' : 'no'}" /></span></dd>
              </dl>
