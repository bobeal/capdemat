      ...
      <div id="page2">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class=""><g:message code="ddr.property.comment.label" />  : </dt><dd id="comment" class="action-editField validate-regex i18n-ddr.property.comment rows-3" regex="^.{0,255}$"><span>${rqt?.comment}</span></dd>
              </dl>
