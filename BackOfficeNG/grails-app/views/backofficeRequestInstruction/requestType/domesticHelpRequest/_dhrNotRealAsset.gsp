  ...
  <dl class="required">
      ...
      <dd id="dhrNotRealAsset[${listSize - 1 - index}].dhrNotRealAssetAddress" class="action-editField validate-address required-true i18n-dhr.property.dhrNotRealAssetAddress" >
        <div><p class="additionalDeliveryInformation">${it?.dhrNotRealAssetAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${it?.dhrNotRealAssetAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${it?.dhrNotRealAssetAddress?.streetNumber}</span> <span class="streetName">${it?.dhrNotRealAssetAddress?.streetName}</span><g:if test="${!!it?.dhrNotRealAssetAddress?.streetMatriculation}"><br /><em><g:message code="address.property.streetMatriculation" /></em><span class="streetMatriculation">${it?.dhrNotRealAssetAddress?.streetMatriculation}</span></g:if><p class="placeNameOrService">${it?.dhrNotRealAssetAddress?.placeNameOrService}</p><span class="postalCode">${it?.dhrNotRealAssetAddress?.postalCode}</span> <span class="city">${it?.dhrNotRealAssetAddress?.city}</span><p class="countryName">${it?.dhrNotRealAssetAddress?.countryName}</p><g:if test="${!!it?.dhrNotRealAssetAddress?.cityInseeCode}"><em><g:message code="address.property.cityInseeCode" /></em><span class="cityInseeCode">${it?.dhrNotRealAssetAddress?.cityInseeCode}</span></g:if></div>
      </dd>
      ...
      <dd id="dhrNotRealAsset[${listSize - 1 - index}].dhrNotRealAssetNotaryAddress" class="action-editField validate-address required-true i18n-dhr.property.dhrNotRealAssetNotaryAddress" >
        <div><p class="additionalDeliveryInformation">${it?.dhrNotRealAssetNotaryAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${it?.dhrNotRealAssetNotaryAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${it?.dhrNotRealAssetNotaryAddress?.streetNumber}</span> <span class="streetName">${it?.dhrNotRealAssetNotaryAddress?.streetName}</span><g:if test="${!!it?.dhrNotRealAssetNotaryAddress?.streetMatriculation}"><br /><em><g:message code="address.property.streetMatriculation" /></em><span class="streetMatriculation">${it?.dhrNotRealAssetNotaryAddress?.streetMatriculation}</span></g:if><p class="placeNameOrService">${it?.dhrNotRealAssetNotaryAddress?.placeNameOrService}</p><span class="postalCode">${it?.dhrNotRealAssetNotaryAddress?.postalCode}</span> <span class="city">${it?.dhrNotRealAssetNotaryAddress?.city}</span><p class="countryName">${it?.dhrNotRealAssetNotaryAddress?.countryName}</p><g:if test="${!!it?.dhrNotRealAssetNotaryAddress?.cityInseeCode}"><em><g:message code="address.property.cityInseeCode" /></em><span class="cityInseeCode">${it?.dhrNotRealAssetNotaryAddress?.cityInseeCode}</span></g:if></div>
      </dd>
