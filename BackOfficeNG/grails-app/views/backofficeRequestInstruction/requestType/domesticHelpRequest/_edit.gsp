        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl class="required">
                  ...
                  <dt class="required condition-haveFamilyReferent-filled"><g:message code="dhr.property.dhrReferentAddress.label" /> * : </dt><dd id="dhrReferentAddress" class="action-editField validate-address required-true i18n-dhr.property.dhrReferentAddress" ><div><p class="additionalDeliveryInformation">${rqt?.dhrReferentAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${rqt?.dhrReferentAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${rqt?.dhrReferentAddress?.streetNumber}</span> <span class="streetName">${rqt?.dhrReferentAddress?.streetName}</span><g:if test="${!!rqt?.dhrReferentAddress?.streetMatriculation}"><br /><em><g:message code="address.property.streetMatriculation" /></em><span class="streetMatriculation">${rqt?.dhrReferentAddress?.streetMatriculation}</span></g:if><p class="placeNameOrService">${rqt?.dhrReferentAddress?.placeNameOrService}</p><span class="postalCode">${rqt?.dhrReferentAddress?.postalCode}</span> <span class="city">${rqt?.dhrReferentAddress?.city}</span><p class="countryName">${rqt?.dhrReferentAddress?.countryName}</p><g:if test="${!!rqt?.dhrReferentAddress?.cityInseeCode}"><em><g:message code="address.property.cityInseeCode" /></em><span class="cityInseeCode">${rqt?.dhrReferentAddress?.cityInseeCode}</span></g:if></div></dd>
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl class="required condition-isCoupleRequest-filled">
                  ...
                  <dt class="required condition-isSpouseRetired-unfilled"><g:message code="dhr.property.dhrSpouseAddress.label" /> * : </dt><dd id="dhrSpouseAddress" class="action-editField validate-address required-true i18n-dhr.property.dhrSpouseAddress" ><div><p class="additionalDeliveryInformation">${rqt?.dhrSpouseAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${rqt?.dhrSpouseAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${rqt?.dhrSpouseAddress?.streetNumber}</span> <span class="streetName">${rqt?.dhrSpouseAddress?.streetName}</span><g:if test="${!!rqt?.dhrSpouseAddress?.streetMatriculation}"><br /><em><g:message code="address.property.streetMatriculation" /></em><span class="streetMatriculation">${rqt?.dhrSpouseAddress?.streetMatriculation}</span></g:if><p class="placeNameOrService">${rqt?.dhrSpouseAddress?.placeNameOrService}</p><span class="postalCode">${rqt?.dhrSpouseAddress?.postalCode}</span> <span class="city">${rqt?.dhrSpouseAddress?.city}</span><p class="countryName">${rqt?.dhrSpouseAddress?.countryName}</p><g:if test="${!!rqt?.dhrSpouseAddress?.cityInseeCode}"><em><g:message code="address.property.cityInseeCode" /></em><span class="cityInseeCode">${rqt?.dhrSpouseAddress?.cityInseeCode}</span></g:if></div></dd>
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl class="required">
                  ...
                  <dt class="required"><g:message code="dhr.property.dhrCurrentDwellingAddress.label" /> * : </dt><dd id="dhrCurrentDwellingAddress" class="action-editField validate-address required-true i18n-dhr.property.dhrCurrentDwellingAddress" ><div><p class="additionalDeliveryInformation">${rqt?.dhrCurrentDwellingAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${rqt?.dhrCurrentDwellingAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${rqt?.dhrCurrentDwellingAddress?.streetNumber}</span> <span class="streetName">${rqt?.dhrCurrentDwellingAddress?.streetName}</span><g:if test="${!!rqt?.dhrCurrentDwellingAddress?.streetMatriculation}"><br /><em><g:message code="address.property.streetMatriculation" /></em><span class="streetMatriculation">${rqt?.dhrCurrentDwellingAddress?.streetMatriculation}</span></g:if><p class="placeNameOrService">${rqt?.dhrCurrentDwellingAddress?.placeNameOrService}</p><span class="postalCode">${rqt?.dhrCurrentDwellingAddress?.postalCode}</span> <span class="city">${rqt?.dhrCurrentDwellingAddress?.city}</span><p class="countryName">${rqt?.dhrCurrentDwellingAddress?.countryName}</p><g:if test="${!!rqt?.dhrCurrentDwellingAddress?.cityInseeCode}"><em><g:message code="address.property.cityInseeCode" /></em><span class="cityInseeCode">${rqt?.dhrCurrentDwellingAddress?.cityInseeCode}</span></g:if></div></dd>
