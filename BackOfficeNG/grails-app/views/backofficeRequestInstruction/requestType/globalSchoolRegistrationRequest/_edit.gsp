      ...
      <div id="page0">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required condition-estDerogation-trigger">${message(code:'gsrr.property.estDerogation.label')}&nbsp;*&nbsp;:</dt><dd id="estDerogation" class="action-editField validate-boolean required-true i18n-gsrr.property.estDerogation" ><span class="value-${rqt?.estDerogation}"><g:message code="${rqt?.estDerogation ? 'message.yes' : rqt?.estDerogation==null ? '' : 'message.no'}" /></span></dd>
              </dl>
      ...
      <div id="page1">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required">${message(code:'gsrr.property.estRestauration.label')}&nbsp;*&nbsp;:</dt><dd id="estRestauration" class="action-editField validate-boolean required-true i18n-gsrr.property.estRestauration" ><span class="value-${rqt?.estRestauration}"><g:message code="${rqt?.estRestauration ? 'message.yes' : rqt?.estRestauration==null ? '' : 'message.no'}" /></span></dd>
              </dl>
