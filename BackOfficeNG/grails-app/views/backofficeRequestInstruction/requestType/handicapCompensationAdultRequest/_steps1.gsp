  ...
  <div class="yui-g">
    ...
    <div class="yui-u">
        ...
        <dl class="required">
              ...
              <dt class="required condition-isDisabilityRecognition-filled"><g:message code="hcar.property.benefitsDisabilityRatio.label" /> * : </dt><dd id="benefitsDisabilityRatio" class="action-editField validate- required-true i18n-hcar.property.benefitsDisabilityRatio maxLength-3" ><span>${rqt?.benefitsDisabilityRatio}</span></dd>
              ...
              <dt class="required"><g:message code="hcar.property.benefitsParkingCard.label" /> * : </dt><dd id="benefitsParkingCard" class="action-editField validate-boolean required-true i18n-hcar.property.benefitsParkingCard" ><span class="value-${rqt?.benefitsParkingCard}"><g:message code="message.${rqt?.benefitsParkingCard ? 'yes' : 'no'}" /></span></dd>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u">
        ...
        <dl class="required">
              ...
              <dt class="required condition-isHousing-filled"><g:message code="hcar.property.facilitiesHousingDetails.label" /> * : </dt><dd id="facilitiesHousingDetails" class="action-editField validate- required-true i18n-hcar.property.facilitiesHousingDetails maxLength-60" ><span>${rqt?.facilitiesHousingDetails}</span></dd>
              ...
              <dt class="required condition-isCustomCar-filled"><g:message code="hcar.property.facilitiesCustomCarDetails.label" /> * : </dt><dd id="facilitiesCustomCarDetails" class="action-editField validate- required-true i18n-hcar.property.facilitiesCustomCarDetails maxLength-60" ><span>${rqt?.facilitiesCustomCarDetails}</span></dd>
              ...
              <dt class="required condition-isAnimalAid-filled"><g:message code="hcar.property.facilitiesAnimalAidDetails.label" /> * : </dt><dd id="facilitiesAnimalAidDetails" class="action-editField validate- required-true i18n-hcar.property.facilitiesAnimalAidDetails maxLength-60" ><span>${rqt?.facilitiesAnimalAidDetails}</span></dd>
        ...
        <dl class="required">
              ...
              <dt class="required condition-isSocialServiceSupport-filled"><g:message code="hcar.property.professionalSupportSocialServiceAddress.label" /> * : </dt><dd id="professionalSupportSocialServiceAddress" class="action-editField validate-address required-true i18n-hcar.property.professionalSupportSocialServiceAddress" ><div><p class="additionalDeliveryInformation">${rqt?.professionalSupportSocialServiceAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${rqt?.professionalSupportSocialServiceAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${rqt?.professionalSupportSocialServiceAddress?.streetNumber}</span> <span class="streetName">${rqt?.professionalSupportSocialServiceAddress?.streetName}</span><g:if test="${!!rqt?.professionalSupportSocialServiceAddress?.streetMatriculation}"><p class="streetMatriculation">Matricule: ${rqt?.professionalSupportSocialServiceAddress?.streetMatriculation}</p></g:if><p class="streetMatriculation">Matricule: ${rqt?.professionalSupportSocialServiceAddress?.streetMatriculation}</p><p class="placeNameOrService">${rqt?.professionalSupportSocialServiceAddress?.placeNameOrService}</p><span class="postalCode">${rqt?.professionalSupportSocialServiceAddress?.postalCode}</span> <span class="city">${rqt?.professionalSupportSocialServiceAddress?.city}</span><p class="countryName">${rqt?.professionalSupportSocialServiceAddress?.countryName}</p><g:if test="${!!rqt?.professionalSupportSocialServiceAddress?.cityInseeCode}"><p class="cityInseeCode">INSEE: ${rqt?.professionalSupportSocialServiceAddress?.cityInseeCode}</p></g:if></div></dd>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl class="required">
              ...
              <dt class="required condition-isFollowedByDoctor-filled"><g:message code="hcar.property.healthDoctorLastName.label" /> * : </dt><dd id="healthDoctorLastName" class="action-editField validate-lastName required-true i18n-hcar.property.healthDoctorLastName maxLength-38" ><span>${rqt?.healthDoctorLastName}</span></dd>
          
              <dt class="required condition-isFollowedByDoctor-filled"><g:message code="hcar.property.healthDoctorFirstName.label" /> * : </dt><dd id="healthDoctorFirstName" class="action-editField validate-firstName required-true i18n-hcar.property.healthDoctorFirstName maxLength-38" ><span>${rqt?.healthDoctorFirstName}</span></dd>
              ...
              <dt class="required condition-isFollowedByHospital-filled"><g:message code="hcar.property.healthHospitalName.label" /> * : </dt><dd id="healthHospitalName" class="action-editField validate- required-true i18n-hcar.property.healthHospitalName maxLength-60" ><span>${rqt?.healthHospitalName}</span></dd>
