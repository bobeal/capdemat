  ...
  <dl class="required condition-isCareServices-filled">
      ...
      <dd id="careServices[${listSize - 1 - index}].careServiceProviderName" class="action-editField validate-lastName required-true i18n-hccr.property.careServiceProviderName maxLength-38" >
      ...
      <dd id="careServices[${listSize - 1 - index}].careServiceProviderAddress" class="action-editField validate-address i18n-hccr.property.careServiceProviderAddress" >
        <div><p class="additionalDeliveryInformation">${it?.careServiceProviderAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${it?.careServiceProviderAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${it?.careServiceProviderAddress?.streetNumber}</span> <span class="streetName">${it?.careServiceProviderAddress?.streetName}</span><g:if test="${!!it?.careServiceProviderAddress?.streetMatriculation}"><p class="streetMatriculation">Matricule: ${it?.careServiceProviderAddress?.streetMatriculation}</p></g:if><p class="placeNameOrService">${it?.careServiceProviderAddress?.placeNameOrService}</p><span class="postalCode">${it?.careServiceProviderAddress?.postalCode}</span> <span class="city">${it?.careServiceProviderAddress?.city}</span><p class="countryName">${it?.careServiceProviderAddress?.countryName}</p><g:if test="${!!it?.careServiceProviderAddress?.cityInseeCode}"><p class="cityInseeCode">INSEE: ${it?.careServiceProviderAddress?.cityInseeCode}</p></g:if></div>
      </dd>
