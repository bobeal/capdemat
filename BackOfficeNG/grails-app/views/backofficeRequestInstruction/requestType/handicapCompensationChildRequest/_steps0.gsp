  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl class="required">
              ...
              <dt class="required condition-isInEstablishmentReception-filled"><g:message code="hccr.property.dwellingReceptionAddress.label" /> * : </dt><dd id="dwellingReceptionAddress" class="action-editField validate-address required-true i18n-hccr.property.dwellingReceptionAddress" ><div><p class="additionalDeliveryInformation">${rqt?.dwellingReceptionAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${rqt?.dwellingReceptionAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${rqt?.dwellingReceptionAddress?.streetNumber}</span> <span class="streetName">${rqt?.dwellingReceptionAddress?.streetName}</span><g:if test="${!!rqt?.dwellingReceptionAddress?.streetMatriculation}"><br /><em><g:message code="address.property.streetMatriculation" /></em><span class="streetMatriculation">${rqt?.dwellingReceptionAddress?.streetMatriculation}</span></g:if><p class="streetMatriculation">Matricule: ${rqt?.dwellingReceptionAddress?.streetMatriculation}</p><p class="placeNameOrService">${rqt?.dwellingReceptionAddress?.placeNameOrService}</p><span class="postalCode">${rqt?.dwellingReceptionAddress?.postalCode}</span> <span class="city">${rqt?.dwellingReceptionAddress?.city}</span><p class="countryName">${rqt?.dwellingReceptionAddress?.countryName}</p><g:if test="${!!rqt?.dwellingReceptionAddress?.cityInseeCode}"><em><g:message code="address.property.cityInseeCode" /></em><span class="cityInseeCode">${rqt?.dwellingReceptionAddress?.cityInseeCode}</span></g:if></div></dd>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl class="required">
              ...
              <dt class="required condition-isSchoolingEnrolment-filled"><g:message code="hccr.property.schoolingSchoolAddress.label" /> * : </dt><dd id="schoolingSchoolAddress" class="action-editField validate-address required-true i18n-hccr.property.schoolingSchoolAddress" ><div><p class="additionalDeliveryInformation">${rqt?.schoolingSchoolAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${rqt?.schoolingSchoolAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${rqt?.schoolingSchoolAddress?.streetNumber}</span> <span class="streetName">${rqt?.schoolingSchoolAddress?.streetName}</span><g:if test="${!!rqt?.schoolingSchoolAddress?.streetMatriculation}"><br /><em><g:message code="address.property.streetMatriculation" /></em><span class="streetMatriculation">${rqt?.schoolingSchoolAddress?.streetMatriculation}</span></g:if><p class="streetMatriculation">Matricule: ${rqt?.schoolingSchoolAddress?.streetMatriculation}</p><p class="placeNameOrService">${rqt?.schoolingSchoolAddress?.placeNameOrService}</p><span class="postalCode">${rqt?.schoolingSchoolAddress?.postalCode}</span> <span class="city">${rqt?.schoolingSchoolAddress?.city}</span><p class="countryName">${rqt?.schoolingSchoolAddress?.countryName}</p><g:if test="${!!rqt?.schoolingSchoolAddress?.cityInseeCode}"><em><g:message code="address.property.cityInseeCode" /></em><span class="cityInseeCode">${rqt?.schoolingSchoolAddress?.cityInseeCode}</span></g:if></div></dd>
              ...
              <dt class="condition-isAccompaniedHomeSchooling-filled"><g:message code="hccr.property.schoolingHomeSchoolingAccompanistAddress.label" />  : </dt><dd id="schoolingHomeSchoolingAccompanistAddress" class="action-editField validate-address i18n-hccr.property.schoolingHomeSchoolingAccompanistAddress" ><div><p class="additionalDeliveryInformation">${rqt?.schoolingHomeSchoolingAccompanistAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${rqt?.schoolingHomeSchoolingAccompanistAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${rqt?.schoolingHomeSchoolingAccompanistAddress?.streetNumber}</span> <span class="streetName">${rqt?.schoolingHomeSchoolingAccompanistAddress?.streetName}</span><g:if test="${!!rqt?.schoolingHomeSchoolingAccompanistAddress?.streetMatriculation}"><br /><em><g:message code="address.property.streetMatriculation" /></em><span class="streetMatriculation">${rqt?.schoolingHomeSchoolingAccompanistAddress?.streetMatriculation}</span></g:if><p class="streetMatriculation">Matricule: ${rqt?.schoolingHomeSchoolingAccompanistAddress?.streetMatriculation}</p><p class="placeNameOrService">${rqt?.schoolingHomeSchoolingAccompanistAddress?.placeNameOrService}</p><span class="postalCode">${rqt?.schoolingHomeSchoolingAccompanistAddress?.postalCode}</span> <span class="city">${rqt?.schoolingHomeSchoolingAccompanistAddress?.city}</span><p class="countryName">${rqt?.schoolingHomeSchoolingAccompanistAddress?.countryName}</p><g:if test="${!!rqt?.schoolingHomeSchoolingAccompanistAddress?.cityInseeCode}"><em><g:message code="address.property.cityInseeCode" /></em><span class="cityInseeCode">${rqt?.schoolingHomeSchoolingAccompanistAddress?.cityInseeCode}</span></g:if></div></dd>
        ...
        <dl class="required">
              ...
              <dt class="required condition-isHighSchool-filled"><g:message code="hccr.property.studiesHighSchoolAddress.label" /> * : </dt><dd id="studiesHighSchoolAddress" class="action-editField validate-address required-true i18n-hccr.property.studiesHighSchoolAddress" ><div><p class="additionalDeliveryInformation">${rqt?.studiesHighSchoolAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${rqt?.studiesHighSchoolAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${rqt?.studiesHighSchoolAddress?.streetNumber}</span> <span class="streetName">${rqt?.studiesHighSchoolAddress?.streetName}</span><g:if test="${!!rqt?.studiesHighSchoolAddress?.streetMatriculation}"><br /><em><g:message code="address.property.streetMatriculation" /></em><span class="streetMatriculation">${rqt?.studiesHighSchoolAddress?.streetMatriculation}</span></g:if><p class="streetMatriculation">Matricule: ${rqt?.studiesHighSchoolAddress?.streetMatriculation}</p><p class="placeNameOrService">${rqt?.studiesHighSchoolAddress?.placeNameOrService}</p><span class="postalCode">${rqt?.studiesHighSchoolAddress?.postalCode}</span> <span class="city">${rqt?.studiesHighSchoolAddress?.city}</span><p class="countryName">${rqt?.studiesHighSchoolAddress?.countryName}</p><g:if test="${!!rqt?.studiesHighSchoolAddress?.cityInseeCode}"><em><g:message code="address.property.cityInseeCode" /></em><span class="cityInseeCode">${rqt?.studiesHighSchoolAddress?.cityInseeCode}</span></g:if></div></dd>
