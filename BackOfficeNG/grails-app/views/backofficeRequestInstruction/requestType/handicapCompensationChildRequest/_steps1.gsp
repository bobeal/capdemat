  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl class="required">
              ...
              <dt class="required condition-isMDPH-trigger">${message(code:'hccr.property.foldersMdph.label')}&nbsp;*&nbsp;:</dt><dd id="foldersMdph" class="action-editField validate-boolean required-true i18n-hccr.property.foldersMdph" ><span class="value-${rqt?.foldersMdph}"><g:message code="message.${rqt?.foldersMdph ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="condition-isMDPH-filled">${message(code:'hccr.property.foldersMdphNumber.label')}&nbsp;:</dt><dd id="foldersMdphNumber" class="action-editField validate- i18n-hccr.property.foldersMdphNumber maxLength-30" ><span>${rqt?.foldersMdphNumber}</span></dd>
          
              <dt class="condition-isMDPH-filled">${message(code:'hccr.property.foldersMdphDepartment.label')}&nbsp;:</dt><dd id="foldersMdphDepartment" class="action-editField validate-departmentCode i18n-hccr.property.foldersMdphDepartment maxLength-2" ><span>${rqt?.foldersMdphDepartment}</span></dd>
          
              <dt class="required condition-isCOTOREP-trigger">${message(code:'hccr.property.foldersCotorep.label')}&nbsp;*&nbsp;:</dt><dd id="foldersCotorep" class="action-editField validate-boolean required-true i18n-hccr.property.foldersCotorep" ><span class="value-${rqt?.foldersCotorep}"><g:message code="message.${rqt?.foldersCotorep ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="condition-isCOTOREP-filled">${message(code:'hccr.property.foldersCotorepNumber.label')}&nbsp;:</dt><dd id="foldersCotorepNumber" class="action-editField validate- i18n-hccr.property.foldersCotorepNumber maxLength-30" ><span>${rqt?.foldersCotorepNumber}</span></dd>
          
              <dt class="condition-isCOTOREP-filled">${message(code:'hccr.property.foldersCotorepDepartment.label')}&nbsp;:</dt><dd id="foldersCotorepDepartment" class="action-editField validate-departmentCode i18n-hccr.property.foldersCotorepDepartment maxLength-2" ><span>${rqt?.foldersCotorepDepartment}</span></dd>
          
              <dt class="required condition-isCDES-trigger">${message(code:'hccr.property.foldersCdes.label')}&nbsp;*&nbsp;:</dt><dd id="foldersCdes" class="action-editField validate-boolean required-true i18n-hccr.property.foldersCdes" ><span class="value-${rqt?.foldersCdes}"><g:message code="message.${rqt?.foldersCdes ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="condition-isCDES-filled">${message(code:'hccr.property.foldersCdesNumber.label')}&nbsp;:</dt><dd id="foldersCdesNumber" class="action-editField validate- i18n-hccr.property.foldersCdesNumber maxLength-30" ><span>${rqt?.foldersCdesNumber}</span></dd>
          
              <dt class="condition-isCDES-filled">${message(code:'hccr.property.foldersCdesDepartment.label')}&nbsp;:</dt><dd id="foldersCdesDepartment" class="action-editField validate-departmentCode i18n-hccr.property.foldersCdesDepartment maxLength-2" ><span>${rqt?.foldersCdesDepartment}</span></dd>
          
              <dt class="required condition-isOtherFolders-trigger">${message(code:'hccr.property.foldersOtherFolders.label')}&nbsp;*&nbsp;:</dt><dd id="foldersOtherFolders" class="action-editField validate-boolean required-true i18n-hccr.property.foldersOtherFolders" ><span class="value-${rqt?.foldersOtherFolders}"><g:message code="message.${rqt?.foldersOtherFolders ? 'yes' : 'no'}" /></span></dd>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u">
        ...
        <dl class="required">
              ...
              <dt class="required condition-isHousing-trigger">${message(code:'hccr.property.facilitiesHousing.label')}&nbsp;*&nbsp;:</dt><dd id="facilitiesHousing" class="action-editField validate-boolean required-true i18n-hccr.property.facilitiesHousing" ><span class="value-${rqt?.facilitiesHousing}"><g:message code="message.${rqt?.facilitiesHousing ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required condition-isHousing-filled">${message(code:'hccr.property.facilitiesHousingDetails.label')}&nbsp;*&nbsp;:</dt><dd id="facilitiesHousingDetails" class="action-editField validate- required-true i18n-hccr.property.facilitiesHousingDetails maxLength-60" ><span>${rqt?.facilitiesHousingDetails}</span></dd>
          
              <dt class="required condition-isTechnicalAssistance-trigger">${message(code:'hccr.property.facilitiesTechnicalAssistance.label')}&nbsp;*&nbsp;:</dt><dd id="facilitiesTechnicalAssistance" class="action-editField validate-boolean required-true i18n-hccr.property.facilitiesTechnicalAssistance" ><span class="value-${rqt?.facilitiesTechnicalAssistance}"><g:message code="message.${rqt?.facilitiesTechnicalAssistance ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required condition-isTechnicalAssistance-filled">${message(code:'hccr.property.facilitiesTechnicalAssistanceDetails.label')}&nbsp;*&nbsp;:</dt><dd id="facilitiesTechnicalAssistanceDetails" class="action-editField validate- required-true i18n-hccr.property.facilitiesTechnicalAssistanceDetails maxLength-60" ><span>${rqt?.facilitiesTechnicalAssistanceDetails}</span></dd>
          
              <dt class="required condition-isCustomCar-trigger">${message(code:'hccr.property.facilitiesCustomCar.label')}&nbsp;*&nbsp;:</dt><dd id="facilitiesCustomCar" class="action-editField validate-boolean required-true i18n-hccr.property.facilitiesCustomCar" ><span class="value-${rqt?.facilitiesCustomCar}"><g:message code="message.${rqt?.facilitiesCustomCar ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required condition-isCustomCar-filled">${message(code:'hccr.property.facilitiesCustomCarDetails.label')}&nbsp;*&nbsp;:</dt><dd id="facilitiesCustomCarDetails" class="action-editField validate- required-true i18n-hccr.property.facilitiesCustomCarDetails maxLength-60" ><span>${rqt?.facilitiesCustomCarDetails}</span></dd>
          
              <dt class="required condition-isAnimalAid-trigger">${message(code:'hccr.property.facilitiesAnimalAid.label')}&nbsp;*&nbsp;:</dt><dd id="facilitiesAnimalAid" class="action-editField validate-boolean required-true i18n-hccr.property.facilitiesAnimalAid" ><span class="value-${rqt?.facilitiesAnimalAid}"><g:message code="message.${rqt?.facilitiesAnimalAid ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required condition-isAnimalAid-filled">${message(code:'hccr.property.facilitiesAnimalAidDetails.label')}&nbsp;*&nbsp;:</dt><dd id="facilitiesAnimalAidDetails" class="action-editField validate- required-true i18n-hccr.property.facilitiesAnimalAidDetails maxLength-60" ><span>${rqt?.facilitiesAnimalAidDetails}</span></dd>
          
              <dt class="required condition-isSpecializedTransport-trigger">${message(code:'hccr.property.facilitiesSpecializedTransport.label')}&nbsp;*&nbsp;:</dt><dd id="facilitiesSpecializedTransport" class="action-editField validate-boolean required-true i18n-hccr.property.facilitiesSpecializedTransport" ><span class="value-${rqt?.facilitiesSpecializedTransport}"><g:message code="message.${rqt?.facilitiesSpecializedTransport ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required condition-isSpecializedTransport-filled">${message(code:'hccr.property.facilitiesSpecializedTransportDetails.label')}&nbsp;*&nbsp;:</dt><dd id="facilitiesSpecializedTransportDetails" class="action-editField validate- required-true i18n-hccr.property.facilitiesSpecializedTransportDetails maxLength-60" ><span>${rqt?.facilitiesSpecializedTransportDetails}</span></dd>
        ...
        <dl class="required">
              ...
              <dt class="required condition-isSocialServiceSupport-trigger">${message(code:'hccr.property.socialServiceSupport.label')}&nbsp;*&nbsp;:</dt><dd id="socialServiceSupport" class="action-editField validate-boolean required-true i18n-hccr.property.socialServiceSupport" ><span class="value-${rqt?.socialServiceSupport}"><g:message code="message.${rqt?.socialServiceSupport ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required condition-isSocialServiceSupport-filled">${message(code:'hccr.property.socialServiceName.label')}&nbsp;*&nbsp;:</dt><dd id="socialServiceName" class="action-editField validate- required-true i18n-hccr.property.socialServiceName maxLength-60" ><span>${rqt?.socialServiceName}</span></dd>
          
              <dt class="required condition-isSocialServiceSupport-filled">${message(code:'hccr.property.socialServiceAddress.label')}&nbsp;*&nbsp;:</dt><dd id="socialServiceAddress" class="action-editField validate-address required-true i18n-hccr.property.socialServiceAddress" ><div><p class="additionalDeliveryInformation">${rqt?.socialServiceAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${rqt?.socialServiceAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${rqt?.socialServiceAddress?.streetNumber}</span> <span class="streetName">${rqt?.socialServiceAddress?.streetName}</span><g:if test="${!!rqt?.socialServiceAddress?.streetMatriculation}"><br /><em><g:message code="address.property.streetMatriculation" /></em><span class="streetMatriculation">${rqt?.socialServiceAddress?.streetMatriculation}</span></g:if><g:if test="${!!rqt?.socialServiceAddress?.streetRivoliCode}"><br /><em><g:message code="address.property.streetRivoliCode" /></em><span class="streetRivoliCode">${rqt?.socialServiceAddress?.streetRivoliCode}</span></g:if><p class="placeNameOrService">${rqt?.socialServiceAddress?.placeNameOrService}</p><span class="postalCode">${rqt?.socialServiceAddress?.postalCode}</span> <span class="city">${rqt?.socialServiceAddress?.city}</span><p class="countryName">${rqt?.socialServiceAddress?.countryName}</p><g:if test="${!!rqt?.socialServiceAddress?.cityInseeCode}"><em><g:message code="address.property.cityInseeCode" /></em><span class="cityInseeCode">${rqt?.socialServiceAddress?.cityInseeCode}</span></g:if></div></dd>
