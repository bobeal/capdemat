      ...
      <div id="page0">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required"><g:message code="hsr.property.subject.label" /> : </dt>
              ...
              <dl>
                <dt class="required">${message(code:'hsr.property.absenceStartDate.label')}&nbsp;*&nbsp;:</dt><dd id="absenceStartDate" class="action-editField validate-date required-true i18n-hsr.property.absenceStartDate" ><span><g:formatDate formatName="format.date" date="${rqt?.absenceStartDate}"/></span></dd>
              </dl>
              
            
              
              <dl>
                <dt class="required">${message(code:'hsr.property.absenceEndDate.label')}&nbsp;*&nbsp;:</dt><dd id="absenceEndDate" class="action-editField validate-date required-true i18n-hsr.property.absenceEndDate" ><span><g:formatDate formatName="format.date" date="${rqt?.absenceEndDate}"/></span></dd>
              </dl>
      ...
      <div id="page2">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required">${message(code:'hsr.property.alertPhone.label')}&nbsp;*&nbsp;:</dt><dd id="alertPhone" class="action-editField validate-phone required-true i18n-hsr.property.alertPhone maxLength-10" ><span>${rqt?.alertPhone}</span></dd>
              </dl>
      ...
      <div id="page3">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required condition-isOtherContact-trigger">${message(code:'hsr.property.otherContact.label')}&nbsp;*&nbsp;:</dt><dd id="otherContact" class="action-editField validate-boolean required-true i18n-hsr.property.otherContact" ><span class="value-${rqt?.otherContact}"><g:message code="${rqt?.otherContact ? 'message.yes' : rqt?.otherContact==null ? '' : 'message.no'}" /></span></dd>
              </dl>
      ...
      <div id="page4">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required">${message(code:'hsr.property.alarm.label')}&nbsp;*&nbsp;:</dt><dd id="alarm" class="action-editField validate-boolean required-true i18n-hsr.property.alarm" ><span class="value-${rqt?.alarm}"><g:message code="${rqt?.alarm ? 'message.yes' : rqt?.alarm==null ? '' : 'message.no'}" /></span></dd>
              </dl>
              
            
              
              <dl>
                <dt class="required">${message(code:'hsr.property.light.label')}&nbsp;*&nbsp;:</dt><dd id="light" class="action-editField validate-boolean required-true i18n-hsr.property.light" ><span class="value-${rqt?.light}"><g:message code="${rqt?.light ? 'message.yes' : rqt?.light==null ? '' : 'message.no'}" /></span></dd>
              </dl>
