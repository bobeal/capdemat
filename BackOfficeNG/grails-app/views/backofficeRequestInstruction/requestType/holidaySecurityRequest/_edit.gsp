      ...
      <div id="page3">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required condition-isOtherContact-trigger">${message(code:'hsr.property.otherContact.label')} * :</dt><dd id="otherContact" class="action-editField validate-boolean required-true i18n-hsr.property.otherContact" ><span class="value-${rqt?.otherContact}"><g:message code="message.${rqt?.otherContact ? 'yes' : 'no'}" /></span></dd>
              </dl>
      ...
      <div id="page4">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required">${message(code:'hsr.property.alarm.label')} * :</dt><dd id="alarm" class="action-editField validate-boolean required-true i18n-hsr.property.alarm" ><span class="value-${rqt?.alarm}"><g:message code="message.${rqt?.alarm ? 'yes' : 'no'}" /></span></dd>
              </dl>
              
            
              
              <dl>
                <dt class="required">${message(code:'hsr.property.light.label')} * :</dt><dd id="light" class="action-editField validate-boolean required-true i18n-hsr.property.light" ><span class="value-${rqt?.light}"><g:message code="message.${rqt?.light ? 'yes' : 'no'}" /></span></dd>
              </dl>
