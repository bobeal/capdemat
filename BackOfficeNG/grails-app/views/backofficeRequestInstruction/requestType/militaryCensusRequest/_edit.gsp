      ...
      <div id="page3">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required">${message(code:'mcr.property.japdExemption.label')} * :</dt><dd id="japdExemption" class="action-editField validate-boolean required-true i18n-mcr.property.japdExemption" ><span class="value-${rqt?.japdExemption}"><g:message code="message.${rqt?.japdExemption ? 'yes' : 'no'}" /></span></dd>
              </dl>
              
            
              
              <dl>
                <dt class="">${message(code:'mcr.property.highlyInfirm.label')} :</dt><dd id="highlyInfirm" class="action-editField validate-boolean i18n-mcr.property.highlyInfirm" ><span class="value-${rqt?.highlyInfirm}"><g:message code="message.${rqt?.highlyInfirm ? 'yes' : 'no'}" /></span></dd>
              </dl>
              
            
              
              <dl>
                <dt class="">${message(code:'mcr.property.affectionOrDisease.label')} :</dt><dd id="affectionOrDisease" class="action-editField validate-boolean i18n-mcr.property.affectionOrDisease" ><span class="value-${rqt?.affectionOrDisease}"><g:message code="message.${rqt?.affectionOrDisease ? 'yes' : 'no'}" /></span></dd>
              </dl>
