      ...
      <div id="page0">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class=""><g:message code="mcr.property.childConvention.label" />  : </dt><dd id="childConvention" class="action-editField validate-textarea i18n-mcr.property.childConvention rows-3" ><span>${rqt?.childConvention}</span></dd>
              </dl>
