      ...
      <div id="page0">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class=""><g:message code="par.property.telephoneSujet.label" />  : </dt><dd id="telephoneSujet" class="action-editField validate-mobilePhone i18n-par.property.telephoneSujet maxLength-10" ><span>${rqt?.telephoneSujet}</span></dd>
              </dl>
              
            
              
              <dl>
                <dt class=""><g:message code="par.property.emailSujet.label" />  : </dt><dd id="emailSujet" class="action-editField validate-email i18n-par.property.emailSujet" ><span>${rqt?.emailSujet}</span></dd>
              </dl>
