  ...
  <h3>
    ...
    <span><g:message code="rarr.property.contactIndividuals.label" /></span>
  </h3>
  ...
  <dl class="">
      ...
      <dd id="contactIndividuals[${listSize - 1 - index}].lastName" class="action-editField validate-lastName required-true i18n-rarr.property.lastName maxLength-38" >
        <span>${it?.lastName}</span>
      </dd>
    
      <dt class="required"><g:message code="rarr.property.firstName.label" /> * : </dt>
      <dd id="contactIndividuals[${listSize - 1 - index}].firstName" class="action-editField validate-firstName required-true i18n-rarr.property.firstName maxLength-38" >
        <span>${it?.firstName}</span>
      </dd>
    
      <dt class="required"><g:message code="rarr.property.address.label" /> * : </dt>
      <dd id="contactIndividuals[${listSize - 1 - index}].address" class="action-editField validate-address required-true i18n-rarr.property.address" >
      ...
      <dd id="contactIndividuals[${listSize - 1 - index}].homePhone" class="action-editField validate-phone i18n-rarr.property.homePhone maxLength-10" >
        <span>${it?.homePhone}</span>
      </dd>
    
      <dt class=""><g:message code="rarr.property.officePhone.label" />  : </dt>
      <dd id="contactIndividuals[${listSize - 1 - index}].officePhone" class="action-editField validate-phone i18n-rarr.property.officePhone maxLength-10" >
