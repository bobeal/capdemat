      ...
      <div id="page0">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required"><g:message code="snr.property.subject.label" /> : </dt>
              ...
              <dl>
                <dt class="required">${message(code:'snr.property.subscription.label')}&nbsp;*&nbsp;:</dt><dd id="subscription" class="action-editField validate-boolean required-true i18n-snr.property.subscription" ><span class="value-${rqt?.subscription}"><g:message code="${rqt?.subscription ? 'message.yes' : rqt?.subscription==null ? '' : 'message.no'}" /></span></dd>
              </dl>
