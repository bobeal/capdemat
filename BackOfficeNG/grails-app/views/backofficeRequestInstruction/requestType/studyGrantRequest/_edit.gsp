        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dd><span>${subjectIsChild && !subject?.born ? message(code:'request.subject.childNoBorn', args:[subject?.getFullName()]) : subject?.fullName}</span></dd>
                  ...
                  <dt class="required">${message(code:'sgr.property.subjectFirstRequest.label')} * :</dt><dd id="subjectFirstRequest" class="action-editField validate-boolean required-true i18n-sgr.property.subjectFirstRequest" ><span class="value-${rqt?.subjectFirstRequest}"><g:message code="message.${rqt?.subjectFirstRequest ? 'yes' : 'no'}" /></span></dd>
      ...
      <div id="page2">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required">${message(code:'sgr.property.hasCROUSHelp.label')} * :</dt><dd id="hasCROUSHelp" class="action-editField validate-boolean required-true i18n-sgr.property.hasCROUSHelp" ><span class="value-${rqt?.hasCROUSHelp}"><g:message code="message.${rqt?.hasCROUSHelp ? 'yes' : 'no'}" /></span></dd>
              </dl>
          ...
          <div class="yui-u">
              ...
              <dl>
                <dt class="required">${message(code:'sgr.property.hasEuropeHelp.label')} * :</dt><dd id="hasEuropeHelp" class="action-editField validate-boolean required-true i18n-sgr.property.hasEuropeHelp" ><span class="value-${rqt?.hasEuropeHelp}"><g:message code="message.${rqt?.hasEuropeHelp ? 'yes' : 'no'}" /></span></dd>
              </dl>
              
            
              
              <dl>
                <dt class="required">${message(code:'sgr.property.hasOtherHelp.label')} * :</dt><dd id="hasOtherHelp" class="action-editField validate-boolean required-true i18n-sgr.property.hasOtherHelp" ><span class="value-${rqt?.hasOtherHelp}"><g:message code="message.${rqt?.hasOtherHelp ? 'yes' : 'no'}" /></span></dd>
              </dl>
        ...
        <div class="yui-g">
          ...
          <div class="yui-u">
              ...
              <dl class="">
                  ...
                  <dt class="required">${message(code:'sgr.property.sandwichCourses.label')} * :</dt><dd id="sandwichCourses" class="action-editField validate-boolean required-true i18n-sgr.property.sandwichCourses" ><span class="value-${rqt?.sandwichCourses}"><g:message code="message.${rqt?.sandwichCourses ? 'yes' : 'no'}" /></span></dd>
