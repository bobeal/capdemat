      ...
      <div id="page0">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class="required condition-otherIntervention-trigger">${message(code:'tir.property.interventionType.label')}&nbsp;*&nbsp;:</dt><dd id="interventionType" class="action-editField validate-localReferentialData required-true i18n-tir.property.interventionType data-localReferentialData" >
