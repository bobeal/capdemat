<form method="post" id="${propertyName}_Form" action="<g:createLink action="modify" />" class="editable-list-form" >
  ...
  <fieldset>
    ...
    <input name="${propertyName}.additionalDeliveryInformation" type="text" maxlength="38"
        value="${propertyValue.additionalDeliveryInformation}"/>
        
    <label><g:message code="address.property.additionalGeographicalInformation" /></label>
    <input name="${propertyName}.additionalGeographicalInformation" type="text" maxlength="38"
    ...
    <input name="${propertyName}.placeNameOrService" type="text" maxlength="38"
    ...
    <input name="${propertyName}.countryName" type="text" maxlength="38" value="${propertyValue.countryName}" /> 
  </fieldset>
