<html>
  <head>
    ...
    <script type="text/javascript" src="${resource(dir:'js/backoffice',file:'templateManager.js')}"></script>
    ...
    <script type="text/javascript" src="${resource(dir:'js/backoffice',file:'ticketBooking.js')}"></script>
    ...
    <div id="yui-main">
      <div class="yui-b">
        ...
        <div id="mainPanel">
          ...
          <div id="requestTypeTicketBooking" style="display:none"></div>
        </div>
