    ...
    <label class="required condition-isTenant-filled"><g:message code="acr.property.ownerAddress.label" /> *  <span><g:message code="acr.property.ownerAddress.help" /></span></label>
            <div id="ownerAddress" class="address-fieldset required condition-isTenant-filled  ${stepStates != null && stepStates['cadastre']?.invalidFields.contains('ownerAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['cadastre']?.invalidFields.contains('ownerAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.ownerAddress?.streetNumber}" size="5" maxlength="5" id="ownerAddress_streetNumber" name="ownerAddress.streetNumber" />
            ...
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['cadastre']?.invalidFields.contains('ownerAddress.city') ? 'validation-failed' : ''}" value="${rqt.ownerAddress?.city}" maxlength="32" id="ownerAddress_city" name="ownerAddress.city" title="<g:message code="address.property.city.validationError" />" />
