    ...
    <label class="required condition-isSameAddress-unfilled"><g:message code="ancr.property.otherAddress.label" /> *  <span><g:message code="ancr.property.otherAddress.help" /></span></label>
            <div id="otherAddress" class="address required condition-isSameAddress-unfilled  ${rqt.stepStates['address'].invalidFields.contains('otherAddress') ? 'validation-failed' : ''}">
            <label for="otherAddress.additionalDeliveryInformation"><g:message code="address.property.additionalDeliveryInformation" /></label>
            <input type="text" class="validate-addressLine38 ${rqt.stepStates['address'].invalidFields.contains('otherAddress.additionalDeliveryInformation') ? 'validation-failed' : ''}" value="${rqt.otherAddress?.additionalDeliveryInformation}" maxlength="38" id="otherAddress.additionalDeliveryInformation" name="otherAddress.additionalDeliveryInformation" />  
            ...
            <input type="text" class="line1 validate-streetNumber ${rqt.stepStates['address'].invalidFields.contains('otherAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.otherAddress?.streetNumber}" size="5" maxlength="5" id="otherAddress_streetNumber" name="otherAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${rqt.stepStates['address'].invalidFields.contains('otherAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.otherAddress?.streetName}" maxlength="32" id="otherAddress_streetName" name="otherAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="validate-addressLine38 ${rqt.stepStates['address'].invalidFields.contains('otherAddress.placeNameOrService') ? 'validation-failed' : ''}" value="${rqt.otherAddress?.placeNameOrService}" maxlength="38" id="otherAddress.placeNameOrService" name="otherAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required validate-postalCode ${rqt.stepStates['address'].invalidFields.contains('otherAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.otherAddress?.postalCode}" size="5" maxlength="5" id="otherAddress_postalCode" name="otherAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${rqt.stepStates['address'].invalidFields.contains('otherAddress.city') ? 'validation-failed' : ''}" value="${rqt.otherAddress?.city}" maxlength="32" id="otherAddress_city" name="otherAddress.city" title="<g:message code="address.property.city.validationError" />" />
            ...
            <input type="text" class="validate-addressLine38 ${rqt.stepStates['address'].invalidFields.contains('otherAddress.countryName') ? 'validation-failed' : ''}" value="${rqt.otherAddress?.countryName}" maxlength="38" id="otherAddress.countryName" name="otherAddress.countryName" />
            </div>
