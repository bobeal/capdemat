    ...
    <label class="required condition-isSameAddress-unfilled"><g:message code="ancr.property.otherAddress.label" /> *  <span><g:message code="ancr.property.otherAddress.help" /></span></label>
            <div id="otherAddress" class="address-fieldset required condition-isSameAddress-unfilled  ${stepStates != null && stepStates['requester']?.invalidFields.contains('otherAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['requester']?.invalidFields.contains('otherAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.otherAddress?.streetNumber}" size="5" maxlength="5" id="otherAddress_streetNumber" name="otherAddress.streetNumber" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['requester']?.invalidFields.contains('otherAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.otherAddress?.postalCode}" size="5" maxlength="5" id="otherAddress_postalCode" name="otherAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['requester']?.invalidFields.contains('otherAddress.city') ? 'validation-failed' : ''}" value="${rqt.otherAddress?.city}" maxlength="32" id="otherAddress_city" name="otherAddress.city" title="<g:message code="address.property.city.validationError" />" />
