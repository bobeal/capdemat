    ...
    <label class="required condition-isSameAddress-unfilled"><g:message code="ancr.property.otherAddress.label" /> *  <span><g:message code="ancr.property.otherAddress.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.otherAddress?.streetMatriculation}" id="otherAddress.streetMatriculation" name="otherAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.otherAddress?.cityInseeCode}" id="otherAddress.cityInseeCode" name="otherAddress.cityInseeCode" />
