    ...
    <label class="required"><g:message code="bgr.property.subjectAddress.label" /> *  <span><g:message code="bgr.property.subjectAddress.help" /></span></label>
            <div class="address required autofill-subjectFilling-listener-Adress ${rqt.stepStates['subject'].invalidFields.contains('subjectAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="line1 validate-streetNumber ${rqt.stepStates['subject'].invalidFields.contains('subjectAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.subjectAddress?.streetNumber}" size="5" maxlength="5" id="subjectAddress.streetNumber" name="subjectAddress.streetNumber" />
            ...
            <input type="text" class="line2 required validate-city ${rqt.stepStates['subject'].invalidFields.contains('subjectAddress.city') ? 'validation-failed' : ''}" value="${rqt.subjectAddress?.city}" maxlength="32" id="subjectAddress.city" name="subjectAddress.city" title="<g:message code="address.property.city.validationError" />" />
