...
<html>
  <head>
     <title>${message(code:'bgr.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box">
      <h2>
        ...
        <g:message code="bgr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="bgr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="bgr" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'subject' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'bgr.step.subject.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
        ...
        <li class="${currentStep == 'internship' ? 'current ' : ''}
          
            ${rqt.stepStates['internship'].state}
          
          ">
          <span class="number">2</span>
          <a
            <g:if test="${currentStep != 'internship' && rqt.stepStates['internship'].state != 'unavailable'}">
              href="${createLink(controller:'frontofficeRequest', action : 'edit', params:['id':rqt.id,'currentStep':'internship'])}"
            </g:if>
          >
            
              <g:message code="bgr.step.internship.label" /> *
              <span class="help">
                
                  <g:message code="request.step.message.${rqt.stepStates['internship'].state}" />
        ...
        <li class="${currentStep == 'bankReference' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="bgr.step.bankReference.label" /> *
              <span class="help">
