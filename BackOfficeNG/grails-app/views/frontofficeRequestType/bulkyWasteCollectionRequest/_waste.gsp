    ...
    <label class=""><g:message code="bwcr.property.collectionAddress.label" />   <span><g:message code="bwcr.property.collectionAddress.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.collectionAddress?.streetMatriculation}" id="collectionAddress.streetMatriculation" name="collectionAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.collectionAddress?.cityInseeCode}" id="collectionAddress.cityInseeCode" name="collectionAddress.cityInseeCode" />
