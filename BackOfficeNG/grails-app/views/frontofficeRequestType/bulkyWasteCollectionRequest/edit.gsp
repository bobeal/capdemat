  ...
  <body>
    ...
    <div id="request" class="main-box">
      <h2>
        ...
        <g:message code="bwcr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="bwcr" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'waste' ? 'current ' : ''}
          
            ${individual ? rqt.stepStates['waste-' + params.type].state : rqt.stepStates['waste'].state}
          
          ">
          <span class="number">1</span>
          <a
            <g:if test="${currentStep != 'waste' && rqt.stepStates['waste'].state != 'unavailable'}">
              href="${createLink(controller:'frontofficeRequest', action : 'edit', params:['id':rqt.id,'currentStep':'waste'])}"
            </g:if>
          >
            
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'bwcr.step.waste.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
                <g:message code="request.step.message.${rqt.stepStates['waste' + (individual ? '-' + params.type : '')].state}" />
              </span>
