  ...
  <body>
    ...
    <div id="request" class="main-box">
      <h2>
        ...
        <g:message code="cwcr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      ...
      <ul>
        ...
        <li class="${currentStep == 'waste' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'cwcr.step.waste.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
