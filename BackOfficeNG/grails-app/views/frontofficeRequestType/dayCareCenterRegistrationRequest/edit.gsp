  ...
  <body>
    ...
    <div id="requestTabView" class="yui-navset">
     ...
     <div class="yui-content">
       ...
       <div id="subject">
         <form method="post"  id="stepForm-subject" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="dccrr.step.subject.label" />
             <span><g:message code="dccrr.step.subject.desc" /></span>
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/dayCareCenterRegistrationRequest/subject" />         
       ...
       <div id="accueil">
         <form method="post"  id="stepForm-accueil" action="<g:createLink action="step" />">
           <input type="hidden" name="returnUrl" value="${returnUrl}" />
           <h3>
             <span class="tag-state ${stepStates!= null ? stepStates.accueil.cssClass : 'tag-pending'}"><g:message code="${stepStates != null ? stepStates.accueil.i18nKey : 'request.step.state.uncomplete'}" /></span>
             ...
             <g:message code="dccrr.step.accueil.label" />
             <span><g:message code="dccrr.step.accueil.desc" /></span>
             <span class="error">${stepStates?.accueil?.errorMsg}</span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
  
            <g:render template="/frontofficeRequestType/dayCareCenterRegistrationRequest/accueil" />         
  
           </div>
           <div class="error" id="stepForm-accueil-error"> </div>
           <!-- Input submit-->
           <input type="hidden" name="requestTypeInfo" value="${requestTypeInfo}" />
           <input type="hidden" name="uuidString" value="${uuidString}" />
  
           <input type="submit" id="submit-step-accueil" name="submit-step-accueil" class="submit-step" value="${message(code:'action.validate')}" />
  
         </form>
         
         <g:if test="${helps.accueil != null}">       
         <div class="requestHelp">
           <h3><g:message code="header.help"/></h3>
           ${helps.accueil}
         </div>
       ...
       <div id="rendezVous">
         <form method="post"  id="stepForm-rendezVous" action="<g:createLink action="step" />">
           <input type="hidden" name="returnUrl" value="${returnUrl}" />
           <h3>
             <span class="tag-state ${stepStates!= null ? stepStates.rendezVous.cssClass : 'tag-pending'}"><g:message code="${stepStates != null ? stepStates.rendezVous.i18nKey : 'request.step.state.uncomplete'}" /></span>
             ...
             <g:message code="dccrr.step.rendezVous.label" />
             <span><g:message code="dccrr.step.rendezVous.desc" /></span>
             <span class="error">${stepStates?.rendezVous?.errorMsg}</span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
  
            <g:render template="/frontofficeRequestType/dayCareCenterRegistrationRequest/rendezVous" />         
  
           </div>
           <div class="error" id="stepForm-rendezVous-error"> </div>
           <!-- Input submit-->
           <input type="hidden" name="requestTypeInfo" value="${requestTypeInfo}" />
           <input type="hidden" name="uuidString" value="${uuidString}" />
  
           <input type="submit" id="submit-step-rendezVous" name="submit-step-rendezVous" class="submit-step" value="${message(code:'action.validate')}" />
  
         </form>
         
         <g:if test="${helps.rendezVous != null}">       
         <div class="requestHelp">
           <h3><g:message code="header.help"/></h3>
           ${helps.rendezVous}
         </div>
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/dayCareCenterRegistrationRequest/validation0" />
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="dccrr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
