    ...
    <label for="copies" class="required"><g:message code="ddr.property.copies.label" /> *  <span><g:message code="ddr.property.copies.help" /></span></label>
            <input type="text" id="copies" name="copies" value="${rqt.copies?.toString()}" 
                    class="required  validate-positiveInteger ${stepStates != null && stepStates['type']?.invalidFields?.contains('copies') ? 'validation-failed' : ''}" title="<g:message code="ddr.property.copies.validationError" />"   />
    ...
    <label for="motive" class=""><g:message code="ddr.property.motive.label" />   <span><g:message code="ddr.property.motive.help" /></span></label>
            <select id="motive" name="motive" class="  validate-select ${stepStates != null && stepStates['type']?.invalidFields?.contains('motive') ? 'validation-failed' : ''}" title="<g:message code="ddr.property.motive.validationError" />">
    ...
    <label for="comment" class=""><g:message code="ddr.property.comment.label" />   <span><g:message code="ddr.property.comment.help" /></span></label>
            <textarea id="comment" name="comment" class="  validate-regex ${stepStates != null && stepStates['type']?.invalidFields?.contains('comment') ? 'validation-failed' : ''}" title="<g:message code="ddr.property.comment.validationError" />" rows="3" cols="" regex="^[\w\W]{0,255}$" maxlength="255">${rqt.comment}</textarea>
