  ...
  <body>
    ...
    <div id="request" class="main-box">
      <h2>
        ...
        <g:message code="ddr.label" />
        <span><g:message code="ddr.description" /></span> 
      </h2>
      ...
      <ul>
        ...
        <li class="${currentStep == 'requester' ? 'current' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'ddr.step.requester.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
