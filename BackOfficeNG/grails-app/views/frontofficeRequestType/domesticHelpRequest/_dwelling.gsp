    ...
    <legend><g:message code="dhr.property.dhrCurrentDwelling.label" /></legend>
      ...
      <label class="required"><g:message code="dhr.property.dhrCurrentDwellingAddress.label" /> *  <span><g:message code="dhr.property.dhrCurrentDwellingAddress.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.dhrCurrentDwellingAddress?.streetMatriculation}" id="dhrCurrentDwellingAddress.streetMatriculation" name="dhrCurrentDwellingAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.dhrCurrentDwellingAddress?.cityInseeCode}" id="dhrCurrentDwellingAddress.cityInseeCode" name="dhrCurrentDwellingAddress.cityInseeCode" />
    ...
    <div class="collection-fieldset required validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add required">
        ...
        <label class="required"><g:message code="dhr.property.dhrPreviousDwellingAddress.label" /> *  <span><g:message code="dhr.property.dhrPreviousDwellingAddress.help" /></span></label>
            ...
            <input type="hidden" value="${editList?.dhrPreviousDwelling?.dhrPreviousDwellingAddress?.streetMatriculation}" id="dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress.streetMatriculation" name="dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${editList?.dhrPreviousDwelling?.dhrPreviousDwellingAddress?.cityInseeCode}" id="dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress.cityInseeCode" name="dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress.cityInseeCode" />
