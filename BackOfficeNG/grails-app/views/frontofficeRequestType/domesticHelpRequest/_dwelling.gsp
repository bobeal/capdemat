    ...
    <legend><g:message code="dhr.property.dhrCurrentDwelling.label" /></legend>
      ...
      <label class="required"><g:message code="dhr.property.dhrCurrentDwellingAddress.label" /> *  <span><g:message code="dhr.property.dhrCurrentDwellingAddress.help" /></span></label>
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['dwelling']?.invalidFields.contains('dhrCurrentDwellingAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.dhrCurrentDwellingAddress?.streetNumber}" size="5" maxlength="5" id="dhrCurrentDwellingAddress.streetNumber" name="dhrCurrentDwellingAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['dwelling']?.invalidFields.contains('dhrCurrentDwellingAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.dhrCurrentDwellingAddress?.streetName}" maxlength="32" id="dhrCurrentDwellingAddress.streetName" name="dhrCurrentDwellingAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['dwelling']?.invalidFields.contains('dhrCurrentDwellingAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.dhrCurrentDwellingAddress?.postalCode}" size="5" maxlength="5" id="dhrCurrentDwellingAddress.postalCode" name="dhrCurrentDwellingAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['dwelling']?.invalidFields.contains('dhrCurrentDwellingAddress.city') ? 'validation-failed' : ''}" value="${rqt.dhrCurrentDwellingAddress?.city}" maxlength="32" id="dhrCurrentDwellingAddress.city" name="dhrCurrentDwellingAddress.city" title="<g:message code="address.property.city.validationError" />" />
    ...
    <div class="collection-fieldset required validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add required">
        ...
        <label class="required"><g:message code="dhr.property.dhrPreviousDwellingAddress.label" /> *  <span><g:message code="dhr.property.dhrPreviousDwellingAddress.help" /></span></label>
            <div class="address-fieldset required  ${stepStates != null && stepStates['dwelling']?.invalidFields.contains('dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['dwelling']?.invalidFields.contains('dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress.streetNumber') ? 'validation-failed' : ''}" value="${editList?.dhrPreviousDwelling?.dhrPreviousDwellingAddress?.streetNumber}" size="5" maxlength="5" id="dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress.streetNumber" name="dhrPreviousDwelling[${listIndex}].dhrPreviousDwellingAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['dwelling']?.invalidFields.contains('dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress.streetName') ? 'validation-failed' : ''}" value="${editList?.dhrPreviousDwelling?.dhrPreviousDwellingAddress?.streetName}" maxlength="32" id="dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress.streetName" name="dhrPreviousDwelling[${listIndex}].dhrPreviousDwellingAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['dwelling']?.invalidFields.contains('dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress.countryName') ? 'validation-failed' : ''}" value="${editList?.dhrPreviousDwelling?.dhrPreviousDwellingAddress?.countryName}" maxlength="38" id="dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress.countryName" name="dhrPreviousDwelling[${listIndex}].dhrPreviousDwellingAddress.countryName" />
            </div>
