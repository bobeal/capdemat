    ...
    <legend><g:message code="dhr.property.dhrCurrentDwelling.label" /></legend>
      ...
      <label class="required"><g:message code="dhr.property.dhrCurrentDwellingAddress.label" /> *  <span><g:message code="dhr.property.dhrCurrentDwellingAddress.help" /></span></label>
            ...
            <input type="hidden" value="" id="dhrCurrentDwellingAddress_streetMatriculation" name="dhrCurrentDwellingAddress.streetMatriculation" />
            ...
            <input type="hidden" value="" id="dhrCurrentDwellingAddress_cityInseeCode" name="dhrCurrentDwellingAddress.cityInseeCode" />
    ...
    <div class="collection-fieldset required validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add required">
        ...
        <label class="required"><g:message code="dhr.property.dhrPreviousDwellingAddress.label" /> *  <span><g:message code="dhr.property.dhrPreviousDwellingAddress.help" /></span></label>
            ...
            <input type="hidden" value="" id="dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress_streetMatriculation" name="dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress.streetMatriculation" />
            ...
            <input type="hidden" value="" id="dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress_cityInseeCode" name="dhrPreviousDwelling.${listIndex}.dhrPreviousDwellingAddress.cityInseeCode" />
