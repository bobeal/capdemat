    ...
    <legend><g:message code="dhr.property.dhrFamilyReferent.label" /></legend>
      ...
      <label class="required condition-haveFamilyReferent-filled"><g:message code="dhr.property.dhrReferentAddress.label" /> *  <span><g:message code="dhr.property.dhrReferentAddress.help" /></span></label>
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['familyReferent']?.invalidFields.contains('dhrReferentAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.dhrReferentAddress?.streetNumber}" size="5" maxlength="5" id="dhrReferentAddress.streetNumber" name="dhrReferentAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['familyReferent']?.invalidFields.contains('dhrReferentAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.dhrReferentAddress?.streetName}" maxlength="32" id="dhrReferentAddress.streetName" name="dhrReferentAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            <input type="hidden" value="${rqt.dhrReferentAddress?.streetMatriculation}" id="dhrReferentAddress.streetMatriculation" name="dhrReferentAddress.streetMatriculation" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['familyReferent']?.invalidFields.contains('dhrReferentAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.dhrReferentAddress?.postalCode}" size="5" maxlength="5" id="dhrReferentAddress.postalCode" name="dhrReferentAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['familyReferent']?.invalidFields.contains('dhrReferentAddress.city') ? 'validation-failed' : ''}" value="${rqt.dhrReferentAddress?.city}" maxlength="32" id="dhrReferentAddress.city" name="dhrReferentAddress.city" title="<g:message code="address.property.city.validationError" />" />
            <input type="hidden" value="${rqt.dhrReferentAddress?.cityInseeCode}" id="dhrReferentAddress.cityInseeCode" name="dhrReferentAddress.cityInseeCode" />
