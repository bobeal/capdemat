    ...
    <legend><g:message code="dhr.property.dhrFamilyReferent.label" /></legend>
      ...
      <label class="required condition-haveFamilyReferent-filled"><g:message code="dhr.property.dhrReferentAddress.label" /> *  <span><g:message code="dhr.property.dhrReferentAddress.help" /></span></label>
            ...
            <input type="text" value="${rqt.dhrReferentAddress?.additionalDeliveryInformation}" maxlength="38" id="dhrReferentAddress.additionalDeliveryInformation" name="dhrReferentAddress.additionalDeliveryInformation" />  
            ...
            <input type="text" value="${rqt.dhrReferentAddress?.additionalGeographicalInformation}" maxlength="38" id="dhrReferentAddress.additionalGeographicalInformation" name="dhrReferentAddress.additionalGeographicalInformation" />
            ...
            <input type="text" class="line1" value="${rqt.dhrReferentAddress?.streetNumber}" size="5" maxlength="5" id="dhrReferentAddress.streetNumber" name="dhrReferentAddress.streetNumber" />
            <input type="text" class="line2 required" value="${rqt.dhrReferentAddress?.streetName}" maxlength="32" id="dhrReferentAddress.streetName" name="dhrReferentAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            <label for="dhrReferentAddress.placeNameOrService"><g:message code="address.property.placeNameOrService" /></label>
            <input type="text" value="${rqt.dhrReferentAddress?.placeNameOrService}" maxlength="38" id="dhrReferentAddress.placeNameOrService" name="dhrReferentAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required" value="${rqt.dhrReferentAddress?.postalCode}" size="5" maxlength="5" id="dhrReferentAddress.postalCode" name="dhrReferentAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required" value="${rqt.dhrReferentAddress?.city}" maxlength="32" id="dhrReferentAddress.city" name="dhrReferentAddress.city" title="<g:message code="address.property.city.validationError" />" />
            <label for="dhrReferentAddress.countryName"><g:message code="address.property.countryName" /></label>
            <input type="text" value="${rqt.dhrReferentAddress?.countryName}" maxlength="38" id="dhrReferentAddress.countryName" name="dhrReferentAddress.countryName" />
            </div>
