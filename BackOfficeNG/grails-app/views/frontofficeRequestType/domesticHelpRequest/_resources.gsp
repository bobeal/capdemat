    ...
    <div class="collection-fieldset required validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add required">
        ...
        <label class="required"><g:message code="dhr.property.dhrRealAssetAddress.label" /> *  <span><g:message code="dhr.property.dhrRealAssetAddress.help" /></span></label>
            ...
            <input type="hidden" value="${editList?.dhrRealAsset?.dhrRealAssetAddress?.streetMatriculation}" id="dhrRealAsset.${listIndex}.dhrRealAssetAddress.streetMatriculation" name="dhrRealAsset.${listIndex}.dhrRealAssetAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${editList?.dhrRealAsset?.dhrRealAssetAddress?.cityInseeCode}" id="dhrRealAsset.${listIndex}.dhrRealAssetAddress.cityInseeCode" name="dhrRealAsset.${listIndex}.dhrRealAssetAddress.cityInseeCode" />
    ...
    <div class="collection-fieldset required validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add required">
        ...
        <label class="required condition-isRealEstate-filled"><g:message code="dhr.property.dhrNotRealAssetAddress.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetAddress.help" /></span></label>
            ...
            <input type="hidden" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetAddress?.streetMatriculation}" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.streetMatriculation" name="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetAddress?.cityInseeCode}" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.cityInseeCode" name="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.cityInseeCode" />
        ...
        <label class="required"><g:message code="dhr.property.dhrNotRealAssetBeneficiaryAddress.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetBeneficiaryAddress.help" /></span></label>
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetBeneficiaryAddress.streetNumber') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetBeneficiaryAddress?.streetNumber}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.streetNumber" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetBeneficiaryAddress.streetName') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetBeneficiaryAddress?.streetName}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.streetName" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            <input type="hidden" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetBeneficiaryAddress?.streetMatriculation}" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.streetMatriculation" name="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.streetMatriculation" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetBeneficiaryAddress.postalCode') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetBeneficiaryAddress?.postalCode}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.postalCode" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetBeneficiaryAddress.city') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetBeneficiaryAddress?.city}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.city" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.city" title="<g:message code="address.property.city.validationError" />" />
            <input type="hidden" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetBeneficiaryAddress?.cityInseeCode}" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.cityInseeCode" name="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.cityInseeCode" />
        ...
        <label class="required"><g:message code="dhr.property.dhrNotRealAssetNotaryAddress.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetNotaryAddress.help" /></span></label>
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetNotaryAddress.streetNumber') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.streetNumber}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.streetNumber" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetNotaryAddress.streetName') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.streetName}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.streetName" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            <input type="hidden" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.streetMatriculation}" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.streetMatriculation" name="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.streetMatriculation" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetNotaryAddress.postalCode') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.postalCode}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.postalCode" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetNotaryAddress.city') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.city}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.city" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.city" title="<g:message code="address.property.city.validationError" />" />
            <input type="hidden" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.cityInseeCode}" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.cityInseeCode" name="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.cityInseeCode" />
