    ...
    <div class="collection-fieldset required validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add required">
        ...
        <label class="required"><g:message code="dhr.property.dhrRealAssetAddress.label" /> *  <span><g:message code="dhr.property.dhrRealAssetAddress.help" /></span></label>
            <div id="dhrRealAsset.${listIndex}.dhrRealAssetAddress" class="address-fieldset required  ${rqt.stepStates['resources'].invalidFields.contains('dhrRealAsset.dhrRealAssetAddress') ? 'validation-failed' : ''}">
    ...
    <div class="collection-fieldset required validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add required">
        ...
        <label class="required condition-isRealEstate-filled"><g:message code="dhr.property.dhrNotRealAssetAddress.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetAddress.help" /></span></label>
            <div id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress" class="address-fieldset required condition-isRealEstate-filled  ${rqt.stepStates['resources'].invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetAddress') ? 'validation-failed' : ''}">
        ...
        <label class="required"><g:message code="dhr.property.dhrNotRealAssetBeneficiaryAddress.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetBeneficiaryAddress.help" /></span></label>
            <div id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress" class="address-fieldset required  ${rqt.stepStates['resources'].invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetBeneficiaryAddress') ? 'validation-failed' : ''}">
        ...
        <label class="required"><g:message code="dhr.property.dhrNotRealAssetDate.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetDate.help" /></span></label>
            <div class="date required  validate-date required ">
              <select class="day ${rqt.stepStates['resources'].invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetDate') ? 'validation-failed' : ''}"
              ...
              <select class="month ${rqt.stepStates['resources'].invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetDate') ? 'validation-failed' : ''}"
              ...
              <input type="text" maxlength="4" size="3"
                class="year ${rqt.stepStates['resources'].invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetDate') ? 'validation-failed' : ''}"
        ...
        <label class="required"><g:message code="dhr.property.dhrNotRealAssetNotaryAddress.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetNotaryAddress.help" /></span></label>
            <div id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress" class="address-fieldset required  ${rqt.stepStates['resources'].invalidFields.contains('dhrNotRealAsset.dhrNotRealAssetNotaryAddress') ? 'validation-failed' : ''}">
