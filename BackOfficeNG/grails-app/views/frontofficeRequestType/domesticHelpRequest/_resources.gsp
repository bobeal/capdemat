      ...
      <fieldset>
        <legend>
          ...
          <label class="required"><g:message code="dhr.property.dhrRealAssetAddress.label" /> *  <span><g:message code="dhr.property.dhrRealAssetAddress.help" /></span></label>
            ...
            <input type="text" value="${listItem?.dhrRealAssetAddress?.additionalDeliveryInformation}" maxlength="38" id="dhrRealAsset.${listIndex}.dhrRealAssetAddress.additionalDeliveryInformation" name="dhrRealAsset[${listIndex}].dhrRealAssetAddress.additionalDeliveryInformation" />  
            ...
            <input type="text" value="${listItem?.dhrRealAssetAddress?.additionalGeographicalInformation}" maxlength="38" id="dhrRealAsset.${listIndex}.dhrRealAssetAddress.additionalGeographicalInformation" name="dhrRealAsset[${listIndex}].dhrRealAssetAddress.additionalGeographicalInformation" />
            ...
            <input type="text" class="line1" value="${listItem?.dhrRealAssetAddress?.streetNumber}" size="5" maxlength="5" id="dhrRealAsset.${listIndex}.dhrRealAssetAddress.streetNumber" name="dhrRealAsset[${listIndex}].dhrRealAssetAddress.streetNumber" />
            <input type="text" class="line2 required" value="${listItem?.dhrRealAssetAddress?.streetName}" maxlength="32" id="dhrRealAsset.${listIndex}.dhrRealAssetAddress.streetName" name="dhrRealAsset[${listIndex}].dhrRealAssetAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" value="${listItem?.dhrRealAssetAddress?.placeNameOrService}" maxlength="38" id="dhrRealAsset.${listIndex}.dhrRealAssetAddress.placeNameOrService" name="dhrRealAsset[${listIndex}].dhrRealAssetAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required" value="${listItem?.dhrRealAssetAddress?.postalCode}" size="5" maxlength="5" id="dhrRealAsset.${listIndex}.dhrRealAssetAddress.postalCode" name="dhrRealAsset[${listIndex}].dhrRealAssetAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required" value="${listItem?.dhrRealAssetAddress?.city}" maxlength="32" id="dhrRealAsset.${listIndex}.dhrRealAssetAddress.city" name="dhrRealAsset[${listIndex}].dhrRealAssetAddress.city" title="<g:message code="address.property.city.validationError" />" />
            <label for="dhrRealAsset.${listIndex}.dhrRealAssetAddress.countryName"><g:message code="address.property.countryName" /></label>
            <input type="text" value="${listItem?.dhrRealAssetAddress?.countryName}" maxlength="38" id="dhrRealAsset.${listIndex}.dhrRealAssetAddress.countryName" name="dhrRealAsset[${listIndex}].dhrRealAssetAddress.countryName" />
            </div>
      ...
      <fieldset>
        <legend>
          ...
          <label class="required condition-isRealEstate-filled"><g:message code="dhr.property.dhrNotRealAssetAddress.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetAddress.help" /></span></label>
            ...
            <input type="text" value="${listItem?.dhrNotRealAssetAddress?.additionalDeliveryInformation}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.additionalDeliveryInformation" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetAddress.additionalDeliveryInformation" />  
            ...
            <input type="text" value="${listItem?.dhrNotRealAssetAddress?.additionalGeographicalInformation}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.additionalGeographicalInformation" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetAddress.additionalGeographicalInformation" />
            ...
            <input type="text" class="line1" value="${listItem?.dhrNotRealAssetAddress?.streetNumber}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.streetNumber" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetAddress.streetNumber" />
            <input type="text" class="line2 required" value="${listItem?.dhrNotRealAssetAddress?.streetName}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.streetName" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" value="${listItem?.dhrNotRealAssetAddress?.placeNameOrService}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.placeNameOrService" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required" value="${listItem?.dhrNotRealAssetAddress?.postalCode}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.postalCode" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required" value="${listItem?.dhrNotRealAssetAddress?.city}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.city" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetAddress.city" title="<g:message code="address.property.city.validationError" />" />
            <label for="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.countryName"><g:message code="address.property.countryName" /></label>
            <input type="text" value="${listItem?.dhrNotRealAssetAddress?.countryName}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetAddress.countryName" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetAddress.countryName" />
            </div>
          ...
          <label class="required"><g:message code="dhr.property.dhrNotRealAssetBeneficiaryAddress.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetBeneficiaryAddress.help" /></span></label>
            ...
            <input type="text" value="${listItem?.dhrNotRealAssetBeneficiaryAddress?.additionalDeliveryInformation}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.additionalDeliveryInformation" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.additionalDeliveryInformation" />  
            ...
            <input type="text" class="line1" value="${listItem?.dhrNotRealAssetBeneficiaryAddress?.streetNumber}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.streetNumber" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.streetNumber" />
            <input type="text" class="line2 required" value="${listItem?.dhrNotRealAssetBeneficiaryAddress?.streetName}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.streetName" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" value="${listItem?.dhrNotRealAssetBeneficiaryAddress?.placeNameOrService}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.placeNameOrService" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required" value="${listItem?.dhrNotRealAssetBeneficiaryAddress?.postalCode}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.postalCode" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required" value="${listItem?.dhrNotRealAssetBeneficiaryAddress?.city}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.city" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.city" title="<g:message code="address.property.city.validationError" />" />
            ...
            <input type="text" value="${listItem?.dhrNotRealAssetBeneficiaryAddress?.countryName}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.countryName" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.countryName" />
            </div>
          ...
          <label class="required"><g:message code="dhr.property.dhrNotRealAssetNotaryAddress.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetNotaryAddress.help" /></span></label>
            ...
            <input type="text" value="${listItem?.dhrNotRealAssetNotaryAddress?.additionalDeliveryInformation}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.additionalDeliveryInformation" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.additionalDeliveryInformation" />  
            ...
            <input type="text" value="${listItem?.dhrNotRealAssetNotaryAddress?.additionalGeographicalInformation}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.additionalGeographicalInformation" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.additionalGeographicalInformation" />
            ...
            <input type="text" class="line1" value="${listItem?.dhrNotRealAssetNotaryAddress?.streetNumber}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.streetNumber" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.streetNumber" />
            <input type="text" class="line2 required" value="${listItem?.dhrNotRealAssetNotaryAddress?.streetName}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.streetName" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" value="${listItem?.dhrNotRealAssetNotaryAddress?.placeNameOrService}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.placeNameOrService" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required" value="${listItem?.dhrNotRealAssetNotaryAddress?.postalCode}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.postalCode" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required" value="${listItem?.dhrNotRealAssetNotaryAddress?.city}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.city" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.city" title="<g:message code="address.property.city.validationError" />" />
            ...
            <input type="text" value="${listItem?.dhrNotRealAssetNotaryAddress?.countryName}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.countryName" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.countryName" />
            </div>
