    ...
    <div class="collection-fieldset required validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add required">
        ...
        <label class="required"><g:message code="dhr.property.dhrRealAssetAddress.label" /> *  <span><g:message code="dhr.property.dhrRealAssetAddress.help" /></span></label>
            <div class="address-fieldset required  ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrRealAssetAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrRealAssetAddress.additionalGeographicalInformation') ? 'validation-failed' : ''}" value="${editList?.dhrRealAsset?.dhrRealAssetAddress?.additionalGeographicalInformation}" maxlength="38" id="dhrRealAsset.${listIndex}.dhrRealAssetAddress.additionalGeographicalInformation" name="dhrRealAsset[${listIndex}].dhrRealAssetAddress.additionalGeographicalInformation" />
    ...
    <div class="collection-fieldset required validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add required">
        ...
        <label class="required condition-isRealEstate-filled"><g:message code="dhr.property.dhrNotRealAssetAddress.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetAddress.help" /></span></label>
            <div class="address-fieldset required condition-isRealEstate-filled  ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetAddress') ? 'validation-failed' : ''}">
        ...
        <label class="required"><g:message code="dhr.property.dhrNotRealAssetBeneficiaryAddress.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetBeneficiaryAddress.help" /></span></label>
            <div class="address-fieldset required  ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetBeneficiaryAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetBeneficiaryAddress.streetNumber') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetBeneficiaryAddress?.streetNumber}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.streetNumber" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetBeneficiaryAddress.streetName') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetBeneficiaryAddress?.streetName}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.streetName" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetBeneficiaryAddress.placeNameOrService') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetBeneficiaryAddress?.placeNameOrService}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.placeNameOrService" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetBeneficiaryAddress.postalCode') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetBeneficiaryAddress?.postalCode}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.postalCode" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetBeneficiaryAddress.city') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetBeneficiaryAddress?.city}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.city" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.city" title="<g:message code="address.property.city.validationError" />" />
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetBeneficiaryAddress.countryName') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetBeneficiaryAddress?.countryName}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetBeneficiaryAddress.countryName" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetBeneficiaryAddress.countryName" />
            </div>
        ...
        <label class="required"><g:message code="dhr.property.dhrNotRealAssetNotaryAddress.label" /> *  <span><g:message code="dhr.property.dhrNotRealAssetNotaryAddress.help" /></span></label>
            <div class="address-fieldset required  ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetNotaryAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetNotaryAddress.additionalDeliveryInformation') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.additionalDeliveryInformation}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.additionalDeliveryInformation" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.additionalDeliveryInformation" />  
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetNotaryAddress.additionalGeographicalInformation') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.additionalGeographicalInformation}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.additionalGeographicalInformation" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.additionalGeographicalInformation" />
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetNotaryAddress.streetNumber') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.streetNumber}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.streetNumber" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetNotaryAddress.streetName') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.streetName}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.streetName" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetNotaryAddress.placeNameOrService') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.placeNameOrService}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.placeNameOrService" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetNotaryAddress.postalCode') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.postalCode}" size="5" maxlength="5" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.postalCode" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetNotaryAddress.city') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.city}" maxlength="32" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.city" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.city" title="<g:message code="address.property.city.validationError" />" />
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['resources']?.invalidFields.contains('dhrNotRealAssetNotaryAddress.countryName') ? 'validation-failed' : ''}" value="${editList?.dhrNotRealAsset?.dhrNotRealAssetNotaryAddress?.countryName}" maxlength="38" id="dhrNotRealAsset.${listIndex}.dhrNotRealAssetNotaryAddress.countryName" name="dhrNotRealAsset[${listIndex}].dhrNotRealAssetNotaryAddress.countryName" />
            </div>
