    ...
    <legend><g:message code="dhr.property.dhrSpouseStatus.label" /></legend>
      ...
      <label class="required condition-isSpouseRetired-unfilled"><g:message code="dhr.property.dhrSpouseAddress.label" /> *  <span><g:message code="dhr.property.dhrSpouseAddress.help" /></span></label>
            <div id="dhrSpouseAddress" class="address-fieldset required condition-isSpouseRetired-unfilled  ${stepStates != null && stepStates['spouse']?.invalidFields.contains('dhrSpouseAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['spouse']?.invalidFields.contains('dhrSpouseAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.dhrSpouseAddress?.streetNumber}" size="5" maxlength="5" id="dhrSpouseAddress_streetNumber" name="dhrSpouseAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['spouse']?.invalidFields.contains('dhrSpouseAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.dhrSpouseAddress?.streetName}" maxlength="32" id="dhrSpouseAddress_streetName" name="dhrSpouseAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['spouse']?.invalidFields.contains('dhrSpouseAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.dhrSpouseAddress?.postalCode}" size="5" maxlength="5" id="dhrSpouseAddress_postalCode" name="dhrSpouseAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['spouse']?.invalidFields.contains('dhrSpouseAddress.city') ? 'validation-failed' : ''}" value="${rqt.dhrSpouseAddress?.city}" maxlength="32" id="dhrSpouseAddress_city" name="dhrSpouseAddress.city" title="<g:message code="address.property.city.validationError" />" />
