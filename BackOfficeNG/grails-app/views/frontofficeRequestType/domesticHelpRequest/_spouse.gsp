    ...
    <legend><g:message code="dhr.property.dhrSpouseStatus.label" /></legend>
      ...
      <label class="required condition-isSpouseRetired-unfilled"><g:message code="dhr.property.dhrSpouseAddress.label" /> *  <span><g:message code="dhr.property.dhrSpouseAddress.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.dhrSpouseAddress?.streetMatriculation}" id="dhrSpouseAddress.streetMatriculation" name="dhrSpouseAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.dhrSpouseAddress?.cityInseeCode}" id="dhrSpouseAddress.cityInseeCode" name="dhrSpouseAddress.cityInseeCode" />
