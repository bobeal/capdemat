    ...
    <legend><g:message code="dhr.property.dhrRequester.label" /></legend>
      ...
      <label class="required"><g:message code="dhr.property.dhrRequesterBirthDate.label" /> *  <span><g:message code="dhr.property.dhrRequesterBirthDate.help" /></span></label>
            <div class="date required  validate-date required ">
              <select class="day ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrRequesterBirthDate') ? 'validation-failed' : ''}"
              ...
              <select class="month ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrRequesterBirthDate') ? 'validation-failed' : ''}"
              ...
              <input type="text" maxlength="4" size="3"
                class="year ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrRequesterBirthDate') ? 'validation-failed' : ''}"
      ...
      <label class="required condition-isNonEuropean-filled"><g:message code="dhr.property.dhrRequesterFranceArrivalDate.label" /> *  <span><g:message code="dhr.property.dhrRequesterFranceArrivalDate.help" /></span></label>
            <div class="date required condition-isNonEuropean-filled  validate-date required condition-isNonEuropean-filled ">
              <select class="day ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrRequesterFranceArrivalDate') ? 'validation-failed' : ''}"
              ...
              <select class="month ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrRequesterFranceArrivalDate') ? 'validation-failed' : ''}"
              ...
              <input type="text" maxlength="4" size="3"
                class="year ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrRequesterFranceArrivalDate') ? 'validation-failed' : ''}"
    ...
    <legend><g:message code="dhr.property.dhrRequesterGuardian.label" /></legend>
      ...
      <label class="required condition-haveGuardian-filled"><g:message code="dhr.property.dhrGuardianAddress.label" /> *  <span><g:message code="dhr.property.dhrGuardianAddress.help" /></span></label>
            <div class="address-fieldset required condition-haveGuardian-filled  ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrGuardianAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrGuardianAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.dhrGuardianAddress?.streetNumber}" size="5" maxlength="5" id="dhrGuardianAddress.streetNumber" name="dhrGuardianAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrGuardianAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.dhrGuardianAddress?.streetName}" maxlength="32" id="dhrGuardianAddress.streetName" name="dhrGuardianAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            <label for="dhrGuardianAddress.placeNameOrService"><g:message code="address.property.placeNameOrService" /></label>
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrGuardianAddress.placeNameOrService') ? 'validation-failed' : ''}" value="${rqt.dhrGuardianAddress?.placeNameOrService}" maxlength="38" id="dhrGuardianAddress.placeNameOrService" name="dhrGuardianAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrGuardianAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.dhrGuardianAddress?.postalCode}" size="5" maxlength="5" id="dhrGuardianAddress.postalCode" name="dhrGuardianAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrGuardianAddress.city') ? 'validation-failed' : ''}" value="${rqt.dhrGuardianAddress?.city}" maxlength="32" id="dhrGuardianAddress.city" name="dhrGuardianAddress.city" title="<g:message code="address.property.city.validationError" />" />
            <label for="dhrGuardianAddress.countryName"><g:message code="address.property.countryName" /></label>
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrGuardianAddress.countryName') ? 'validation-failed' : ''}" value="${rqt.dhrGuardianAddress?.countryName}" maxlength="38" id="dhrGuardianAddress.countryName" name="dhrGuardianAddress.countryName" />
            </div>
