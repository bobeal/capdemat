    ...
    <legend><g:message code="dhr.property.dhrRequesterGuardian.label" /></legend>
      ...
      <label class="required condition-haveGuardian-filled"><g:message code="dhr.property.dhrGuardianAddress.label" /> *  <span><g:message code="dhr.property.dhrGuardianAddress.help" /></span></label>
            <div id="dhrGuardianAddress" class="address-fieldset required condition-haveGuardian-filled  ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrGuardianAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrGuardianAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.dhrGuardianAddress?.streetNumber}" size="5" maxlength="5" id="dhrGuardianAddress_streetNumber" name="dhrGuardianAddress.streetNumber" />
            ...
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['subject']?.invalidFields?.contains('dhrGuardianAddress.city') ? 'validation-failed' : ''}" value="${rqt.dhrGuardianAddress?.city}" maxlength="32" id="dhrGuardianAddress_city" name="dhrGuardianAddress.city" title="<g:message code="address.property.city.validationError" />" />
