  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.category.name}">
      <h2>
        ...
        <g:message code="dhr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      ...
      <ul>
        ...
        <li class="${currentStep == 'subject' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'dhr.step.subject.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
        ...
        <li class="${currentStep == 'familyReferent' ? 'current ' : ''}
          ...
          <a
            <g:if test="${currentStep != 'familyReferent' && rqt.stepStates['familyReferent'].state != 'unavailable'}">
        ...
        <li class="${currentStep == 'spouse' ? 'current ' : ''}
          ...
          <a
            <g:if test="${currentStep != 'spouse' && rqt.stepStates['spouse'].state != 'unavailable'}">
        ...
        <li class="${currentStep == 'resources' ? 'current ' : ''}
          ...
          <a
            <g:if test="${currentStep != 'resources' && rqt.stepStates['resources'].state != 'unavailable'}">
        ...
        <li class="${currentStep == 'taxes' ? 'current ' : ''}
          ...
          <a
            <g:if test="${currentStep != 'taxes' && rqt.stepStates['taxes'].state != 'unavailable'}">
