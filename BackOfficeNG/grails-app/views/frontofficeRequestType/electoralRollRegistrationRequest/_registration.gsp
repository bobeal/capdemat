    ...
    <label class="required condition-isDirect-filled"><g:message code="errr.property.subjectAddressOutsideCity.label" /> *  <span><g:message code="errr.property.subjectAddressOutsideCity.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.subjectAddressOutsideCity?.streetMatriculation}" id="subjectAddressOutsideCity.streetMatriculation" name="subjectAddressOutsideCity.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.subjectAddressOutsideCity?.cityInseeCode}" id="subjectAddressOutsideCity.cityInseeCode" name="subjectAddressOutsideCity.cityInseeCode" />
