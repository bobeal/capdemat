    ...
    <legend><g:message code="hcar.property.socialService.label" /></legend>
      ...
      <label class="required condition-isSocialServiceSupport-filled"><g:message code="hcar.property.professionalSupportSocialServiceAddress.label" /> *  <span><g:message code="hcar.property.professionalSupportSocialServiceAddress.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.professionalSupportSocialServiceAddress?.streetMatriculation}" id="professionalSupportSocialServiceAddress.streetMatriculation" name="professionalSupportSocialServiceAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.professionalSupportSocialServiceAddress?.cityInseeCode}" id="professionalSupportSocialServiceAddress.cityInseeCode" name="professionalSupportSocialServiceAddress.cityInseeCode" />
