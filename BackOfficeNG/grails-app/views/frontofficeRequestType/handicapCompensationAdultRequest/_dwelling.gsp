    ...
    <legend><g:message code="hcar.property.dwelling.label" /></legend>
      ...
      <label for="dwellingKind" class="required"><g:message code="hcar.property.dwellingKind.label" /> *  <span><g:message code="hcar.property.dwellingKind.help" /></span></label>
            <select id="dwellingKind" name="dwellingKind" class="required condition-isNotPlaceOfResidence-trigger  validate-not-first ${invalidFields.contains('dwellingKind') ? 'validation-failed' : ''}" title="<g:message code="hcar.property.dwellingKind.validationError" />">
      ...
      <label for="dwellingPrecision" class="required condition-isNotPlaceOfResidence-filled"><g:message code="hcar.property.dwellingPrecision.label" /> *  <span><g:message code="hcar.property.dwellingPrecision.help" /></span></label>
            <textarea id="dwellingPrecision" name="dwellingPrecision" class="required condition-isNotPlaceOfResidence-filled  validate-textarea ${invalidFields.contains('dwellingPrecision') ? 'validation-failed' : ''}" title="<g:message code="hcar.property.dwellingPrecision.validationError" />" rows="2" cols=""  maxlength="120">${rqt.dwellingPrecision}</textarea>
      ...
      <label for="dwellingReceptionType" class="required condition-isInEstablishmentReception-filled"><g:message code="hcar.property.dwellingReceptionType.label" /> *  <span><g:message code="hcar.property.dwellingReceptionType.help" /></span></label>
            <select id="dwellingReceptionType" name="dwellingReceptionType" class="required condition-isInEstablishmentReception-filled  validate-not-first ${invalidFields.contains('dwellingReceptionType') ? 'validation-failed' : ''}" title="<g:message code="hcar.property.dwellingReceptionType.validationError" />">
              <option value=""><g:message code="message.select.defaultOption" /></option>
      ...
      <label for="dwellingReceptionNaming" class="required condition-isInEstablishmentReception-filled"><g:message code="hcar.property.dwellingReceptionNaming.label" /> *  <span><g:message code="hcar.property.dwellingReceptionNaming.help" /></span></label>
            <input type="text" id="dwellingReceptionNaming" name="dwellingReceptionNaming" value="${rqt.dwellingReceptionNaming?.toString()}" 
                    class="required condition-isInEstablishmentReception-filled   ${invalidFields.contains('dwellingReceptionNaming') ? 'validation-failed' : ''}" title="<g:message code="hcar.property.dwellingReceptionNaming.validationError" />"  maxlength="80" />
      ...
      <label class="required condition-isInEstablishmentReception-filled"><g:message code="hcar.property.dwellingReceptionAddress.label" /> *  <span><g:message code="hcar.property.dwellingReceptionAddress.help" /></span></label>
            ...
            <input type="text" class="validate-addressLine38" value="${rqt.dwellingReceptionAddress?.additionalDeliveryInformation}" maxlength="38" id="dwellingReceptionAddress.additionalDeliveryInformation" name="dwellingReceptionAddress.additionalDeliveryInformation" />  
            ...
            <input type="text" class="validate-addressLine38" value="${rqt.dwellingReceptionAddress?.additionalGeographicalInformation}" maxlength="38" id="dwellingReceptionAddress.additionalGeographicalInformation" name="dwellingReceptionAddress.additionalGeographicalInformation" />
            ...
            <input type="text" class="line1 validate-streetNumber" value="${rqt.dwellingReceptionAddress?.streetNumber}" size="5" maxlength="5" id="dwellingReceptionAddress.streetNumber" name="dwellingReceptionAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName" value="${rqt.dwellingReceptionAddress?.streetName}" maxlength="32" id="dwellingReceptionAddress.streetName" name="dwellingReceptionAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            <label for="dwellingReceptionAddress.placeNameOrService"><g:message code="address.property.placeNameOrService" /></label>
            <input type="text" class="validate-addressLine38" value="${rqt.dwellingReceptionAddress?.placeNameOrService}" maxlength="38" id="dwellingReceptionAddress.placeNameOrService" name="dwellingReceptionAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required validate-postalCode" value="${rqt.dwellingReceptionAddress?.postalCode}" size="5" maxlength="5" id="dwellingReceptionAddress.postalCode" name="dwellingReceptionAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city" value="${rqt.dwellingReceptionAddress?.city}" maxlength="32" id="dwellingReceptionAddress.city" name="dwellingReceptionAddress.city" title="<g:message code="address.property.city.validationError" />" />
            <label for="dwellingReceptionAddress.countryName"><g:message code="address.property.countryName" /></label>
            <input type="text" class="validate-addressLine38" value="${rqt.dwellingReceptionAddress?.countryName}" maxlength="38" id="dwellingReceptionAddress.countryName" name="dwellingReceptionAddress.countryName" />
            </div>
      ...
      <label for="dwellingSocialReceptionNaming" class="required condition-isInSocialReception-filled"><g:message code="hcar.property.dwellingSocialReceptionNaming.label" /> *  <span><g:message code="hcar.property.dwellingSocialReceptionNaming.help" /></span></label>
            <input type="text" id="dwellingSocialReceptionNaming" name="dwellingSocialReceptionNaming" value="${rqt.dwellingSocialReceptionNaming?.toString()}" 
                    class="required condition-isInSocialReception-filled   ${invalidFields.contains('dwellingSocialReceptionNaming') ? 'validation-failed' : ''}" title="<g:message code="hcar.property.dwellingSocialReceptionNaming.validationError" />"  maxlength="80" />
      ...
      <label class="required condition-isInSocialReception-filled"><g:message code="hcar.property.dwellingSocialReceptionAddress.label" /> *  <span><g:message code="hcar.property.dwellingSocialReceptionAddress.help" /></span></label>
            ...
            <input type="text" class="validate-addressLine38" value="${rqt.dwellingSocialReceptionAddress?.additionalDeliveryInformation}" maxlength="38" id="dwellingSocialReceptionAddress.additionalDeliveryInformation" name="dwellingSocialReceptionAddress.additionalDeliveryInformation" />  
            ...
            <input type="text" class="validate-addressLine38" value="${rqt.dwellingSocialReceptionAddress?.additionalGeographicalInformation}" maxlength="38" id="dwellingSocialReceptionAddress.additionalGeographicalInformation" name="dwellingSocialReceptionAddress.additionalGeographicalInformation" />
            ...
            <input type="text" class="line1 validate-streetNumber" value="${rqt.dwellingSocialReceptionAddress?.streetNumber}" size="5" maxlength="5" id="dwellingSocialReceptionAddress.streetNumber" name="dwellingSocialReceptionAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName" value="${rqt.dwellingSocialReceptionAddress?.streetName}" maxlength="32" id="dwellingSocialReceptionAddress.streetName" name="dwellingSocialReceptionAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            <label for="dwellingSocialReceptionAddress.placeNameOrService"><g:message code="address.property.placeNameOrService" /></label>
            <input type="text" class="validate-addressLine38" value="${rqt.dwellingSocialReceptionAddress?.placeNameOrService}" maxlength="38" id="dwellingSocialReceptionAddress.placeNameOrService" name="dwellingSocialReceptionAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required validate-postalCode" value="${rqt.dwellingSocialReceptionAddress?.postalCode}" size="5" maxlength="5" id="dwellingSocialReceptionAddress.postalCode" name="dwellingSocialReceptionAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city" value="${rqt.dwellingSocialReceptionAddress?.city}" maxlength="32" id="dwellingSocialReceptionAddress.city" name="dwellingSocialReceptionAddress.city" title="<g:message code="address.property.city.validationError" />" />
            <label for="dwellingSocialReceptionAddress.countryName"><g:message code="address.property.countryName" /></label>
            <input type="text" class="validate-addressLine38" value="${rqt.dwellingSocialReceptionAddress?.countryName}" maxlength="38" id="dwellingSocialReceptionAddress.countryName" name="dwellingSocialReceptionAddress.countryName" />
            </div>
