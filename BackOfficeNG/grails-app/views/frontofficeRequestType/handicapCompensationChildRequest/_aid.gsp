    ...
    <legend><g:message code="hccr.property.socialService.label" /></legend>
      ...
      <label class="required condition-isSocialServiceSupport-filled"><g:message code="hccr.property.socialServiceAddress.label" /> *  <span><g:message code="hccr.property.socialServiceAddress.help" /></span></label>
            <div id="socialServiceAddress" class="address-fieldset required condition-isSocialServiceSupport-filled  ${stepStates != null && stepStates['aid']?.invalidFields.contains('socialServiceAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['aid']?.invalidFields.contains('socialServiceAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.socialServiceAddress?.streetNumber}" size="5" maxlength="5" id="socialServiceAddress_streetNumber" name="socialServiceAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['aid']?.invalidFields.contains('socialServiceAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.socialServiceAddress?.streetName}" maxlength="32" id="socialServiceAddress_streetName" name="socialServiceAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['aid']?.invalidFields.contains('socialServiceAddress.city') ? 'validation-failed' : ''}" value="${rqt.socialServiceAddress?.city}" maxlength="32" id="socialServiceAddress_city" name="socialServiceAddress.city" title="<g:message code="address.property.city.validationError" />" />
