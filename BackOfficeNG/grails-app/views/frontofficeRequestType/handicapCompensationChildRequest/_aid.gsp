    ...
    <div class="collection-fieldset condition-isHomeIntervenant-filled validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add condition-isHomeIntervenant-filled">
        ...
        <label for="homeIntervenants.${listIndex}.homeIntervenantKind" class="required"><g:message code="hccr.property.homeIntervenantKind.label" /> *  <span><g:message code="hccr.property.homeIntervenantKind.help" /></span></label>
            <select id="homeIntervenants.${listIndex}.homeIntervenantKind" name="homeIntervenants[${listIndex}].homeIntervenantKind" class="required condition-isOtherHomeIntervant-trigger  validate-not-first ${rqt.stepStates['aid'].invalidFields.contains('homeIntervenants.homeIntervenantKind') ? 'validation-failed' : ''}" title="<g:message code="hccr.property.homeIntervenantKind.validationError" />">
        ...
        <label for="homeIntervenants.${listIndex}.homeIntervenantDetails" class="required condition-isOtherHomeIntervant-filled"><g:message code="hccr.property.homeIntervenantDetails.label" /> *  <span><g:message code="hccr.property.homeIntervenantDetails.help" /></span></label>
            <input type="text" id="homeIntervenants.${listIndex}.homeIntervenantDetails" name="homeIntervenants[${listIndex}].homeIntervenantDetails" value="${editList?.homeIntervenants?.homeIntervenantDetails?.toString()}" 
                    class="required condition-isOtherHomeIntervant-filled   ${rqt.stepStates['aid'].invalidFields.contains('homeIntervenants.homeIntervenantDetails') ? 'validation-failed' : ''}" title="<g:message code="hccr.property.homeIntervenantDetails.validationError" />"  maxlength="60" />
      ...
      <fieldset class="collection-fieldset-add required condition-isCareServices-filled">
        ...
        <label for="careServices.${listIndex}.careServiceKind" class="required"><g:message code="hccr.property.careServiceKind.label" /> *  <span><g:message code="hccr.property.careServiceKind.help" /></span></label>
            <input type="text" id="careServices.${listIndex}.careServiceKind" name="careServices[${listIndex}].careServiceKind" value="${editList?.careServices?.careServiceKind?.toString()}" 
                    class="required  validate-string ${rqt.stepStates['aid'].invalidFields.contains('careServices.careServiceKind') ? 'validation-failed' : ''}" title="<g:message code="hccr.property.careServiceKind.validationError" />"   />
        ...
        <label for="careServices.${listIndex}.careServiceProviderName" class="required condition-isCareServiceEmployer-unfilled"><g:message code="hccr.property.careServiceProviderName.label" /> *  <span><g:message code="hccr.property.careServiceProviderName.help" /></span></label>
            <input type="text" id="careServices.${listIndex}.careServiceProviderName" name="careServices[${listIndex}].careServiceProviderName" value="${editList?.careServices?.careServiceProviderName?.toString()}" 
                    class="required condition-isCareServiceEmployer-unfilled  validate-lastName ${rqt.stepStates['aid'].invalidFields.contains('careServices.careServiceProviderName') ? 'validation-failed' : ''}" title="<g:message code="hccr.property.careServiceProviderName.validationError" />"  maxlength="38" />
        ...
        <label class="condition-isCareServiceEmployer-unfilled"><g:message code="hccr.property.careServiceProviderAddress.label" />   <span><g:message code="hccr.property.careServiceProviderAddress.help" /></span></label>
            <div id="careServices.${listIndex}.careServiceProviderAddress" class="address-fieldset condition-isCareServiceEmployer-unfilled  ${rqt.stepStates['aid'].invalidFields.contains('careServices.careServiceProviderAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="validate-addressLine38 ${rqt.stepStates['aid'].invalidFields.contains('careServices.careServiceProviderAddress.additionalGeographicalInformation') ? 'validation-failed' : ''}" value="${editList?.careServices?.careServiceProviderAddress?.additionalGeographicalInformation}" maxlength="38" id="careServices.${listIndex}.careServiceProviderAddress.additionalGeographicalInformation" name="careServices[${listIndex}].careServiceProviderAddress.additionalGeographicalInformation" />
            ...
            <input type="text" class="line1 validate-streetNumber ${rqt.stepStates['aid'].invalidFields.contains('careServices.careServiceProviderAddress.streetNumber') ? 'validation-failed' : ''}" value="${editList?.careServices?.careServiceProviderAddress?.streetNumber}" size="5" maxlength="5" id="careServices.${listIndex}.careServiceProviderAddress_streetNumber" name="careServices[${listIndex}].careServiceProviderAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${rqt.stepStates['aid'].invalidFields.contains('careServices.careServiceProviderAddress.streetName') ? 'validation-failed' : ''}" value="${editList?.careServices?.careServiceProviderAddress?.streetName}" maxlength="32" id="careServices.${listIndex}.careServiceProviderAddress_streetName" name="careServices[${listIndex}].careServiceProviderAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="line2 required validate-city ${rqt.stepStates['aid'].invalidFields.contains('careServices.careServiceProviderAddress.city') ? 'validation-failed' : ''}" value="${editList?.careServices?.careServiceProviderAddress?.city}" maxlength="32" id="careServices.${listIndex}.careServiceProviderAddress_city" name="careServices[${listIndex}].careServiceProviderAddress.city" title="<g:message code="address.property.city.validationError" />" />
            ...
            <input type="text" class="validate-addressLine38 ${rqt.stepStates['aid'].invalidFields.contains('careServices.careServiceProviderAddress.countryName') ? 'validation-failed' : ''}" value="${editList?.careServices?.careServiceProviderAddress?.countryName}" maxlength="38" id="careServices.${listIndex}.careServiceProviderAddress.countryName" name="careServices[${listIndex}].careServiceProviderAddress.countryName" />
            </div>
      ...
      <fieldset class="collection-fieldset-add condition-isProfessionals-filled">
        ...
        <label for="professionals.${listIndex}.professionalLastName" class="required"><g:message code="hccr.property.professionalLastName.label" /> *  <span><g:message code="hccr.property.professionalLastName.help" /></span></label>
            <input type="text" id="professionals.${listIndex}.professionalLastName" name="professionals[${listIndex}].professionalLastName" value="${editList?.professionals?.professionalLastName?.toString()}" 
                    class="required  validate-lastName ${rqt.stepStates['aid'].invalidFields.contains('professionals.professionalLastName') ? 'validation-failed' : ''}" title="<g:message code="hccr.property.professionalLastName.validationError" />"  maxlength="38" />
        ...
        <label for="professionals.${listIndex}.professionalFirstName" class="required"><g:message code="hccr.property.professionalFirstName.label" /> *  <span><g:message code="hccr.property.professionalFirstName.help" /></span></label>
            <input type="text" id="professionals.${listIndex}.professionalFirstName" name="professionals[${listIndex}].professionalFirstName" value="${editList?.professionals?.professionalFirstName?.toString()}" 
                    class="required  validate-firstName ${rqt.stepStates['aid'].invalidFields.contains('professionals.professionalFirstName') ? 'validation-failed' : ''}" title="<g:message code="hccr.property.professionalFirstName.validationError" />"  maxlength="38" />
        ...
        <label class="required"><g:message code="hccr.property.professionalAddress.label" /> *  <span><g:message code="hccr.property.professionalAddress.help" /></span></label>
            <div id="professionals.${listIndex}.professionalAddress" class="address-fieldset required  ${rqt.stepStates['aid'].invalidFields.contains('professionals.professionalAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="validate-addressLine38 ${rqt.stepStates['aid'].invalidFields.contains('professionals.professionalAddress.additionalDeliveryInformation') ? 'validation-failed' : ''}" value="${editList?.professionals?.professionalAddress?.additionalDeliveryInformation}" maxlength="38" id="professionals.${listIndex}.professionalAddress.additionalDeliveryInformation" name="professionals[${listIndex}].professionalAddress.additionalDeliveryInformation" />  
            ...
            <input type="text" class="line2 required validate-streetName ${rqt.stepStates['aid'].invalidFields.contains('professionals.professionalAddress.streetName') ? 'validation-failed' : ''}" value="${editList?.professionals?.professionalAddress?.streetName}" maxlength="32" id="professionals.${listIndex}.professionalAddress_streetName" name="professionals[${listIndex}].professionalAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="validate-addressLine38 ${rqt.stepStates['aid'].invalidFields.contains('professionals.professionalAddress.placeNameOrService') ? 'validation-failed' : ''}" value="${editList?.professionals?.professionalAddress?.placeNameOrService}" maxlength="38" id="professionals.${listIndex}.professionalAddress.placeNameOrService" name="professionals[${listIndex}].professionalAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required validate-postalCode ${rqt.stepStates['aid'].invalidFields.contains('professionals.professionalAddress.postalCode') ? 'validation-failed' : ''}" value="${editList?.professionals?.professionalAddress?.postalCode}" size="5" maxlength="5" id="professionals.${listIndex}.professionalAddress_postalCode" name="professionals[${listIndex}].professionalAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${rqt.stepStates['aid'].invalidFields.contains('professionals.professionalAddress.city') ? 'validation-failed' : ''}" value="${editList?.professionals?.professionalAddress?.city}" maxlength="32" id="professionals.${listIndex}.professionalAddress_city" name="professionals[${listIndex}].professionalAddress.city" title="<g:message code="address.property.city.validationError" />" />
            ...
            <input type="text" class="validate-addressLine38 ${rqt.stepStates['aid'].invalidFields.contains('professionals.professionalAddress.countryName') ? 'validation-failed' : ''}" value="${editList?.professionals?.professionalAddress?.countryName}" maxlength="38" id="professionals.${listIndex}.professionalAddress.countryName" name="professionals[${listIndex}].professionalAddress.countryName" />
            </div>
