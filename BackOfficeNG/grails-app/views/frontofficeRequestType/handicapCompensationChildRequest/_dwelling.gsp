    ...
    <legend><g:message code="hccr.property.dwelling.label" /></legend>
      ...
      <label class="required condition-isInEstablishmentReception-filled"><g:message code="hccr.property.dwellingReceptionAddress.label" /> *  <span><g:message code="hccr.property.dwellingReceptionAddress.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.dwellingReceptionAddress?.streetMatriculation}" id="dwellingReceptionAddress.streetMatriculation" name="dwellingReceptionAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.dwellingReceptionAddress?.cityInseeCode}" id="dwellingReceptionAddress.cityInseeCode" name="dwellingReceptionAddress.cityInseeCode" />
      ...
      <label class="required condition-isInSocialReception-filled"><g:message code="hccr.property.dwellingSocialReceptionAddress.label" /> *  <span><g:message code="hccr.property.dwellingSocialReceptionAddress.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.dwellingSocialReceptionAddress?.streetMatriculation}" id="dwellingSocialReceptionAddress.streetMatriculation" name="dwellingSocialReceptionAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.dwellingSocialReceptionAddress?.cityInseeCode}" id="dwellingSocialReceptionAddress.cityInseeCode" name="dwellingSocialReceptionAddress.cityInseeCode" />
