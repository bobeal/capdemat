    ...
    <legend><g:message code="hccr.property.schooling.label" /></legend>
      ...
      <label class="required condition-isSchoolingEnrolment-filled"><g:message code="hccr.property.schoolingSchoolAddress.label" /> *  <span><g:message code="hccr.property.schoolingSchoolAddress.help" /></span></label>
            <div id="schoolingSchoolAddress" class="address-fieldset required condition-isSchoolingEnrolment-filled  ${stepStates != null && stepStates['occupationnalAndSchoolStatus']?.invalidFields.contains('schoolingSchoolAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['occupationnalAndSchoolStatus']?.invalidFields.contains('schoolingSchoolAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.schoolingSchoolAddress?.streetNumber}" size="5" maxlength="5" id="schoolingSchoolAddress_streetNumber" name="schoolingSchoolAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['occupationnalAndSchoolStatus']?.invalidFields.contains('schoolingSchoolAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.schoolingSchoolAddress?.streetName}" maxlength="32" id="schoolingSchoolAddress_streetName" name="schoolingSchoolAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['occupationnalAndSchoolStatus']?.invalidFields.contains('schoolingSchoolAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.schoolingSchoolAddress?.postalCode}" size="5" maxlength="5" id="schoolingSchoolAddress_postalCode" name="schoolingSchoolAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['occupationnalAndSchoolStatus']?.invalidFields.contains('schoolingSchoolAddress.city') ? 'validation-failed' : ''}" value="${rqt.schoolingSchoolAddress?.city}" maxlength="32" id="schoolingSchoolAddress_city" name="schoolingSchoolAddress.city" title="<g:message code="address.property.city.validationError" />" />
      ...
      <label class="condition-isAccompaniedHomeSchooling-filled"><g:message code="hccr.property.schoolingHomeSchoolingAccompanistAddress.label" />   <span><g:message code="hccr.property.schoolingHomeSchoolingAccompanistAddress.help" /></span></label>
            <div id="schoolingHomeSchoolingAccompanistAddress" class="address-fieldset condition-isAccompaniedHomeSchooling-filled  ${stepStates != null && stepStates['occupationnalAndSchoolStatus']?.invalidFields.contains('schoolingHomeSchoolingAccompanistAddress') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['occupationnalAndSchoolStatus']?.invalidFields.contains('schoolingHomeSchoolingAccompanistAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.schoolingHomeSchoolingAccompanistAddress?.streetName}" maxlength="32" id="schoolingHomeSchoolingAccompanistAddress_streetName" name="schoolingHomeSchoolingAccompanistAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['occupationnalAndSchoolStatus']?.invalidFields.contains('schoolingHomeSchoolingAccompanistAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.schoolingHomeSchoolingAccompanistAddress?.postalCode}" size="5" maxlength="5" id="schoolingHomeSchoolingAccompanistAddress_postalCode" name="schoolingHomeSchoolingAccompanistAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['occupationnalAndSchoolStatus']?.invalidFields.contains('schoolingHomeSchoolingAccompanistAddress.city') ? 'validation-failed' : ''}" value="${rqt.schoolingHomeSchoolingAccompanistAddress?.city}" maxlength="32" id="schoolingHomeSchoolingAccompanistAddress_city" name="schoolingHomeSchoolingAccompanistAddress.city" title="<g:message code="address.property.city.validationError" />" />
