    ...
    <legend><g:message code="hccr.property.schooling.label" /></legend>
      ...
      <label class="required condition-isSchoolingEnrolment-filled"><g:message code="hccr.property.schoolingSchoolAddress.label" /> *  <span><g:message code="hccr.property.schoolingSchoolAddress.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.schoolingSchoolAddress?.streetMatriculation}" id="schoolingSchoolAddress.streetMatriculation" name="schoolingSchoolAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.schoolingSchoolAddress?.cityInseeCode}" id="schoolingSchoolAddress.cityInseeCode" name="schoolingSchoolAddress.cityInseeCode" />
      ...
      <label class="condition-isAccompaniedHomeSchooling-filled"><g:message code="hccr.property.schoolingHomeSchoolingAccompanistAddress.label" />   <span><g:message code="hccr.property.schoolingHomeSchoolingAccompanistAddress.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.schoolingHomeSchoolingAccompanistAddress?.streetMatriculation}" id="schoolingHomeSchoolingAccompanistAddress.streetMatriculation" name="schoolingHomeSchoolingAccompanistAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.schoolingHomeSchoolingAccompanistAddress?.cityInseeCode}" id="schoolingHomeSchoolingAccompanistAddress.cityInseeCode" name="schoolingHomeSchoolingAccompanistAddress.cityInseeCode" />
    ...
    <legend><g:message code="hccr.property.studies.label" /></legend>
      ...
      <label class="required condition-isHighSchool-filled"><g:message code="hccr.property.studiesHighSchoolAddress.label" /> *  <span><g:message code="hccr.property.studiesHighSchoolAddress.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.studiesHighSchoolAddress?.streetMatriculation}" id="studiesHighSchoolAddress.streetMatriculation" name="studiesHighSchoolAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.studiesHighSchoolAddress?.cityInseeCode}" id="studiesHighSchoolAddress.cityInseeCode" name="studiesHighSchoolAddress.cityInseeCode" />
    ...
    <legend><g:message code="hccr.property.professionalStatus.label" /></legend>
      ...
      <label class="condition-isEmployed-filled"><g:message code="hccr.property.professionalStatusAddress.label" />   <span><g:message code="hccr.property.professionalStatusAddress.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.professionalStatusAddress?.streetMatriculation}" id="professionalStatusAddress.streetMatriculation" name="professionalStatusAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.professionalStatusAddress?.cityInseeCode}" id="professionalStatusAddress.cityInseeCode" name="professionalStatusAddress.cityInseeCode" />
