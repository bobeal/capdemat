    ...
    <legend><g:message code="hccr.property.schooling.label" /></legend>
      ...
      <label class="required condition-isSchoolingEnrolment-filled"><g:message code="hccr.property.schoolingSchoolAddress.label" /> *  <span><g:message code="hccr.property.schoolingSchoolAddress.help" /></span></label>
            ...
            <input type="hidden" value="" id="schoolingSchoolAddress_streetMatriculation" name="schoolingSchoolAddress.streetMatriculation" />
            ...
            <input type="hidden" value="" id="schoolingSchoolAddress_cityInseeCode" name="schoolingSchoolAddress.cityInseeCode" />
      ...
      <label class="condition-isAccompaniedHomeSchooling-filled"><g:message code="hccr.property.schoolingHomeSchoolingAccompanistAddress.label" />   <span><g:message code="hccr.property.schoolingHomeSchoolingAccompanistAddress.help" /></span></label>
            ...
            <input type="hidden" value="" id="schoolingHomeSchoolingAccompanistAddress_streetMatriculation" name="schoolingHomeSchoolingAccompanistAddress.streetMatriculation" />
            ...
            <input type="hidden" value="" id="schoolingHomeSchoolingAccompanistAddress_cityInseeCode" name="schoolingHomeSchoolingAccompanistAddress.cityInseeCode" />
    ...
    <legend><g:message code="hccr.property.studies.label" /></legend>
      ...
      <label class="required condition-isHighSchool-filled"><g:message code="hccr.property.studiesHighSchoolAddress.label" /> *  <span><g:message code="hccr.property.studiesHighSchoolAddress.help" /></span></label>
            ...
            <input type="hidden" value="" id="studiesHighSchoolAddress_streetMatriculation" name="studiesHighSchoolAddress.streetMatriculation" />
            ...
            <input type="hidden" value="" id="studiesHighSchoolAddress_cityInseeCode" name="studiesHighSchoolAddress.cityInseeCode" />
    ...
    <legend><g:message code="hccr.property.professionalStatus.label" /></legend>
      ...
      <label class="condition-isEmployed-filled"><g:message code="hccr.property.professionalStatusAddress.label" />   <span><g:message code="hccr.property.professionalStatusAddress.help" /></span></label>
            ...
            <input type="hidden" value="" id="professionalStatusAddress_streetMatriculation" name="professionalStatusAddress.streetMatriculation" />
            ...
            <input type="hidden" value="" id="professionalStatusAddress_cityInseeCode" name="professionalStatusAddress.cityInseeCode" />
