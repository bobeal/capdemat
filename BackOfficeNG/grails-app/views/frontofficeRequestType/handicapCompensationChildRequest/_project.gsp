    ...
    <legend><g:message code="hccr.property.projectRequests.label" /></legend>
      ...
      <label for="projectRequestsOtherDetails" class="required condition-isOtherRequest-filled"><g:message code="hccr.property.projectRequestsOtherDetails.label" /> *  <span><g:message code="hccr.property.projectRequestsOtherDetails.help" /></span></label>
            <input type="text" id="projectRequestsOtherDetails" name="projectRequestsOtherDetails" value="${rqt.projectRequestsOtherDetails?.toString()}" 
                    class="required condition-isOtherRequest-filled   ${stepStates != null && stepStates['project']?.invalidFields?.contains('projectRequestsOtherDetails') ? 'validation-failed' : ''}" title="<g:message code="hccr.property.projectRequestsOtherDetails.validationError" />"  maxlength="60" />
    ...
    <label for="projectWish" class=""><g:message code="hccr.property.projectWish.label" />   <span><g:message code="hccr.property.projectWish.help" /></span></label>
            <textarea id="projectWish" name="projectWish" class="  validate-textarea ${stepStates != null && stepStates['project']?.invalidFields?.contains('projectWish') ? 'validation-failed' : ''}" title="<g:message code="hccr.property.projectWish.validationError" />" rows="10" cols=""  maxlength="600">${rqt.projectWish}</textarea>
    ...
    <label for="projectNeeds" class=""><g:message code="hccr.property.projectNeeds.label" />   <span><g:message code="hccr.property.projectNeeds.help" /></span></label>
            <textarea id="projectNeeds" name="projectNeeds" class="  validate-textarea ${stepStates != null && stepStates['project']?.invalidFields?.contains('projectNeeds') ? 'validation-failed' : ''}" title="<g:message code="hccr.property.projectNeeds.validationError" />" rows="10" cols=""  maxlength="600">${rqt.projectNeeds}</textarea>
    ...
    <label for="projectComments" class=""><g:message code="hccr.property.projectComments.label" />   <span><g:message code="hccr.property.projectComments.help" /></span></label>
            <textarea id="projectComments" name="projectComments" class="  validate-textarea ${stepStates != null && stepStates['project']?.invalidFields?.contains('projectComments') ? 'validation-failed' : ''}" title="<g:message code="hccr.property.projectComments.validationError" />" rows="10" cols=""  maxlength="600">${rqt.projectComments}</textarea>
