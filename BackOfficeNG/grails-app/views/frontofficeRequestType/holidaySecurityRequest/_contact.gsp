    ...
    <label class="required"><g:message code="hsr.property.otherContactAddress.label" /> *  <span><g:message code="hsr.property.otherContactAddress.help" /></span></label>
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['contact']?.invalidFields.contains('otherContactAddress.streetNumber') ? 'validation-failed' : ''}" value="${rqt.otherContactAddress?.streetNumber}" size="5" maxlength="5" id="otherContactAddress.streetNumber" name="otherContactAddress.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['contact']?.invalidFields.contains('otherContactAddress.streetName') ? 'validation-failed' : ''}" value="${rqt.otherContactAddress?.streetName}" maxlength="32" id="otherContactAddress.streetName" name="otherContactAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            <input type="hidden" value="${rqt.otherContactAddress?.streetMatriculation}" id="otherContactAddress.streetMatriculation" name="otherContactAddress.streetMatriculation" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['contact']?.invalidFields.contains('otherContactAddress.postalCode') ? 'validation-failed' : ''}" value="${rqt.otherContactAddress?.postalCode}" size="5" maxlength="5" id="otherContactAddress.postalCode" name="otherContactAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['contact']?.invalidFields.contains('otherContactAddress.city') ? 'validation-failed' : ''}" value="${rqt.otherContactAddress?.city}" maxlength="32" id="otherContactAddress.city" name="otherContactAddress.city" title="<g:message code="address.property.city.validationError" />" />
            <input type="hidden" value="${rqt.otherContactAddress?.cityInseeCode}" id="otherContactAddress.cityInseeCode" name="otherContactAddress.cityInseeCode" />
