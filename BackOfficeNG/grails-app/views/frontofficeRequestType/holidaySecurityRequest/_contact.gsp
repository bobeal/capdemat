    ...
    <label class="required"><g:message code="hsr.property.otherContactAddress.label" /> *  <span><g:message code="hsr.property.otherContactAddress.help" /></span></label>
            ...
            <input type="hidden" value="" id="otherContactAddress_streetMatriculation" name="otherContactAddress.streetMatriculation" />
            ...
            <input type="hidden" value="" id="otherContactAddress_cityInseeCode" name="otherContactAddress.cityInseeCode" />
