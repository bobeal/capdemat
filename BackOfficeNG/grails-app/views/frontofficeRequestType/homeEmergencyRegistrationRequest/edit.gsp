...
<html>
  <head>
     <title>${message(code:'herr.description')}</title>
  ...
  <body>
    <g:set var="requestTypeInfo">
      {"label": "${requestTypeLabel}"
        ,"steps": [  "subject-required",  "document",  "validation-required"  ]
      }
    </g:set>
    ...
    <h2 class="request-creation"> <g:message code="herr.label" /></h2>
    <p><g:message code="herr.description" /></p> 
    <p><g:message code="request.duration.label" /><strong> : <g:message code="herr.duration.value" /></strong></p>
    <p>
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${['subject', 'firstStep'].contains(currentStep) ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="herr.step.subject.label" /> *
          </strong>
       ...
       <div id="subject">
         <form method="post"  id="stepForm-subject" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="herr.step.subject.label" />
             <span><g:message code="herr.step.subject.desc" /></span>
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/homeEmergencyRegistrationRequest/subject" />         
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/homeEmergencyRegistrationRequest/validation0" />
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="herr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
