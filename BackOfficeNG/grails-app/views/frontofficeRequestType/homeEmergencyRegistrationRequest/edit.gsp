  ...
  <body>
    ...
    <div id="request" class="main-box">
      <h2>
        ...
        <g:message code="herr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="herr" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'subject' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'herr.step.subject.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
