  ...
  <body>
    ...
    <div id="request" class="main-box">
      <h2>
        ...
        <g:message code="ladrr.label" />
        <span><g:message code="ladrr.description" /></span> 
      </h2>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="ladrr" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'subject' ? 'current' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'ladrr.step.subject.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
