...
<html>
  <head>
     <title>${message(code:'ladrr.description')}</title>
  ...
  <body>
    ...
    <h2 class="request-creation"> <g:message code="ladrr.label" /></h2>
    <p><g:message code="ladrr.description" /></p> 
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${['subject', 'firstStep'].contains(currentStep) ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="ladrr.step.subject.label" /> *
          </strong>
       ...
       <div id="subject">
         <form method="post"  id="stepForm-subject" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="ladrr.step.subject.label" />
             <span><g:message code="ladrr.step.subject.desc" /></span>
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/learningActivitiesDiscoveryRegistrationRequest/subject" />         
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/learningActivitiesDiscoveryRegistrationRequest/validation0" />
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="ladrr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
