...
<html>
  <head>
     <title>${message(code:'lcrr.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.category.name}">
      <h2>
        ...
        <g:message code="lcrr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="lcrr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="lcrr" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'enfant' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'lcrr.step.enfant.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
        ...
        <li class="${currentStep == 'reglements' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="lcrr.step.reglements.label" /> *
              <span class="help">
