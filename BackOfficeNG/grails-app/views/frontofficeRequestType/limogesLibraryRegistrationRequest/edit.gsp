...
<html>
  <head>
     <title>${message(code:'llrr.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box">
      <h2>
        ...
        <g:message code="llrr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="llrr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="llrr" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'registration' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'llrr.step.registration.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
        ...
        <li class="${currentStep == 'rules' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="llrr.step.rules.label" /> *
              <span class="help">
