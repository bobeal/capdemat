...
<html>
  <head>
     <title>${message(code:'lpsrr.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box">
      <h2>
        ...
        <g:message code="lpsrr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="lpsrr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="lpsrr" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'requester' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'lpsrr.step.requester.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
        ...
        <li class="${currentStep == 'reservation' ? 'current ' : ''}
          
            ${rqt.stepStates['reservation'].state}
          
          ">
          <span class="number">2</span>
          <a
            <g:if test="${currentStep != 'reservation' && rqt.stepStates['reservation'].state != 'unavailable'}">
              href="${createLink(controller:'frontofficeRequest', action : 'edit', params:['id':rqt.id,'currentStep':'reservation'])}"
            </g:if>
          >
            
              <g:message code="lpsrr.step.reservation.label" /> *
              <span class="help">
                
                  <g:message code="request.step.message.${rqt.stepStates['reservation'].state}" />
        ...
        <li class="${currentStep == 'complement' ? 'current ' : ''}
          
            ${rqt.stepStates['complement'].state}
          
          ">
          <span class="number">3</span>
          <a
            <g:if test="${currentStep != 'complement' && rqt.stepStates['complement'].state != 'unavailable'}">
              href="${createLink(controller:'frontofficeRequest', action : 'edit', params:['id':rqt.id,'currentStep':'complement'])}"
            </g:if>
          >
            
              <g:message code="lpsrr.step.complement.label" /> *
              <span class="help">
                
                  <g:message code="request.step.message.${rqt.stepStates['complement'].state}" />
        ...
        <li class="${currentStep == 'rules' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="lpsrr.step.rules.label" /> *
              <span class="help">
