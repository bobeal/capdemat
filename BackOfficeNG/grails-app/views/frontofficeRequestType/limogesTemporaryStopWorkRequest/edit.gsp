...
<html>
  <head>
     <title>${message(code:'ltswr.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box">
      <h2>
        ...
        <g:message code="ltswr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="ltswr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="ltswr" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'requester' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'ltswr.step.requester.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
        ...
        <li class="${currentStep == 'work' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="ltswr.step.work.label" /> *
              <span class="help">
        ...
        <li class="${currentStep == 'informations' ? 'current ' : ''}
          
            ${rqt.stepStates['informations'].state}
          
          ">
          <span class="number">3</span>
          <a
            <g:if test="${currentStep != 'informations' && rqt.stepStates['informations'].state != 'unavailable'}">
              href="${createLink(controller:'frontofficeRequest', action : 'edit', params:['id':rqt.id,'currentStep':'informations'])}"
            </g:if>
          >
            
              <g:message code="ltswr.step.informations.label" /> *
              <span class="help">
                
                  <g:message code="request.step.message.${rqt.stepStates['informations'].state}" />
        ...
        <li class="${currentStep == 'rules' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="ltswr.step.rules.label" /> *
              <span class="help">
