...
<html>
  <head>
     <title>${message(code:'mcerrr.description')}</title>
    <meta name="layout" content="fo_main" />
    <link rel="stylesheet" type="text/css" href="${resource(dir:'css/frontoffice', file:'request.css')}" />
    <link rel="stylesheet" type="text/css" href="${resource(dir:'css/frontoffice', file:'mcerr.css')}" />
  ...
  <body>
    <g:set var="requestTypeInfo">
      {"label": "${requestTypeLabel}"
        ,"steps": [  "registration-required",  "situation-required",  "document",  "validation-required"  ]
      }
    </g:set>
    ...
    <h2 class="request-creation"> <g:message code="mcerrr.label" /></h2>
    <p><g:message code="mcerrr.description" /></p> 
    <p><g:message code="request.duration.label" /><strong> : <g:message code="mcerrr.duration.value" /></strong></p>
    <p>
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${['registration', 'firstStep'].contains(currentStep) ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="mcerrr.step.registration.label" /> *
          </strong>
        ...
        <li class="${currentStep == 'situation' ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="mcerrr.step.situation.label" /> *
          </strong>
       ...
       <div id="registration">
         <form method="post"  id="stepForm-registration" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="mcerrr.step.registration.label" />
             <span><g:message code="mcerrr.step.registration.desc" /></span>
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/multiCerfaElectoralRollRegistrationRequest/registration" />         
       ...
       <div id="situation">
         <form method="post"  id="stepForm-situation" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="mcerrr.step.situation.label" />
             <span><g:message code="mcerrr.step.situation.desc" /></span>
             <span class="error">${stepStates?.situation?.errorMsg}</span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
  
            <g:render template="/frontofficeRequestType/multiCerfaElectoralRollRegistrationRequest/situation" />         
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/multiCerfaElectoralRollRegistrationRequest/validation0" />
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="mcerrr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
