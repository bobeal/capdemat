    ...
    <div class="collection-fieldset  validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add ">
        ...
        <label class="required"><g:message code="parr.property.address.label" /> *  <span><g:message code="parr.property.address.help" /></span></label>
            <div class="address-fieldset required  ${stepStates != null && stepStates['authorization']?.invalidFields.contains('address') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['authorization']?.invalidFields.contains('address.additionalDeliveryInformation') ? 'validation-failed' : ''}" value="${editList?.authorizedIndividuals?.address?.additionalDeliveryInformation}" maxlength="38" id="authorizedIndividuals.${listIndex}.address.additionalDeliveryInformation" name="authorizedIndividuals[${listIndex}].address.additionalDeliveryInformation" />  
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['authorization']?.invalidFields.contains('address.additionalGeographicalInformation') ? 'validation-failed' : ''}" value="${editList?.authorizedIndividuals?.address?.additionalGeographicalInformation}" maxlength="38" id="authorizedIndividuals.${listIndex}.address.additionalGeographicalInformation" name="authorizedIndividuals[${listIndex}].address.additionalGeographicalInformation" />
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['authorization']?.invalidFields.contains('address.streetNumber') ? 'validation-failed' : ''}" value="${editList?.authorizedIndividuals?.address?.streetNumber}" size="5" maxlength="5" id="authorizedIndividuals.${listIndex}.address.streetNumber" name="authorizedIndividuals[${listIndex}].address.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['authorization']?.invalidFields.contains('address.streetName') ? 'validation-failed' : ''}" value="${editList?.authorizedIndividuals?.address?.streetName}" maxlength="32" id="authorizedIndividuals.${listIndex}.address.streetName" name="authorizedIndividuals[${listIndex}].address.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['authorization']?.invalidFields.contains('address.placeNameOrService') ? 'validation-failed' : ''}" value="${editList?.authorizedIndividuals?.address?.placeNameOrService}" maxlength="38" id="authorizedIndividuals.${listIndex}.address.placeNameOrService" name="authorizedIndividuals[${listIndex}].address.placeNameOrService" />
