    ...
    <div class="collection-fieldset  validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add ">
        ...
        <label class="required"><g:message code="parr.property.address.label" /> *  <span><g:message code="parr.property.address.help" /></span></label>
            ...
            <input type="hidden" value="${editList?.contactIndividuals?.address?.streetMatriculation}" id="contactIndividuals.${listIndex}.address.streetMatriculation" name="contactIndividuals.${listIndex}.address.streetMatriculation" />
            ...
            <input type="hidden" value="${editList?.contactIndividuals?.address?.cityInseeCode}" id="contactIndividuals.${listIndex}.address.cityInseeCode" name="contactIndividuals.${listIndex}.address.cityInseeCode" />
