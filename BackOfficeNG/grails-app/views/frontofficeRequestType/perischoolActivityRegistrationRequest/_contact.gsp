      ...
      <fieldset class="collection-fieldset-add ">
        ...
        <label for="contactIndividuals.${listIndex}.lastName" class="required"><g:message code="parr.property.lastName.label" /> *  <span><g:message code="parr.property.lastName.help" /></span></label>
            <input type="text" id="contactIndividuals.${listIndex}.lastName" name="contactIndividuals[${listIndex}].lastName" value="${editList?.contactIndividuals?.lastName?.toString()}" 
                    class="required  validate-lastName ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.lastName') ? 'validation-failed' : ''}" title="<g:message code="parr.property.lastName.validationError" />"  maxlength="38" />
        ...
        <label for="contactIndividuals.${listIndex}.firstName" class="required"><g:message code="parr.property.firstName.label" /> *  <span><g:message code="parr.property.firstName.help" /></span></label>
            <input type="text" id="contactIndividuals.${listIndex}.firstName" name="contactIndividuals[${listIndex}].firstName" value="${editList?.contactIndividuals?.firstName?.toString()}" 
                    class="required  validate-firstName ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.firstName') ? 'validation-failed' : ''}" title="<g:message code="parr.property.firstName.validationError" />"  maxlength="38" />
        ...
        <label class="required"><g:message code="parr.property.address.label" /> *  <span><g:message code="parr.property.address.help" /></span></label>
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.address.streetNumber') ? 'validation-failed' : ''}" value="${editList?.contactIndividuals?.address?.streetNumber}" size="5" maxlength="5" id="contactIndividuals.${listIndex}.address_streetNumber" name="contactIndividuals[${listIndex}].address.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.address.streetName') ? 'validation-failed' : ''}" value="${editList?.contactIndividuals?.address?.streetName}" maxlength="32" id="contactIndividuals.${listIndex}.address_streetName" name="contactIndividuals[${listIndex}].address.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.address.postalCode') ? 'validation-failed' : ''}" value="${editList?.contactIndividuals?.address?.postalCode}" size="5" maxlength="5" id="contactIndividuals.${listIndex}.address_postalCode" name="contactIndividuals[${listIndex}].address.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.address.city') ? 'validation-failed' : ''}" value="${editList?.contactIndividuals?.address?.city}" maxlength="32" id="contactIndividuals.${listIndex}.address_city" name="contactIndividuals[${listIndex}].address.city" title="<g:message code="address.property.city.validationError" />" />
        ...
        <label for="contactIndividuals.${listIndex}.homePhone" class=""><g:message code="parr.property.homePhone.label" />   <span><g:message code="parr.property.homePhone.help" /></span></label>
            <input type="text" id="contactIndividuals.${listIndex}.homePhone" name="contactIndividuals[${listIndex}].homePhone" value="${editList?.contactIndividuals?.homePhone?.toString()}" 
                    class="  validate-phone ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.homePhone') ? 'validation-failed' : ''}" title="<g:message code="parr.property.homePhone.validationError" />"  maxlength="10" />
        ...
        <label for="contactIndividuals.${listIndex}.officePhone" class=""><g:message code="parr.property.officePhone.label" />   <span><g:message code="parr.property.officePhone.help" /></span></label>
            <input type="text" id="contactIndividuals.${listIndex}.officePhone" name="contactIndividuals[${listIndex}].officePhone" value="${editList?.contactIndividuals?.officePhone?.toString()}" 
                    class="  validate-phone ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.officePhone') ? 'validation-failed' : ''}" title="<g:message code="parr.property.officePhone.validationError" />"  maxlength="10" />
