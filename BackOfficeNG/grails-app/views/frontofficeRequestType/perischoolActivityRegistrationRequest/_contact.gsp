    ...
    <div class="collection-fieldset  validation-scope summary-box">
      ...
      <fieldset class="collection-fieldset-add ">
        ...
        <label class="required"><g:message code="parr.property.address.label" /> *  <span><g:message code="parr.property.address.help" /></span></label>
            ...
            <input type="hidden" value="" id="contactIndividuals.${listIndex}.address_streetMatriculation" name="contactIndividuals.${listIndex}.address.streetMatriculation" />
            ...
            <input type="hidden" value="" id="contactIndividuals.${listIndex}.address_cityInseeCode" name="contactIndividuals.${listIndex}.address.cityInseeCode" />
