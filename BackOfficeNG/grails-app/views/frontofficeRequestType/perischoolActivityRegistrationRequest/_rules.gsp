              ...
              <ul class="yes-no required ${invalidFields.contains('classTripPermission') ? 'validation-failed' : ''}">
                <g:each in="${[true,false]}">
                  <li>
              ...
              <ul class="yes-no required ${invalidFields.contains('childPhotoExploitationPermission') ? 'validation-failed' : ''}">
                <g:each in="${[true,false]}">
                  <li>
