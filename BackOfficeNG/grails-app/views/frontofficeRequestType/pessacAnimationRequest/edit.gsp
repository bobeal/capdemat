...
<html>
  <head>
     <title>${message(code:'par.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.displayGroup == null ? '' : rqt.requestType.displayGroup.name}">
      <h2>
        ...
        <g:message code="par.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="par.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="par" scope="request" />
      ...
      <g:set var="stepNumber" value="1"/>
        ...
        <li class="${currentStep == 'enfant' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'par.step.enfant.label'}" />
