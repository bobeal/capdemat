...
<html>
  <head>
     <title>${message(code:'raprr.description')}</title>
  ...
  <body>
    <g:set var="requestTypeInfo">
      {"label": "${requestTypeLabel}"
        ,"steps": [  "requester-required",  "contact",  "authorization",  "rules-required",  "document",  "validation-required"  ]
      }
    </g:set>
    ...
    <h2 class="request-creation"> <g:message code="raprr.label" /></h2>
    <p><g:message code="raprr.description" /></p> 
    <p><g:message code="request.duration.label" /><strong> : <g:message code="raprr.duration.value" /></strong></p>
    <p>
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${currentStep == 'contact' ? 'selected' : ''}">
          ...
          <g:message code="raprr.step.contact.label" />
        ...
        <li class="${currentStep == 'authorization' ? 'selected' : ''}">
          ...
          <g:message code="raprr.step.authorization.label" />
        ...
        <li class="${currentStep == 'rules' ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="raprr.step.rules.label" /> *
          </strong>
       ...
       <div id="requester">
         <form method="post"  id="stepForm-requester" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="raprr.step.requester.label" />
             <span><g:message code="raprr.step.requester.desc" /></span>
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/recreationActivityPolyRegistrationRequest/requester" />         
       ...
       <div id="contact">
         <form method="post"  id="stepForm-contact" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="raprr.step.contact.label" />
             <span><g:message code="raprr.step.contact.desc" /></span>
             <span class="error">${stepStates?.contact?.errorMsg}</span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
  
            <g:render template="/frontofficeRequestType/recreationActivityPolyRegistrationRequest/contact" />         
       ...
       <div id="authorization">
         <form method="post"  id="stepForm-authorization" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="raprr.step.authorization.label" />
             <span><g:message code="raprr.step.authorization.desc" /></span>
             <span class="error">${stepStates?.authorization?.errorMsg}</span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
  
            <g:render template="/frontofficeRequestType/recreationActivityPolyRegistrationRequest/authorization" />         
       ...
       <div id="rules">
         <form method="post"  id="stepForm-rules" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="raprr.step.rules.label" />
             <span><g:message code="raprr.step.rules.desc" /></span>
             <span class="error">${stepStates?.rules?.errorMsg}</span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
  
            <g:render template="/frontofficeRequestType/recreationActivityPolyRegistrationRequest/rules" />         
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/recreationActivityPolyRegistrationRequest/validation0" />
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="raprr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
