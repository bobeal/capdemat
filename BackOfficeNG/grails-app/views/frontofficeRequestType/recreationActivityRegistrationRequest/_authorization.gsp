    ...
    <div class="collection  summary-box">
      <h4 class=""><g:message code="rarr.property.authorizedIndividuals.label" /> 
        <span><g:message code="rarr.property.authorizedIndividuals.help" /></span>
      </h4>
      <p>
    ...
    <g:each var="it" in="${rqt.authorizedIndividuals}" status="index">
      <div class="item">
        <dl>
        <dt class="head"><g:message code="rarr.property.authorizedIndividuals.label" /> : ${index + 1}</dt>
        <dd class="head">
