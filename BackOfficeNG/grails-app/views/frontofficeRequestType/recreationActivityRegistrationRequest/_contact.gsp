      ...
      <fieldset class="collection-fieldset-add ">
        ...
        <label for="contactIndividuals.${listIndex}.lastName" class="required"><g:message code="rarr.property.lastName.label" /> *  <span><g:message code="rarr.property.lastName.help" /></span></label>
            <input type="text" id="contactIndividuals.${listIndex}.lastName" name="contactIndividuals[${listIndex}].lastName" value="${editList?.contactIndividuals?.lastName?.toString()}" 
                    class="required  validate-lastName ${stepStates != null && stepStates['contact']?.invalidFields.contains('lastName') ? 'validation-failed' : ''}" title="<g:message code="rarr.property.lastName.validationError" />"  maxlength="38" />
        ...
        <label for="contactIndividuals.${listIndex}.firstName" class="required"><g:message code="rarr.property.firstName.label" /> *  <span><g:message code="rarr.property.firstName.help" /></span></label>
            <input type="text" id="contactIndividuals.${listIndex}.firstName" name="contactIndividuals[${listIndex}].firstName" value="${editList?.contactIndividuals?.firstName?.toString()}" 
                    class="required  validate-firstName ${stepStates != null && stepStates['contact']?.invalidFields.contains('firstName') ? 'validation-failed' : ''}" title="<g:message code="rarr.property.firstName.validationError" />"  maxlength="38" />
        ...
        <label class="required"><g:message code="rarr.property.address.label" /> *  <span><g:message code="rarr.property.address.help" /></span></label>
            <div class="address-fieldset required  ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.${listIndex}.address') ? 'validation-failed' : ''}">
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.${listIndex}.address.additionalDeliveryInformation') ? 'validation-failed' : ''}" value="${editList?.contactIndividuals?.address?.additionalDeliveryInformation}" maxlength="38" id="contactIndividuals.${listIndex}.address.additionalDeliveryInformation" name="contactIndividuals[${listIndex}].address.additionalDeliveryInformation" />  
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.${listIndex}.address.additionalGeographicalInformation') ? 'validation-failed' : ''}" value="${editList?.contactIndividuals?.address?.additionalGeographicalInformation}" maxlength="38" id="contactIndividuals.${listIndex}.address.additionalGeographicalInformation" name="contactIndividuals[${listIndex}].address.additionalGeographicalInformation" />
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.${listIndex}.address.streetNumber') ? 'validation-failed' : ''}" value="${editList?.contactIndividuals?.address?.streetNumber}" size="5" maxlength="5" id="contactIndividuals.${listIndex}.address.streetNumber" name="contactIndividuals[${listIndex}].address.streetNumber" />
            <input type="text" class="line2 required validate-streetName ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.${listIndex}.address.streetName') ? 'validation-failed' : ''}" value="${editList?.contactIndividuals?.address?.streetName}" maxlength="32" id="contactIndividuals.${listIndex}.address.streetName" name="contactIndividuals[${listIndex}].address.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            ...
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.${listIndex}.address.placeNameOrService') ? 'validation-failed' : ''}" value="${editList?.contactIndividuals?.address?.placeNameOrService}" maxlength="38" id="contactIndividuals.${listIndex}.address.placeNameOrService" name="contactIndividuals[${listIndex}].address.placeNameOrService" />
            ...
            <input type="text" class="line1 required validate-postalCode ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.${listIndex}.address.postalCode') ? 'validation-failed' : ''}" value="${editList?.contactIndividuals?.address?.postalCode}" size="5" maxlength="5" id="contactIndividuals.${listIndex}.address.postalCode" name="contactIndividuals[${listIndex}].address.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.${listIndex}.address.city') ? 'validation-failed' : ''}" value="${editList?.contactIndividuals?.address?.city}" maxlength="32" id="contactIndividuals.${listIndex}.address.city" name="contactIndividuals[${listIndex}].address.city" title="<g:message code="address.property.city.validationError" />" />
            <label for="contactIndividuals.${listIndex}.address.countryName"><g:message code="address.property.countryName" /></label>
            <input type="text" class="validate-addressLine38 ${stepStates != null && stepStates['contact']?.invalidFields.contains('contactIndividuals.${listIndex}.address.countryName') ? 'validation-failed' : ''}" value="${editList?.contactIndividuals?.address?.countryName}" maxlength="38" id="contactIndividuals.${listIndex}.address.countryName" name="contactIndividuals[${listIndex}].address.countryName" />
            </div>
        ...
        <label for="contactIndividuals.${listIndex}.homePhone" class=""><g:message code="rarr.property.homePhone.label" />   <span><g:message code="rarr.property.homePhone.help" /></span></label>
            <input type="text" id="contactIndividuals.${listIndex}.homePhone" name="contactIndividuals[${listIndex}].homePhone" value="${editList?.contactIndividuals?.homePhone?.toString()}" 
                    class="  validate-phone ${stepStates != null && stepStates['contact']?.invalidFields.contains('homePhone') ? 'validation-failed' : ''}" title="<g:message code="rarr.property.homePhone.validationError" />"  maxlength="10" />
        ...
        <label for="contactIndividuals.${listIndex}.officePhone" class=""><g:message code="rarr.property.officePhone.label" />   <span><g:message code="rarr.property.officePhone.help" /></span></label>
            <input type="text" id="contactIndividuals.${listIndex}.officePhone" name="contactIndividuals[${listIndex}].officePhone" value="${editList?.contactIndividuals?.officePhone?.toString()}" 
                    class="  validate-phone ${stepStates != null && stepStates['contact']?.invalidFields.contains('officePhone') ? 'validation-failed' : ''}" title="<g:message code="rarr.property.officePhone.validationError" />"  maxlength="10" />
