...
<html>
  <head>
     <title>${message(code:'sapr.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.category.name}">
      <h2>
        ...
        <g:message code="sapr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="sapr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="sapr" scope="request" />
      ...
      <g:set var="stepNumber" value="1"/>
        ...
        <li class="${currentStep == 'enfant' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="sapr.step.enfant.label" /> *
              <span class="help">
        ...
        <li class="${currentStep == 'activites' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="sapr.step.activites.label" /> *
              <span class="help">
        ...
        <li class="${currentStep == 'paiement' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="sapr.step.paiement.label" /> *
              <span class="help">
