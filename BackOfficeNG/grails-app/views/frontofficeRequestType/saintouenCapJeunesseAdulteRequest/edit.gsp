...
<html>
  <head>
     <title>${message(code:'scjar.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.category.name}">
      <h2>
        ...
        <g:message code="scjar.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="scjar.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="scjar" scope="request" />
      ...
      <ul>
        ...
        <li class="${currentStep == 'sujet' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="${individual ? 'homeFolder.action.add' + org.apache.commons.lang.StringUtils.capitalize(params.type) : 'scjar.step.sujet.label'}" />
              ${individual ? '' : '*'}
              <span class="help">
        ...
        <li class="${currentStep == 'renseignements' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="scjar.step.renseignements.label" /> *
              <span class="help">
        ...
        <li class="${currentStep == 'reglements' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="scjar.step.reglements.label" /> *
              <span class="help">
