    ...
    <label class="required"><g:message code="scssr.property.isSubjectAccountHolder.label" /> *  <span><g:message code="scssr.property.isSubjectAccountHolder.help" /></span></label>
    ...
    <label for="accountHolderTitle" class="required condition-isSubjectAccountHolder-unfilled"><g:message code="scssr.property.accountHolderTitle.label" /> *  <span><g:message code="scssr.property.accountHolderTitle.help" /></span></label>
            <select id="accountHolderTitle" name="accountHolderTitle" class="required condition-isSubjectAccountHolder-unfilled  validate-not-first ${rqt.stepStates['bankReference'].invalidFields.contains('accountHolderTitle') ? 'validation-failed' : ''}" title="<g:message code="scssr.property.accountHolderTitle.validationError" />">
              <option value=""><g:message code="message.select.defaultOption" /></option>
              <g:each in="${['MISTER','MADAM','MISS','AGENCY','UNKNOWN']}">
                <option value="${it}" ${it == rqt.accountHolderTitle?.toString() ? 'selected="selected"': ''}><g:capdematEnumToText var="${it}" i18nKeyPrefix="scssr.property.accountHolderTitle" /></option>
              </g:each>
            </select>
    ...
    <label for="accountHolderLastName" class="required condition-isSubjectAccountHolder-unfilled"><g:message code="scssr.property.accountHolderLastName.label" /> *  <span><g:message code="scssr.property.accountHolderLastName.help" /></span></label>
            <input type="text" id="accountHolderLastName" name="accountHolderLastName" value="${rqt.accountHolderLastName?.toString()}" 
                    class="required condition-isSubjectAccountHolder-unfilled  validate-lastName ${rqt.stepStates['bankReference'].invalidFields.contains('accountHolderLastName') ? 'validation-failed' : ''}" title="<g:message code="scssr.property.accountHolderLastName.validationError" />"  maxlength="38" />
            

  

  
    <label for="accountHolderFirstName" class="required condition-isSubjectAccountHolder-unfilled"><g:message code="scssr.property.accountHolderFirstName.label" /> *  <span><g:message code="scssr.property.accountHolderFirstName.help" /></span></label>
            <input type="text" id="accountHolderFirstName" name="accountHolderFirstName" value="${rqt.accountHolderFirstName?.toString()}" 
                    class="required condition-isSubjectAccountHolder-unfilled  validate-firstName ${rqt.stepStates['bankReference'].invalidFields.contains('accountHolderFirstName') ? 'validation-failed' : ''}" title="<g:message code="scssr.property.accountHolderFirstName.validationError" />"  maxlength="38" />
            

  

  
    <label class="required condition-isSubjectAccountHolder-unfilled"><g:message code="scssr.property.accountHolderBirthDate.label" /> *  <span><g:message code="scssr.property.accountHolderBirthDate.help" /></span></label>
            <div class="date required condition-isSubjectAccountHolder-unfilled  validate-date required condition-isSubjectAccountHolder-unfilled ">
              ...
              <input type="text" maxlength="4" size="3"
                ...
                title="<g:message code="scssr.property.accountHolderBirthDate.validationError" />" />
            </div>
    ...
    <label for="bankAccount" class="required"><g:message code="scssr.property.bankAccount.label" /> *  <span><g:message code="scssr.property.bankAccount.help" /></span></label>
