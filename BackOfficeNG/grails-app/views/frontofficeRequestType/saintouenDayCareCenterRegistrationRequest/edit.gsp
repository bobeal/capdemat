...
<html>
  <head>
     <title>${message(code:'sdccrr.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.category.name}">
      <h2>
        ...
        <g:message code="sdccrr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="sdccrr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="sdccrr" scope="request" />
      ...
      <g:set var="stepNumber" value="1"/>
        ...
        <li class="${currentStep == 'subject' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="sdccrr.step.subject.label" /> *
              <span class="help">
        ...
        <li class="${currentStep == 'accueil' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="sdccrr.step.accueil.label" /> *
              <span class="help">
                
                  <g:message code="request.step.message.${rqt.stepStates['accueil'].state}" />
        ...
        <li class="${currentStep == 'rendezVous' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="sdccrr.step.rendezVous.label" /> *
              <span class="help">
                
                  <g:message code="request.step.message.${rqt.stepStates['rendezVous'].state}" />
