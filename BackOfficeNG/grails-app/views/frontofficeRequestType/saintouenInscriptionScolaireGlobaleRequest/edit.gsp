...
<html>
  <head>
     <title>${message(code:'sisgr.description')}</title>
  ...
  <body>
    ...
    <div id="request" class="main-box ${rqt.requestType.category.name}">
      <h2>
        ...
        <g:message code="sisgr.label" /> <g:message code="message.number" args="[rqt.id]" />
      </h2>
      <p><g:message code="request.duration.label" /><strong> : <g:message code="sisgr.duration.value" /></strong></p>
      <p>
      ...
      <div class="datas">
         <g:set var="requestTypeAcronym" value="sisgr" scope="request" />
      ...
      <g:set var="stepNumber" value="1"/>
        ...
        <li class="${currentStep == 'enfant' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="sisgr.step.enfant.label" /> *
              <span class="help">
        ...
        <li class="${currentStep == 'activites' ? 'current ' : ''}
          ...
          >
              ...
              <g:message code="sisgr.step.activites.label" /> *
              <span class="help">
        ...
        <li class="${currentStep == 'paiement' ? 'current ' : ''}
          
            ${rqt.stepStates['paiement'].state}
          "
          >
          <span class="number">${stepNumber++}</span>
          <a
            <g:if test="${currentStep != 'paiement' && rqt.stepStates['paiement'].state != 'unavailable'}">
              href="${createLink(controller:'frontofficeRequest', action : 'edit', params:['id':rqt.id,'currentStep':'paiement'])}"
            </g:if>
          >
            
              <g:message code="sisgr.step.paiement.label" /> *
              <span class="help">
                
                  <g:message code="request.step.message.${rqt.stepStates['paiement'].state}" />
