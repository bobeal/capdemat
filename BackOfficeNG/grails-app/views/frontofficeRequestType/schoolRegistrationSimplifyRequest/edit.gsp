...
<html>
  <head>
     <title>${message(code:'srsr.description')}</title>
  ...
  <body>
    ...
    <h2 class="request-creation"> <g:message code="srsr.label" /></h2>
    <p><g:message code="srsr.description" /></p> 
    <p><g:message code="request.duration.label" /><strong> : <g:message code="srsr.duration.value" /></strong></p>
    <p>
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${['registration', 'firstStep'].contains(currentStep) ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="srsr.step.registration.label" /> *
          </strong>
       ...
       <div id="registration">
         <form method="post"  id="stepForm-registration" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="srsr.step.registration.label" />
             <span><g:message code="srsr.step.registration.desc" /></span>
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/schoolRegistrationSimplifyRequest/registration" />         
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/schoolRegistrationSimplifyRequest/validation0" />
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="srsr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
