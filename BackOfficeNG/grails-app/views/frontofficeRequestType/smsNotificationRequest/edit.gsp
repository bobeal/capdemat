  ...
  <body>
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${currentStep == 'subscription' ? 'selected' : ''}">
          <a href="${createLink(controller:'frontofficeRequest', action : 'edit', params:['id':rqt.id,'currentStep':'subscription'])}">
          <em>
          <span class="tag-state tag-${rqt.stepStates.subscription.state}"><g:message code="request.step.state.${rqt.stepStates.subscription.state}" /></span>
     ...
     <div class="yui-content">
       <g:set var="firstStep" value="subscription" />
