    ...
    <label for="roleDemandeur" class="required"><g:message code="sagr.property.roleDemandeur.label" /> *  <span><g:message code="sagr.property.roleDemandeur.help" /></span></label>
            <select id="roleDemandeur" name="roleDemandeur" class="required  validate-not-first ${rqt.stepStates['bureau'].invalidFields.contains('roleDemandeur') ? 'validation-failed' : ''}" title="<g:message code="sagr.property.roleDemandeur.validationError" />">
