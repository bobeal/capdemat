    ...
    <legend><g:message code="sgr.property.subjectInformations.label" /></legend>
      ...
      <label class="required"><g:message code="sgr.property.subjectAddress.label" /> *  <span><g:message code="sgr.property.subjectAddress.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.subjectAddress?.streetMatriculation}" id="subjectAddress.streetMatriculation" name="subjectAddress.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.subjectAddress?.cityInseeCode}" id="subjectAddress.cityInseeCode" name="subjectAddress.cityInseeCode" />
