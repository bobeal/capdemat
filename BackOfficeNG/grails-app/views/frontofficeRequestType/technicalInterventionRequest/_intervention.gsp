    ...
    <label class="required"><g:message code="tir.property.interventionPlace.label" /> *  <span><g:message code="tir.property.interventionPlace.help" /></span></label>
            ...
            <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['intervention']?.invalidFields.contains('interventionPlace.streetNumber') ? 'validation-failed' : ''}" value="${rqt.interventionPlace?.streetNumber}" size="5" maxlength="5" id="interventionPlace_streetNumber" name="interventionPlace.streetNumber" />
