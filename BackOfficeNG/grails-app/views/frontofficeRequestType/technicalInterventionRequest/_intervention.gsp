    ...
    <label class="required"><g:message code="tir.property.interventionPlace.label" /> *  <span><g:message code="tir.property.interventionPlace.help" /></span></label>
            ...
            <input type="text" class="validate-addressLine38" value="${rqt.interventionPlace?.additionalDeliveryInformation}" maxlength="38" id="interventionPlace.additionalDeliveryInformation" name="interventionPlace.additionalDeliveryInformation" />  
            ...
            <input type="text" class="validate-addressLine38" value="${rqt.interventionPlace?.additionalGeographicalInformation}" maxlength="38" id="interventionPlace.additionalGeographicalInformation" name="interventionPlace.additionalGeographicalInformation" />
            ...
            <input type="text" class="line1 validate-streetNumber" value="${rqt.interventionPlace?.streetNumber}" size="5" maxlength="5" id="interventionPlace.streetNumber" name="interventionPlace.streetNumber" />
            <input type="text" class="line2 required validate-streetName" value="${rqt.interventionPlace?.streetName}" maxlength="32" id="interventionPlace.streetName" name="interventionPlace.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            <label for="interventionPlace.placeNameOrService"><g:message code="address.property.placeNameOrService" /></label>
            <input type="text" class="validate-addressLine38" value="${rqt.interventionPlace?.placeNameOrService}" maxlength="38" id="interventionPlace.placeNameOrService" name="interventionPlace.placeNameOrService" />
            ...
            <input type="text" class="line1 required validate-postalCode" value="${rqt.interventionPlace?.postalCode}" size="5" maxlength="5" id="interventionPlace.postalCode" name="interventionPlace.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required validate-city" value="${rqt.interventionPlace?.city}" maxlength="32" id="interventionPlace.city" name="interventionPlace.city" title="<g:message code="address.property.city.validationError" />" />
            <label for="interventionPlace.countryName"><g:message code="address.property.countryName" /></label>
            <input type="text" class="validate-addressLine38" value="${rqt.interventionPlace?.countryName}" maxlength="38" id="interventionPlace.countryName" name="interventionPlace.countryName" />
            </div>
