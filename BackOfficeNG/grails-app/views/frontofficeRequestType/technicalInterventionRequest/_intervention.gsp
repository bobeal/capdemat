    ...
    <label class="required"><g:message code="tir.property.interventionPlace.label" /> *  <span><g:message code="tir.property.interventionPlace.help" /></span></label>
            ...
            <input type="hidden" value="${rqt.interventionPlace?.streetMatriculation}" id="interventionPlace.streetMatriculation" name="interventionPlace.streetMatriculation" />
            ...
            <input type="hidden" value="${rqt.interventionPlace?.cityInseeCode}" id="interventionPlace.cityInseeCode" name="interventionPlace.cityInseeCode" />
