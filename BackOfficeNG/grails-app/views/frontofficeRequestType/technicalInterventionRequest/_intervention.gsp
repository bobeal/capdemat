    ...
    <label class="required"><g:message code="tir.property.interventionPlace.label" /> *  <span><g:message code="tir.property.interventionPlace.help" /></span></label>
            ...
            <input type="hidden" value="" id="interventionPlace_streetMatriculation" name="interventionPlace.streetMatriculation" />
            ...
            <input type="hidden" value="" id="interventionPlace_cityInseeCode" name="interventionPlace.cityInseeCode" />
