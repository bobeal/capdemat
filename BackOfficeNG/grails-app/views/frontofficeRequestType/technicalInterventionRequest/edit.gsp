  ...
  <body>
    <g:set var="requestTypeInfo">
      {"label": "${requestTypeLabel}"
        ,"steps": [  "intervention-required",  "document",  "validation-required"  ]
      }
    </g:set>
     ...
     <div class="yui-content">
       ...
       <div id="intervention">
         ...
         <div class="navTab">
           ...
           <a id="next-tab-intervention" class="next-tab" href="#document"><g:message code="request.step.navigation.next"/></a>
       ...
       <div id="document">
         ...
         <div class="navTab">
           ...
           <a id="prev-tab-document" class="prev-tab" href="#intervention"><g:message code="request.step.navigation.previous"/></a>
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="tir.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
