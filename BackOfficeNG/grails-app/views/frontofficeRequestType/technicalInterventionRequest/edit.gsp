...
<html>
  <head>
     <title>${message(code:'tir.description')}</title>
  ...
  <body>
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${currentStep == 'intervention' ? 'selected' : ''}">
          <a href="${createLink(controller:'frontofficeRequest', action : 'edit', params:['id':rqt.id,'currentStep':'intervention'])}">
          <em>
          <span class="tag-state tag-${rqt.stepStates.intervention.state}"><g:message code="request.step.state.${rqt.stepStates.intervention.state}" /></span>
     ...
     <div class="yui-content">
       <g:set var="firstStep" value="intervention" />
       ...
       <g:set var="requestTypeAcronym" value="tir" scope="request" />
