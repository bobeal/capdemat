    ...
    <div class="yui-g">
      ...
      <div class="yui-u">
        ...
        <div id="_individuals_adults_${listIndex}_adress" class="address-fieldset required ${stepStates != null && stepStates['adults']?.invalidFields.contains('adress') ? 'validation-failed' : ''}">
          ...
          <label for="_individuals.adults.${listIndex}_adress_streetNumber"><g:message code="address.property.streetNumber" /></label> - 
          ...
          <input type="text" class="line1 validate-streetNumber ${stepStates != null && stepStates['adults']?.invalidFields.contains('adress.streetNumber') ? 'validation-failed' : ''}" size="5" maxlength="5" id="_individuals.adults.${listIndex}.adress_streetNumber" name="_individuals.adults[${listIndex}].adress.streetNumber"
