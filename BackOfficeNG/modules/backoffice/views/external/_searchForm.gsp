<div class="txt-right" id="searchSwitcher">
  <a class="simple"
    href="${module.createLink(module:'backoffice', controller:'Request',action:'initSearch')}">
    <g:message code="action.goToRequestSearch" /></a> |
  <a class="simple"
    href="${module.createLink(module:'backoffice', controller:'HomeFolder',action:'search')}">
    <g:message code="action.goToHomeFolderSearch" /></a> |
  <g:message code="action.goToExternalSearch" />
</div>
<div id="search-form">
  <h1><g:message code="externalServiceTrace.header.search" /></h1>
  <form method="post" id="searchForm" class="advanced-search" action="${createLink(action:'search')}">
    ...
    <div class="yui-g">
      ...
      <div class="yui-u">
        ...
        <label for="dateTo"><g:message code="externalServiceTrace.search.message.dateTo" /> :</label>
