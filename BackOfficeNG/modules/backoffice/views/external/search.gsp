<html>
  <head>
    ...
    <link rel="stylesheet" href="${createLinkTo(dir : 'css/backoffice', file : 'externalSearch.css')}" />
    <script type="text/javascript" src="${createLinkTo(dir:'js/common',file:'calendar.js')}"></script>
    <script type="text/javascript" src="${createLinkTo(dir:'js/backoffice',file:'externalSearch.js')}"></script>
  </head>
  <body>
    <div id="yui-main">
      <div class="yui-b">
