...
<form method="post" id="activationForm" action="${createLink(action : 'deactivation')}">
  ...
  <div id="deactivationDatesPanel"<g:if test="${!inactive}"> class="invisible"</g:if>>
    <p class="field">
      ...
      <a class="calendarLink" onclick="showCalendar('paymentDeactivationStartDateShow', 'paymentDeactivationStartDate');">
    ...
    <p class="field">
      ...
      <a class="calendarLink" onclick="showCalendar('paymentDeactivationEndDateShow', 'paymentDeactivationEndDate');">
