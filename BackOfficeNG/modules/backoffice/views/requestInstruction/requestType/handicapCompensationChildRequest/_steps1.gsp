  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl class="required">
              ...
              <dt class="required condition-isMDPH-trigger"><g:message code="hccr.property.foldersMdph.label" /> * : </dt><dd id="foldersMdph" class="action-editField validate-boolean required-true i18n-hccr.property.foldersMdph" ><span class="value-${request?.foldersMdph}"><g:message code="message.${request?.foldersMdph ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="condition-isMDPH-filled"><g:message code="hccr.property.foldersMdphNumber.label" />  : </dt><dd id="foldersMdphNumber" class="action-editField validate- i18n-hccr.property.foldersMdphNumber maxLength-30" ><span>${request?.foldersMdphNumber}</span></dd>
          
              <dt class="condition-isMDPH-filled"><g:message code="hccr.property.foldersMdphDepartment.label" />  : </dt><dd id="foldersMdphDepartment" class="action-editField validate-departmentCode i18n-hccr.property.foldersMdphDepartment maxLength-2" ><span>${request?.foldersMdphDepartment}</span></dd>
          
              <dt class="required condition-isCOTOREP-trigger"><g:message code="hccr.property.foldersCotorep.label" /> * : </dt><dd id="foldersCotorep" class="action-editField validate-boolean required-true i18n-hccr.property.foldersCotorep" ><span class="value-${request?.foldersCotorep}"><g:message code="message.${request?.foldersCotorep ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="condition-isCOTOREP-filled"><g:message code="hccr.property.foldersCotorepNumber.label" />  : </dt><dd id="foldersCotorepNumber" class="action-editField validate- i18n-hccr.property.foldersCotorepNumber maxLength-30" ><span>${request?.foldersCotorepNumber}</span></dd>
          
              <dt class="condition-isCOTOREP-filled"><g:message code="hccr.property.foldersCotorepDepartment.label" />  : </dt><dd id="foldersCotorepDepartment" class="action-editField validate-departmentCode i18n-hccr.property.foldersCotorepDepartment maxLength-2" ><span>${request?.foldersCotorepDepartment}</span></dd>
          
              <dt class="required condition-isCDES-trigger"><g:message code="hccr.property.foldersCdes.label" /> * : </dt><dd id="foldersCdes" class="action-editField validate-boolean required-true i18n-hccr.property.foldersCdes" ><span class="value-${request?.foldersCdes}"><g:message code="message.${request?.foldersCdes ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="condition-isCDES-filled"><g:message code="hccr.property.foldersCdesNumber.label" />  : </dt><dd id="foldersCdesNumber" class="action-editField validate- i18n-hccr.property.foldersCdesNumber maxLength-30" ><span>${request?.foldersCdesNumber}</span></dd>
          
              <dt class="condition-isCDES-filled"><g:message code="hccr.property.foldersCdesDepartment.label" />  : </dt><dd id="foldersCdesDepartment" class="action-editField validate-departmentCode i18n-hccr.property.foldersCdesDepartment maxLength-2" ><span>${request?.foldersCdesDepartment}</span></dd>
          
              <dt class="required condition-isOtherFolders-trigger"><g:message code="hccr.property.foldersOtherFolders.label" /> * : </dt><dd id="foldersOtherFolders" class="action-editField validate-boolean required-true i18n-hccr.property.foldersOtherFolders" ><span class="value-${request?.foldersOtherFolders}"><g:message code="message.${request?.foldersOtherFolders ? 'yes' : 'no'}" /></span></dd>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u">
        ...
        <dl class="required">
              ...
              <dt class="required condition-isDisabilityRecognition-trigger"><g:message code="hccr.property.benefitsDisabilityRecognition.label" /> * : </dt><dd id="benefitsDisabilityRecognition" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsDisabilityRecognition" ><span class="value-${request?.benefitsDisabilityRecognition}"><g:message code="message.${request?.benefitsDisabilityRecognition ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required condition-isDisabilityRecognition-filled"><g:message code="hccr.property.benefitsDisabilityRatio.label" /> * : </dt><dd id="benefitsDisabilityRatio" class="action-editField validate- required-true i18n-hccr.property.benefitsDisabilityRatio maxLength-3" ><span>${request?.benefitsDisabilityRatio}</span></dd>
          
              <dt class="required"><g:message code="hccr.property.benefitsDisabilityCard.label" /> * : </dt><dd id="benefitsDisabilityCard" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsDisabilityCard" ><span class="value-${request?.benefitsDisabilityCard}"><g:message code="message.${request?.benefitsDisabilityCard ? 'yes' : 'no'}" /></span></dd>
              ...
              <dt class="required"><g:message code="hccr.property.benefitsParkingCard.label" /> * : </dt><dd id="benefitsParkingCard" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsParkingCard" ><span class="value-${request?.benefitsParkingCard}"><g:message code="message.${request?.benefitsParkingCard ? 'yes' : 'no'}" /></span></dd>
              ...
              <dt class="required"><g:message code="hccr.property.benefitsDisabledAdultAllocation.label" /> * : </dt><dd id="benefitsDisabledAdultAllocation" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsDisabledAdultAllocation" ><span class="value-${request?.benefitsDisabledAdultAllocation}"><g:message code="message.${request?.benefitsDisabledAdultAllocation ? 'yes' : 'no'}" /></span></dd>
              ...
              <dt class="required condition-isEducationOfDisabledChildren-trigger"><g:message code="hccr.property.benefitsEducationOfDisabledChildren.label" /> * : </dt><dd id="benefitsEducationOfDisabledChildren" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsEducationOfDisabledChildren" ><span class="value-${request?.benefitsEducationOfDisabledChildren}"><g:message code="message.${request?.benefitsEducationOfDisabledChildren ? 'yes' : 'no'}" /></span></dd>
              ...
              <dt class="required"><g:message code="hccr.property.benefitsSupplementForSingleParents.label" /> * : </dt><dd id="benefitsSupplementForSingleParents" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsSupplementForSingleParents" ><span class="value-${request?.benefitsSupplementForSingleParents}"><g:message code="message.${request?.benefitsSupplementForSingleParents ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required"><g:message code="hccr.property.benefitsThirdPersonCompensatoryAllowance.label" /> * : </dt><dd id="benefitsThirdPersonCompensatoryAllowance" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsThirdPersonCompensatoryAllowance" ><span class="value-${request?.benefitsThirdPersonCompensatoryAllowance}"><g:message code="message.${request?.benefitsThirdPersonCompensatoryAllowance ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required"><g:message code="hccr.property.benefitsThirdPartyCompensatoryAllowance.label" /> * : </dt><dd id="benefitsThirdPartyCompensatoryAllowance" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsThirdPartyCompensatoryAllowance" ><span class="value-${request?.benefitsThirdPartyCompensatoryAllowance}"><g:message code="message.${request?.benefitsThirdPartyCompensatoryAllowance ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required"><g:message code="hccr.property.benefitsCompensatoryAllowanceForExpenses.label" /> * : </dt><dd id="benefitsCompensatoryAllowanceForExpenses" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsCompensatoryAllowanceForExpenses" ><span class="value-${request?.benefitsCompensatoryAllowanceForExpenses}"><g:message code="message.${request?.benefitsCompensatoryAllowanceForExpenses ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required"><g:message code="hccr.property.benefitsDisabilityCompensation.label" /> * : </dt><dd id="benefitsDisabilityCompensation" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsDisabilityCompensation" ><span class="value-${request?.benefitsDisabilityCompensation}"><g:message code="message.${request?.benefitsDisabilityCompensation ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required condition-isDisabilityPension-trigger"><g:message code="hccr.property.benefitsDisabilityPension.label" /> * : </dt><dd id="benefitsDisabilityPension" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsDisabilityPension" ><span class="value-${request?.benefitsDisabilityPension}"><g:message code="message.${request?.benefitsDisabilityPension ? 'yes' : 'no'}" /></span></dd>
              ...
              <dt class="required condition-isWorkAccidentAnnuity-trigger"><g:message code="hccr.property.benefitsWorkAccidentAnnuity.label" /> * : </dt><dd id="benefitsWorkAccidentAnnuity" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsWorkAccidentAnnuity" ><span class="value-${request?.benefitsWorkAccidentAnnuity}"><g:message code="message.${request?.benefitsWorkAccidentAnnuity ? 'yes' : 'no'}" /></span></dd>
              ...
              <dt class="required"><g:message code="hccr.property.benefitsUnemploymentBenefits.label" /> * : </dt><dd id="benefitsUnemploymentBenefits" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsUnemploymentBenefits" ><span class="value-${request?.benefitsUnemploymentBenefits}"><g:message code="message.${request?.benefitsUnemploymentBenefits ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required"><g:message code="hccr.property.benefitsDailyAllowances.label" /> * : </dt><dd id="benefitsDailyAllowances" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsDailyAllowances" ><span class="value-${request?.benefitsDailyAllowances}"><g:message code="message.${request?.benefitsDailyAllowances ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required"><g:message code="hccr.property.benefitsThirdPartySupplement.label" /> * : </dt><dd id="benefitsThirdPartySupplement" class="action-editField validate-boolean required-true i18n-hccr.property.benefitsThirdPartySupplement" ><span class="value-${request?.benefitsThirdPartySupplement}"><g:message code="message.${request?.benefitsThirdPartySupplement ? 'yes' : 'no'}" /></span></dd>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u">
        ...
        <dl class="">
              ...
              <dt class="required condition-isCareServices-trigger"><g:message code="hccr.property.careCareServices.label" /> * : </dt><dd id="careCareServices" class="action-editField validate-boolean required-true i18n-hccr.property.careCareServices" ><span class="value-${request?.careCareServices}"><g:message code="message.${request?.careCareServices ? 'yes' : 'no'}" /></span></dd>
        ...
        <dl class="required">
              ...
              <dt class="required condition-isHousing-trigger"><g:message code="hccr.property.facilitiesHousing.label" /> * : </dt><dd id="facilitiesHousing" class="action-editField validate-boolean required-true i18n-hccr.property.facilitiesHousing" ><span class="value-${request?.facilitiesHousing}"><g:message code="message.${request?.facilitiesHousing ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required condition-isHousing-filled"><g:message code="hccr.property.facilitiesHousingDetails.label" /> * : </dt><dd id="facilitiesHousingDetails" class="action-editField validate- required-true i18n-hccr.property.facilitiesHousingDetails maxLength-60" ><span>${request?.facilitiesHousingDetails}</span></dd>
          
              <dt class="required condition-isTechnicalAssistance-trigger"><g:message code="hccr.property.facilitiesTechnicalAssistance.label" /> * : </dt><dd id="facilitiesTechnicalAssistance" class="action-editField validate-boolean required-true i18n-hccr.property.facilitiesTechnicalAssistance" ><span class="value-${request?.facilitiesTechnicalAssistance}"><g:message code="message.${request?.facilitiesTechnicalAssistance ? 'yes' : 'no'}" /></span></dd>
              ...
              <dt class="required condition-isCustomCar-filled"><g:message code="hccr.property.facilitiesCustomCarDetails.label" /> * : </dt><dd id="facilitiesCustomCarDetails" class="action-editField validate- required-true i18n-hccr.property.facilitiesCustomCarDetails maxLength-60" ><span>${request?.facilitiesCustomCarDetails}</span></dd>
          
              <dt class="required condition-isAnimalAid-trigger"><g:message code="hccr.property.facilitiesAnimalAid.label" /> * : </dt><dd id="facilitiesAnimalAid" class="action-editField validate-boolean required-true i18n-hccr.property.facilitiesAnimalAid" ><span class="value-${request?.facilitiesAnimalAid}"><g:message code="message.${request?.facilitiesAnimalAid ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required condition-isAnimalAid-filled"><g:message code="hccr.property.facilitiesAnimalAidDetails.label" /> * : </dt><dd id="facilitiesAnimalAidDetails" class="action-editField validate- required-true i18n-hccr.property.facilitiesAnimalAidDetails maxLength-60" ><span>${request?.facilitiesAnimalAidDetails}</span></dd>
          
              <dt class="required condition-isSpecializedTransport-trigger"><g:message code="hccr.property.facilitiesSpecializedTransport.label" /> * : </dt><dd id="facilitiesSpecializedTransport" class="action-editField validate-boolean required-true i18n-hccr.property.facilitiesSpecializedTransport" ><span class="value-${request?.facilitiesSpecializedTransport}"><g:message code="message.${request?.facilitiesSpecializedTransport ? 'yes' : 'no'}" /></span></dd>
        ...
        <dl class="required">
              ...
              <dt class="required condition-isProfessionals-trigger"><g:message code="hccr.property.professionalSupportProfessionals.label" /> * : </dt><dd id="professionalSupportProfessionals" class="action-editField validate-boolean required-true i18n-hccr.property.professionalSupportProfessionals" ><span class="value-${request?.professionalSupportProfessionals}"><g:message code="message.${request?.professionalSupportProfessionals ? 'yes' : 'no'}" /></span></dd>
        ...
        <dl class="required">
              ...
              <dt class="required condition-isSocialServiceSupport-trigger"><g:message code="hccr.property.socialServiceSupport.label" /> * : </dt><dd id="socialServiceSupport" class="action-editField validate-boolean required-true i18n-hccr.property.socialServiceSupport" ><span class="value-${request?.socialServiceSupport}"><g:message code="message.${request?.socialServiceSupport ? 'yes' : 'no'}" /></span></dd>
          
              <dt class="required condition-isSocialServiceSupport-filled"><g:message code="hccr.property.socialServiceName.label" /> * : </dt><dd id="socialServiceName" class="action-editField validate- required-true i18n-hccr.property.socialServiceName maxLength-60" ><span>${request?.socialServiceName}</span></dd>
          
              <dt class="required condition-isSocialServiceSupport-filled"><g:message code="hccr.property.socialServiceAddress.label" /> * : </dt><dd id="socialServiceAddress" class="action-editField validate-address required-true i18n-hccr.property.socialServiceAddress" ><div><p class="additionalDeliveryInformation">${request?.socialServiceAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${request?.socialServiceAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${request?.socialServiceAddress?.streetNumber}</span> <span class="streetName">${request?.socialServiceAddress?.streetName}</span><p class="placeNameOrService">${request?.socialServiceAddress?.placeNameOrService}</p><span class="postalCode">${request?.socialServiceAddress?.postalCode}</span> <span class="city">${request?.socialServiceAddress?.city}</span><p class="countryName">${request?.socialServiceAddress?.countryName}</p></div></dd>
