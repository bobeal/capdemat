  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl class="required">
              ...
              <dt class="required condition-isFollowedByDoctor-filled"><g:message code="hccr.property.healthDoctorLastName.label" /> * : </dt><dd id="healthDoctorLastName" class="action-editField validate-lastName required-true i18n-hccr.property.healthDoctorLastName maxLength-38" ><span>${rqt?.healthDoctorLastName}</span></dd>
          
              <dt class="required condition-isFollowedByDoctor-filled"><g:message code="hccr.property.healthDoctorFirstName.label" /> * : </dt><dd id="healthDoctorFirstName" class="action-editField validate-firstName required-true i18n-hccr.property.healthDoctorFirstName maxLength-38" ><span>${rqt?.healthDoctorFirstName}</span></dd>
              ...
              <dt class="required condition-isFollowedByHospital-filled"><g:message code="hccr.property.healthHospitalName.label" /> * : </dt><dd id="healthHospitalName" class="action-editField validate- required-true i18n-hccr.property.healthHospitalName maxLength-60" ><span>${rqt?.healthHospitalName}</span></dd>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
        ...
        <dl class="required">
              ...
              <dt class=""><g:message code="hccr.property.projectRequestsCustomCar.label" />  : </dt><dd id="projectRequestsCustomCar" class="action-editField validate-boolean i18n-hccr.property.projectRequestsCustomCar" ><span class="value-${rqt?.projectRequestsCustomCar}"><g:message code="message.${rqt?.projectRequestsCustomCar ? 'yes' : 'no'}" /></span></dd>
              ...
              <dt class="required condition-isOtherRequest-filled"><g:message code="hccr.property.projectRequestsOtherDetails.label" /> * : </dt><dd id="projectRequestsOtherDetails" class="action-editField validate- required-true i18n-hccr.property.projectRequestsOtherDetails maxLength-60" ><span>${rqt?.projectRequestsOtherDetails}</span></dd>
    ...
    <div class="yui-u">
        ...
        <dl>
          <dt class=""><g:message code="hccr.property.projectWish.label" />  : </dt><dd id="projectWish" class="action-editField validate-textarea i18n-hccr.property.projectWish rows-10 maxLength-600" ><span>${rqt?.projectWish}</span></dd>
        </dl>
        
      
        
        <dl>
          <dt class=""><g:message code="hccr.property.projectNeeds.label" />  : </dt><dd id="projectNeeds" class="action-editField validate-textarea i18n-hccr.property.projectNeeds rows-10 maxLength-600" ><span>${rqt?.projectNeeds}</span></dd>
        </dl>
        
      
        
        <dl>
          <dt class=""><g:message code="hccr.property.projectComments.label" />  : </dt><dd id="projectComments" class="action-editField validate-textarea i18n-hccr.property.projectComments rows-10 maxLength-600" ><span>${rqt?.projectComments}</span></dd>
        </dl>
