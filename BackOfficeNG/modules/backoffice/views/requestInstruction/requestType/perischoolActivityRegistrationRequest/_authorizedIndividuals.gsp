  ...
  <h3>
    ...
    <span><g:message code="parr.property.authorizedIndividuals.label" /></span>
  </h3>
  ...
  <dl class="">
      ...
      <dd id="authorizedIndividuals[${listSize - 1 - index}].lastName" class="action-editField validate-lastName required-true i18n-parr.property.lastName maxLength-38" >
        <span>${it?.lastName}</span>
      </dd>
    
      <dt class="required"><g:message code="parr.property.firstName.label" /> * : </dt>
      <dd id="authorizedIndividuals[${listSize - 1 - index}].firstName" class="action-editField validate-firstName required-true i18n-parr.property.firstName maxLength-38" >
      ...
      <dd id="authorizedIndividuals[${listSize - 1 - index}].homePhone" class="action-editField validate-phone i18n-parr.property.homePhone maxLength-10" >
        <span>${it?.homePhone}</span>
      </dd>
    
      <dt class=""><g:message code="parr.property.officePhone.label" />  : </dt>
      <dd id="authorizedIndividuals[${listSize - 1 - index}].officePhone" class="action-editField validate-phone i18n-parr.property.officePhone maxLength-10" >
