      ...
      <div id="page1">
        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
              ...
              <dl>
                <dt class=""><g:message code="scr.property.ownerAddress.label" />  : </dt><dd id="ownerAddress" class="action-editField validate-address i18n-scr.property.ownerAddress" ><div><p class="additionalDeliveryInformation">${request?.ownerAddress?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${request?.ownerAddress?.additionalGeographicalInformation}</p><span class="streetNumber">${request?.ownerAddress?.streetNumber}</span> <span class="streetName">${request?.ownerAddress?.streetName}</span><p class="placeNameOrService">${request?.ownerAddress?.placeNameOrService}</p><span class="postalCode">${request?.ownerAddress?.postalCode}</span> <span class="city">${request?.ownerAddress?.city}</span><p class="countryName">${request?.ownerAddress?.countryName}</p></div></dd>
              </dl>
