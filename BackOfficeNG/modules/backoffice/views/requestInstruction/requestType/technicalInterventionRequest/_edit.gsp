        ...
        <div class="yui-g">
          ...
          <div class="yui-u first">
           ...
           <g:render template="/backofficeRequestInstruction/widget/localReferentialDataStatic" 
              ...
              <dl>
                <dt class="required"><g:message code="tir.property.interventionPlace.label" /> * : </dt><dd id="interventionPlace" class="action-editField validate-address required-true i18n-tir.property.interventionPlace" ><div><p class="additionalDeliveryInformation">${rqt?.interventionPlace?.additionalDeliveryInformation}</p><p class="additionalGeographicalInformation">${rqt?.interventionPlace?.additionalGeographicalInformation}</p><span class="streetNumber">${rqt?.interventionPlace?.streetNumber}</span> <span class="streetName">${rqt?.interventionPlace?.streetName}</span><p class="placeNameOrService">${rqt?.interventionPlace?.placeNameOrService}</p><span class="postalCode">${rqt?.interventionPlace?.postalCode}</span> <span class="city">${rqt?.interventionPlace?.city}</span><p class="countryName">${rqt?.interventionPlace?.countryName}</p></div></dd>
              </dl>
