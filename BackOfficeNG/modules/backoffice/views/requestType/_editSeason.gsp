<form id="seasonForm_${season?.id}" class="editable-list-form"
  ...
  <a class="calendarLink">
    <img id="registrationStart_${season?.id}Show" src="${createLinkTo(dir:'css/backoffice/yui/calendar',file:'calendar.gif')}"/>
  </a>
  ...
  <a class="calendarLink">
    <img id="registrationEnd_${season?.id}Show" src="${createLinkTo(dir:'css/backoffice/yui/calendar',file:'calendar.gif')}"/>
  </a>
  ...
  <a class="calendarLink">
    <img id="validationAuthorizationStart_${season?.id}Show" src="${createLinkTo(dir:'css/backoffice/yui/calendar',file:'calendar.gif')}"/>
  </a>
  ...
  <a class="calendarLink">
    <img id="effectStart_${season?.id}Show" src="${createLinkTo(dir:'css/backoffice/yui/calendar',file:'calendar.gif')}"/>
  </a>
  ...
  <a class="calendarLink">
    <img id="effectEnd_${season?.id}Show" src="${createLinkTo(dir:'css/backoffice/yui/calendar',file:'calendar.gif')}"/>
  </a>
