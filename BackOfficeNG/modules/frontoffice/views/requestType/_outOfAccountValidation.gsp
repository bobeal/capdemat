    ...
    <ul class="yes-no required">
      ...
      <li>
        <input type="radio" class="required validate-boolean condition-activeHomeFolder-trigger" title="" value="${it}" 
               name="_homeFolderResponsible.activeHomeFolder" ${flash.activeHomeFolder == null ? (!it ? 'checked="checked"' : '') : (flash.activeHomeFolder == it ? 'checked="checked"' : '') } />
  ...
  <fieldset class="condition-activeHomeFolder-filled">
    ...
    <input type="password" name="_homeFolderResponsible.password" class="required" value="" title="${message(code:'homeFolder.adult.property.password.validationError')}" />

    <label class="required">${message(code:'request.step.validation.label.confirmPassword')} *</label>
    <input type="password" name="_homeFolderResponsible.confirmPassword" class="required" value="" title="${message(code:'vcr.property.confirmPassword.validationError')}" />
  </fieldset>
  ...
  <fieldset class="condition-activeHomeFolder-filled">
    ...
    <select name="_homeFolderResponsible.question" class="required validate-not-first" title="${message(code:'homeFolder.adult.property.question.validationError')}">
    ...
    <input type="text" name="_homeFolderResponsible.answer" class="required" title="${message(code:'homeFolder.adult.property.answer.validationError')}" />
  </fieldset>

  <label class="required">${message(code:'request.step.validation.label.typeTextInImage')}*</label>
  <div class="captcha">
    <jcaptcha:jpeg name="captchaImage" />
    <input type="text" name="captchaText" class="required" title="${message(code:'request.step.validation.error.captcha')}" />
  </div>
