...
<html>
  ...
  <body>
    ...
    <h2 class="request-creation"> <g:message code="acr.label" /></h2>
    <p><g:message code="acr.description" /></p> 
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${['requester', 'firstStep'].contains(currentStep) ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="acr.step.requester.label" /> *
          </strong>
       ...
       <div id="requester">
         <form method="post"  id="stepForm-requester" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="acr.step.requester.label" />
             <span><g:message code="acr.step.requester.desc" /></span>
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/alignmentCertificateRequest/requester" />         
       ...
       <div id="cadastre">
         <form method="post"  id="stepForm-cadastre" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="acr.step.cadastre.label" />
             <span><g:message code="acr.step.cadastre.desc" /></span>
             <span class="error">${stepStates?.cadastre?.errorMsg}</span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
  
            <g:render template="/frontofficeRequestType/alignmentCertificateRequest/cadastre" />         
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/alignmentCertificateRequest/validation0" />
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="acr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
