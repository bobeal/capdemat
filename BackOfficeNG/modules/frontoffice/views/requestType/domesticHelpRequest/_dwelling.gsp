    ...
    <legend><g:message code="dhr.property.dhrCurrentDwelling.label" /></legend>
      ...
      <label class=" "><g:message code="dhr.property.dhrCurrentDwellingAddress.label" /> <span><g:message code="dhr.property.dhrCurrentDwellingAddress.help" /></span></label>
          ...
          <input type="text" title="" class="line2 required" value="${dhr.dhrCurrentDwellingAddress.streetName}" maxlength="32" name="dhrCurrentDwellingAddress.streetName" title="<g:message code="request.error.required" />" />
          ...
          <input type="text" class="line1 required" value="${dhr.dhrCurrentDwellingAddress.postalCode}" maxlength="5" name="dhrCurrentDwellingAddress.postalCode"/>
          <input type="text" title="" class="line2 required" value="${dhr.dhrCurrentDwellingAddress.city}" maxlength="32" name="dhrCurrentDwellingAddress.city" title="<g:message code="request.error.required" />" />
