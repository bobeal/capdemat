    ...
    <legend><g:message code="dhr.property.dhrSpouse.label" /></legend> 
      ...
      <label class="required condition-isSpouseMadam-trigger condition-isCoupleRequest-filled"><g:message code="dhr.property.dhrSpouseTitle.label" /> <span><g:message code="dhr.property.dhrSpouseTitle.help" /></span></label>
      ...
      <input name="dhrSpouseName" value="${rqt.dhrSpouseName}" class="required condition-isCoupleRequest-filled validate-lastName" title="<g:message code="dhr.property.dhrSpouseName.validationError" />">
      ...
      <input name="dhrSpouseFirstName" value="${rqt.dhrSpouseFirstName}" class="required condition-isCoupleRequest-filled validate-firstName" title="<g:message code="dhr.property.dhrSpouseFirstName.validationError" />">
      ...
      <input name="dhrSpouseMaidenName" value="${rqt.dhrSpouseMaidenName}" class="required condition-isSpouseMadam-filled validate-lastName" title="<g:message code="dhr.property.dhrSpouseMaidenName.validationError" />">
      ...
      <input name="dhrSpouseBirthPlace" value="${rqt.dhrSpouseBirthPlace}" class="required condition-isCoupleRequest-filled validate-string" title="<g:message code="dhr.property.dhrSpouseBirthPlace.validationError" />">
    ...
    <legend><g:message code="dhr.property.dhrSpouseStatus.label" /></legend> 
      ...
      <label class="required condition-isSpouseRetired-filled condition-isSpouseOtherPensionPlan-trigger"><g:message code="dhr.property.dhrSpousePrincipalPensionPlan.label" /> <span><g:message code="dhr.property.dhrSpousePrincipalPensionPlan.help" /></span></label>
      
            <select name="dhrSpousePrincipalPensionPlan" class="required condition-isSpouseRetired-filled condition-isSpouseOtherPensionPlan-trigger validate-no-first" title="<g:message code="dhr.property.dhrSpousePrincipalPensionPlan.validationError" />">
              <option value=""><g:message code="message.select.defaultOption" /></option>
      ...
      <input name="dhrSpousePensionPlanDetail" value="${rqt.dhrSpousePensionPlanDetail}" class="required condition-isSpouseOtherPensionPlan-filled validate-string" title="<g:message code="dhr.property.dhrSpousePensionPlanDetail.validationError" />">
      ...
      <input name="dhrSpouseComplementaryPensionPlan" value="${rqt.dhrSpouseComplementaryPensionPlan}" class="required condition-isSpouseRetired-filled validate-string" title="<g:message code="dhr.property.dhrSpouseComplementaryPensionPlan.validationError" />">
      ...
      <input name="dhrSpouseProfession" value="${rqt.dhrSpouseProfession}" class="required condition-isSpouseRetired-unfilled validate-string" title="<g:message code="dhr.property.dhrSpouseProfession.validationError" />">
      ...
      <input name="dhrSpouseEmployer" value="${rqt.dhrSpouseEmployer}" class="required condition-isSpouseRetired-unfilled validate-string" title="<g:message code="dhr.property.dhrSpouseEmployer.validationError" />">
    ...
    <legend><g:message code="dhr.property.dhrSpouseIncomes.label" /></legend> 
      ...
      <input name="pensions" value="${rqt.pensions}" class=" validate-positiveInteger" title="<g:message code="dhr.property.pensions.validationError" />">
      ...
      <input name="dhrAllowances" value="${rqt.dhrAllowances}" class=" validate-positiveInteger" title="<g:message code="dhr.property.dhrAllowances.validationError" />">
      ...
      <input name="dhrFurnitureInvestmentIncome" value="${rqt.dhrFurnitureInvestmentIncome}" class=" validate-positiveInteger" title="<g:message code="dhr.property.dhrFurnitureInvestmentIncome.validationError" />">
      ...
      <input name="dhrRealEstateInvestmentIncome" value="${rqt.dhrRealEstateInvestmentIncome}" class=" validate-positiveInteger" title="<g:message code="dhr.property.dhrRealEstateInvestmentIncome.validationError" />">
    
      <label class=""><g:message code="dhr.property.dhrNetIncome.label" /> <span><g:message code="dhr.property.dhrNetIncome.help" /></span></label>
      <input name="dhrNetIncome" value="${rqt.dhrNetIncome}" class=" validate-positiveInteger" title="<g:message code="dhr.property.dhrNetIncome.validationError" />">
      ...
      <input name="dhrIncomesAnnualTotal" value="${rqt.dhrIncomesAnnualTotal}" class="required validate-positiveInteger" title="<g:message code="dhr.property.dhrIncomesAnnualTotal.validationError" />">
