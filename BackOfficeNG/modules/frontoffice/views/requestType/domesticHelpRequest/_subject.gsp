    ...
    <select name="subjectId" class="required validate-not-first" title="request.subject.validationError">
      ...
      <label class="required"><g:message code="dhr.property.dhrRequesterBirthDate.label" /> <span><g:message code="dhr.property.dhrRequesterBirthDate.help" /></span></label>
          ...
          <input name="dhrRequesterBirthDate" value="${formatDate(formatName:'format.date',date:request.dhrRequesterBirthDate)}" 
      ...
      <input name="dhrRequesterBirthPlace" value="${request.dhrRequesterBirthPlace}" class="required validate-string" title="<g:message code="dhr.property.dhrRequesterBirthPlace.validationError" />">
      ...
      <label class="required condition-isNonEuropean-trigger"><g:message code="dhr.property.dhrRequesterNationality.label" /> <span><g:message code="dhr.property.dhrRequesterNationality.help" /></span></label>
          ...
          <select name="dhrRequesterNationality" class="required condition-isNonEuropean-trigger validate-no-first" title="<g:message code="dhr.property.dhrRequesterNationality.validationError" />">
            ...
            <g:each in="${['French','EuropeanUnion','OutsideEuropeanUnion']}">
              <option value="fr.cg95.cvq.business.users.NationalityType_${it}" ${it == request.dhrRequesterNationality?.toString() ? 'selected="selected"': ''}><g:capdematEnumToField var="${it}" i18nKeyPrefix="dhr.property.dhrRequesterNationality" /></option>
            </g:each>
          </select>
      ...
      <label class="required condition-isNonEuropean-filled"><g:message code="dhr.property.dhrRequesterFranceArrivalDate.label" /> <span><g:message code="dhr.property.dhrRequesterFranceArrivalDate.help" /></span></label>
          ...
          <input name="dhrRequesterFranceArrivalDate" value="${formatDate(formatName:'format.date',date:request.dhrRequesterFranceArrivalDate)}" 
      ...
      <label class="required condition-isNonEuropean-filled"><g:message code="dhr.property.dhrRequesterIsFrenchResident.label" /> <span><g:message code="dhr.property.dhrRequesterIsFrenchResident.help" /></span></label>
          ...
          <ul class="required condition-isNonEuropean-filled">
            ...
            <li>
              <input type="radio" class="required condition-isNonEuropean-filled validate-boolean" title="" value="${it}" name="dhrRequesterIsFrenchResident" ${it == request.dhrRequesterIsFrenchResident ? 'checked="checked"': ''} />
    ...
    <legend><g:message code="dhr.property.dhrRequesterPensionPlan.label" /></legend> 
      ...
      <label class="required condition-isOtherPensionPlan-trigger"><g:message code="dhr.property.dhrPrincipalPensionPlan.label" /> <span><g:message code="dhr.property.dhrPrincipalPensionPlan.help" /></span></label>
          ...
          <select name="dhrPrincipalPensionPlan" class="required condition-isOtherPensionPlan-trigger validate-no-first" title="<g:message code="dhr.property.dhrPrincipalPensionPlan.validationError" />">
            ...
            <g:each in="${['CNAV','MSA','CRAM','MGEN','SNCF','Other']}">
              <option value="fr.cg95.cvq.business.request.social.DhrPrincipalPensionPlanType_${it}" ${it == request.dhrPrincipalPensionPlan?.toString() ? 'selected="selected"': ''}><g:capdematEnumToField var="${it}" i18nKeyPrefix="dhr.property.dhrPrincipalPensionPlan" /></option>
            </g:each>
          </select>
      ...
      <input name="dhrPensionPlanDetail" value="${request.dhrPensionPlanDetail}" class="required condition-isOtherPensionPlan-filled validate-string" title="<g:message code="dhr.property.dhrPensionPlanDetail.validationError" />">
      ...
      <input name="dhrComplementaryPensionPlan" value="${request.dhrComplementaryPensionPlan}" class="required validate-string" title="<g:message code="dhr.property.dhrComplementaryPensionPlan.validationError" />">
    ...
    <legend><g:message code="dhr.property.dhrRequesterGuardian.label" /></legend> 
      ...
      <label class="required condition-haveGuardian-trigger"><g:message code="dhr.property.dhrRequesterHaveGuardian.label" /> <span><g:message code="dhr.property.dhrRequesterHaveGuardian.help" /></span></label>
          ...
          <ul class="required condition-haveGuardian-trigger">
            <g:each in="${[true,false]}">
            <li>
              <input type="radio" class="required condition-haveGuardian-trigger validate-boolean" title="" value="${it}" name="dhrRequesterHaveGuardian" ${it == request.dhrRequesterHaveGuardian ? 'checked="checked"': ''} />
	            <g:message code="message.${it ? 'yes' : 'no'}" />
            </li>
            </g:each>
          </ul>
      ...
      <label class="required condition-haveGuardian-filled"><g:message code="dhr.property.dhrGuardianMeasure.label" /> <span><g:message code="dhr.property.dhrGuardianMeasure.help" /></span></label>
          ...
          <select name="dhrGuardianMeasure" class="required condition-haveGuardian-filled validate-no-first" title="<g:message code="dhr.property.dhrGuardianMeasure.validationError" />">
            <option value=""><g:message code="message.select.defaultOption" /></option>
            <g:each in="${['safeguardingJustice','guardianship','curatorship']}">
              <option value="fr.cg95.cvq.business.request.social.DhrGuardianMeasureType_${it}" ${it == request.dhrGuardianMeasure?.toString() ? 'selected="selected"': ''}><g:capdematEnumToField var="${it}" i18nKeyPrefix="dhr.property.dhrGuardianMeasure" /></option>
            </g:each>
          </select>
      ...
      <input name="dhrGuardianName" value="${request.dhrGuardianName}" class="required condition-haveGuardian-filled validate-lastName" title="<g:message code="dhr.property.dhrGuardianName.validationError" />">
      ...
      <label class="required condition-haveGuardian-filled"><g:message code="dhr.property.dhrGuardianAddress.label" /> <span><g:message code="dhr.property.dhrGuardianAddress.help" /></span></label>
          ...
          <input type="text" value="${request.dhrGuardianAddress?.additionalDeliveryInformation}" maxlength="38" name="dhrGuardianAddress.additionalDeliveryInformation"/>  
          <label><g:message code="address.property.additionalGeographicalInformation" /></label>
          <input type="text" value="${request.dhrGuardianAddress?.additionalGeographicalInformation}" maxlength="38" name="dhrGuardianAddress.additionalGeographicalInformation"/>
          <label class="required"><g:message code="address.property.streetNumber" /> - <g:message code="address.property.streetName" /></label>
          <input type="text" class="line1" value="${request.dhrGuardianAddress?.streetNumber}" maxlength="5" name="dhrGuardianAddress.streetNumber"/>
          <input type="text" class="line2 required" value="${request.dhrGuardianAddress?.streetName}" maxlength="32" name="dhrGuardianAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
          <label><g:message code="address.property.placeNameOrService" /></label>
          <input type="text" value="${request.dhrGuardianAddress?.placeNameOrService}" maxlength="38" name="dhrGuardianAddress.placeNameOrService"/>
          <label class="required"><g:message code="address.property.postalCode" /> - <g:message code="address.property.city" /></label>
          <input type="text" class="line1 required" value="${request.dhrGuardianAddress?.postalCode}" maxlength="5" name="dhrGuardianAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
          <input type="text" class="line2 required" value="${request.dhrGuardianAddress?.city}" maxlength="32" name="dhrGuardianAddress.city" title="<g:message code="address.property.city.validationError" />" />
          <label><g:message code="address.property.countryName" /></label>
          <input type="text" value="${request.dhrGuardianAddress?.countryName}" maxlength="38" name="dhrGuardianAddress.countryName"/>
          </div>
