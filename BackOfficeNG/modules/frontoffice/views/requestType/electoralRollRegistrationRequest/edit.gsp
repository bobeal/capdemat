  ...
  <body>
    <g:set var="requestTypeInfo">
      {"label": "${requestTypeLabel}"
        ,"steps": [  "registration-required",  "document",  "validation"  ]
      }
    </g:set>
     ...
     <div class="yui-content">
       ...
       <div id="registration">
         <form method="post"  id="stepForm-registration" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="errr.step.registration.label" />
             <span><g:message code="errr.step.registration.desc" /></span>
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/electoralRollRegistrationRequest/registration" />         
         ...
         <div class="navTab">
           ...
           <a id="next-tab-registration" class="next-tab" href="#document"><g:message code="request.step.navigation.next"/></a>
       ...
       <div id="document">
         ...
         <div class="navTab">
           ...
           <a id="prev-tab-document" class="prev-tab" href="#registration"><g:message code="request.step.navigation.previous"/></a>
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="errr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
