    ...
    <legend><g:message code="hcar.property.health.label" /></legend>
      ...
      <label class="required"><g:message code="hcar.property.healthFollowedByDoctor.label" /> *  <span><g:message code="hcar.property.healthFollowedByDoctor.help" /></span></label>
            <ul class="yes-no required">
              ...
              <li>
                <input type="radio" class="required condition-isFollowedByDoctor-trigger  validate-one-required boolean" title="" value="${it}" name="healthFollowedByDoctor" ${it == rqt.healthFollowedByDoctor ? 'checked="checked"': ''} />
      ...
      <label class="required"><g:message code="hcar.property.healthFollowedByProfessional.label" /> *  <span><g:message code="hcar.property.healthFollowedByProfessional.help" /></span></label>
            <ul class="yes-no required">
              <g:each in="${[true,false]}">
              <li>
                <input type="radio" class="required condition-isFollowedByProfessional-trigger  validate-one-required boolean" title="" value="${it}" name="healthFollowedByProfessional" ${it == rqt.healthFollowedByProfessional ? 'checked="checked"': ''} />
                <g:message code="message.${it ? 'yes' : 'no'}" />
              </li>
              </g:each>
            </ul>
      ...
      <label class="required"><g:message code="hcar.property.healthFollowedByHospital.label" /> *  <span><g:message code="hcar.property.healthFollowedByHospital.help" /></span></label>
            <ul class="yes-no required">
              <g:each in="${[true,false]}">
              <li>
                <input type="radio" class="required condition-isFollowedByHospital-trigger  validate-one-required boolean" title="" value="${it}" name="healthFollowedByHospital" ${it == rqt.healthFollowedByHospital ? 'checked="checked"': ''} />
                <g:message code="message.${it ? 'yes' : 'no'}" />
              </li>
              </g:each>
            </ul>
