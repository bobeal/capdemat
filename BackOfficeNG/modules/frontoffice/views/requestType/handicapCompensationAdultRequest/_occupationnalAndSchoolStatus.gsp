    ...
    <legend><g:message code="hcar.property.formation.label" /></legend> 
      ...
      <label class=""><g:message code="hcar.property.formationDiploma.label" /> <span><g:message code="hcar.property.formationDiploma.help" /></span></label>
            ...
            <input type="text" name="formationDiploma" value="${rqt.formationDiploma}" 
                    class="required validate-textarea" title="<g:message code="hcar.property.formationDiploma.validationError" />">
      ...
      <label class=""><g:message code="hcar.property.formationPreviousFormation.label" /> <span><g:message code="hcar.property.formationPreviousFormation.help" /></span></label>
            ...
            <input type="text" name="formationPreviousFormation" value="${rqt.formationPreviousFormation}" 
                    class="required validate-textarea" title="<g:message code="hcar.property.formationPreviousFormation.validationError" />">
      ...
      <label class=""><g:message code="hcar.property.formationCurrentFormation.label" /> <span><g:message code="hcar.property.formationCurrentFormation.help" /></span></label>
            ...
            <input type="text" name="formationCurrentFormation" value="${rqt.formationCurrentFormation}" 
                    class="required validate-textarea" title="<g:message code="hcar.property.formationCurrentFormation.validationError" />">
