    ...
    <legend><g:message code="hccr.property.dwelling.label" /></legend>
      ...
      <label class="required condition-isNotPlaceOfResidence-filled"><g:message code="hccr.property.dwellingPrecision.label" /> *  <span><g:message code="hccr.property.dwellingPrecision.help" /></span></label>
            <textarea name="dwellingPrecision" class="required condition-isNotPlaceOfResidence-filled  validate-textarea" title="<g:message code="hccr.property.dwellingPrecision.validationError" />" rows="2" cols="" maxlength="120">${rqt.dwellingPrecision}</textarea>
      ...
      <label class="required"><g:message code="hccr.property.dwellingEstablishmentReception.label" /> *  <span><g:message code="hccr.property.dwellingEstablishmentReception.help" /></span></label>
            <ul class="yes-no required">
              ...
              <li>
                <input type="radio" class="required condition-isInEstablishmentReception-trigger  validate-one-required boolean" title="" value="${it}" name="dwellingEstablishmentReception" ${it == rqt.dwellingEstablishmentReception ? 'checked="checked"': ''} />
      ...
      <label class="required"><g:message code="hccr.property.dwellingSocialReception.label" /> *  <span><g:message code="hccr.property.dwellingSocialReception.help" /></span></label>
            <ul class="yes-no required">
              <g:each in="${[true,false]}">
              <li>
                <input type="radio" class="required condition-isInSocialReception-trigger  validate-one-required boolean" title="" value="${it}" name="dwellingSocialReception" ${it == rqt.dwellingSocialReception ? 'checked="checked"': ''} />
                <g:message code="message.${it ? 'yes' : 'no'}" />
              </li>
              </g:each>
            </ul>
