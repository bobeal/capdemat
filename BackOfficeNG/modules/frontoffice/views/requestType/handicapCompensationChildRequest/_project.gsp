    ...
    <label class=""><g:message code="hccr.property.projectWish.label" />   <span><g:message code="hccr.property.projectWish.help" /></span></label>
            <textarea name="projectWish" class="  validate-textarea" title="<g:message code="hccr.property.projectWish.validationError" />" rows="10" cols="" maxlength="600">${rqt.projectWish}</textarea>
    ...
    <label class=""><g:message code="hccr.property.projectNeeds.label" />   <span><g:message code="hccr.property.projectNeeds.help" /></span></label>
            <textarea name="projectNeeds" class="  validate-textarea" title="<g:message code="hccr.property.projectNeeds.validationError" />" rows="10" cols="" maxlength="600">${rqt.projectNeeds}</textarea>
    ...
    <label class=""><g:message code="hccr.property.projectComments.label" />   <span><g:message code="hccr.property.projectComments.help" /></span></label>
            <textarea name="projectComments" class="  validate-textarea" title="<g:message code="hccr.property.projectComments.validationError" />" rows="10" cols="" maxlength="600">${rqt.projectComments}</textarea>
