    ...
    <label class="required"><g:message code="hsr.property.otherContactAddress.label" /> *  <span><g:message code="hsr.property.otherContactAddress.help" /></span></label>
            ...
            <input type="text" value="${rqt.otherContactAddress?.additionalDeliveryInformation}" maxlength="38" id="otherContactAddress.additionalDeliveryInformation" name="otherContactAddress.additionalDeliveryInformation" />  
            ...
            <input type="text" value="${rqt.otherContactAddress?.additionalGeographicalInformation}" maxlength="38" id="otherContactAddress.additionalGeographicalInformation" name="otherContactAddress.additionalGeographicalInformation" />
            ...
            <input type="text" class="line1" value="${rqt.otherContactAddress?.streetNumber}" size="5" maxlength="5" id="otherContactAddress.streetNumber" name="otherContactAddress.streetNumber" />
            <input type="text" class="line2 required" value="${rqt.otherContactAddress?.streetName}" maxlength="32" id="otherContactAddress.streetName" name="otherContactAddress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
            <label for="otherContactAddress.placeNameOrService"><g:message code="address.property.placeNameOrService" /></label>
            <input type="text" value="${rqt.otherContactAddress?.placeNameOrService}" maxlength="38" id="otherContactAddress.placeNameOrService" name="otherContactAddress.placeNameOrService" />
            ...
            <input type="text" class="line1 required" value="${rqt.otherContactAddress?.postalCode}" size="5" maxlength="5" id="otherContactAddress.postalCode" name="otherContactAddress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
            <input type="text" class="line2 required" value="${rqt.otherContactAddress?.city}" maxlength="32" id="otherContactAddress.city" name="otherContactAddress.city" title="<g:message code="address.property.city.validationError" />" />
            <label for="otherContactAddress.countryName"><g:message code="address.property.countryName" /></label>
            <input type="text" value="${rqt.otherContactAddress?.countryName}" maxlength="38" id="otherContactAddress.countryName" name="otherContactAddress.countryName" />
            </div>
