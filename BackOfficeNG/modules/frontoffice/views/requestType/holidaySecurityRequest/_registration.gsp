    ...
    <label class="required"><g:message code="request.property.subject.label" /> *  <span><g:message code="request.property.subject.help" /></span></label>
            <select name="subjectId" class="required validate-not-first autofill-subjectMobilePhone-trigger" title="<g:message code="request.property.subject.validationError" /> ">
