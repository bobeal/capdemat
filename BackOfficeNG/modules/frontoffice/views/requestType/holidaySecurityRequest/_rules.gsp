    ...
    <label class="required"><g:message code="hsr.property.rulesAndRegulationsAcceptance.label" /> *  <span><g:message code="hsr.property.rulesAndRegulationsAcceptance.help" /></span></label>
