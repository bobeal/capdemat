  ...
  <body>
    <g:set var="requestTypeInfo">
      {"label": "${requestTypeLabel}"
        ,"steps": [  "census-required",  "parentage-required",  "situation-required",  "exemption",  "document",  "validation"  ]
      }
    </g:set>
     ...
     <div class="yui-content">
       ...
       <div id="census">
         <form method="POST"  id="stepForm-census" action="<g:createLink action="step" />">
           <h3>
             ...
             <span class="error"><g:message code="${stepStates?.census?.errorMsg}" /></span>
           </h3>
         ...
         <div class="navTab">
           ...
           <a id="next-tab" href="#parentage"><g:message code="request.step.navigation.next"/></a>
       ...
       <div id="parentage">
         <form method="POST"  id="stepForm-parentage" action="<g:createLink action="step" />">
           <h3>
             ...
             <span class="error"><g:message code="${stepStates?.parentage?.errorMsg}" /></span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
         ...
         <div class="navTab">
           ...
           <a id="prev-tab" href="#census"><g:message code="request.step.navigation.previous"/></a>
  
  
           <a id="next-tab" href="#situation"><g:message code="request.step.navigation.next"/></a>
       ...
       <div id="situation">
         <form method="POST"  id="stepForm-situation" action="<g:createLink action="step" />">
           <h3>
             ...
             <span class="error"><g:message code="${stepStates?.situation?.errorMsg}" /></span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
         ...
         <div class="navTab">
           ...
           <a id="prev-tab" href="#parentage"><g:message code="request.step.navigation.previous"/></a>
  
  
           <a id="next-tab" href="#exemption"><g:message code="request.step.navigation.next"/></a>
       ...
       <div id="exemption">
         <form method="POST"  id="stepForm-exemption" action="<g:createLink action="step" />">
           <h3>
             ...
             <span class="error"><g:message code="${stepStates?.exemption?.errorMsg}" /></span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
         ...
         <div class="navTab">
           ...
           <a id="prev-tab" href="#situation"><g:message code="request.step.navigation.previous"/></a>
       ...
       <div id="document">
         ...
         <div class="navTab">
           ...
           <a id="prev-tab" href="#exemption"><g:message code="request.step.navigation.previous"/></a>
