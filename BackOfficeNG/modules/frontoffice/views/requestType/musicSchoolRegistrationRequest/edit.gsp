...
<html>
  <head>
     <title>${message(code:'msrr.description')}</title>
  ...
  <body>
    ...
    <h2 class="request-creation"> <g:message code="msrr.label" /></h2>
    <p><g:message code="msrr.description" /></p> 
    <p><g:message code="request.duration.label" /><strong> : <g:message code="msrr.duration.value" /></strong></p>
    <p>
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${currentStep == 'rules' ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="msrr.step.rules.label" /> *
          </strong>
       ...
       <div id="rules">
         <form method="post"  id="stepForm-rules" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="msrr.step.rules.label" />
             <span><g:message code="msrr.step.rules.desc" /></span>
             <span class="error">${stepStates?.rules?.errorMsg}</span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
  
            <g:render template="/frontofficeRequestType/musicSchoolRegistrationRequest/rules" />         
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/musicSchoolRegistrationRequest/validation0" />
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="msrr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
