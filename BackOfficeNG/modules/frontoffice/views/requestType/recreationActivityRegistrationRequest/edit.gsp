     ...
     <div class="yui-content">
       ...
       <div id="registration">
         ...
         <div class="navTab">
           ...
           <a id="next-tab-registration" class="next-tab" href="#contact"><g:message code="request.step.navigation.next"/></a>
       ...
       <div id="contact">
         <form method="post"  id="stepForm-contact" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/recreationActivityRegistrationRequest/contact" />         
         ...
         <div class="navTab">
           ...
           <a id="prev-tab-contact" class="prev-tab" href="#registration"><g:message code="request.step.navigation.previous"/></a>
  
  
           <a id="next-tab-contact" class="next-tab" href="#authorization"><g:message code="request.step.navigation.next"/></a>
       ...
       <div id="authorization">
         <form method="post"  id="stepForm-authorization" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/recreationActivityRegistrationRequest/authorization" />         
         ...
         <div class="navTab">
           ...
           <a id="prev-tab-authorization" class="prev-tab" href="#contact"><g:message code="request.step.navigation.previous"/></a>
  
  
           <a id="next-tab-authorization" class="next-tab" href="#rules"><g:message code="request.step.navigation.next"/></a>
       ...
       <div id="rules">
         <form method="post"  id="stepForm-rules" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/recreationActivityRegistrationRequest/rules" />         
         ...
         <div class="navTab">
           ...
           <a id="prev-tab-rules" class="prev-tab" href="#authorization"><g:message code="request.step.navigation.previous"/></a>
  
  
           <a id="next-tab-rules" class="next-tab" href="#document"><g:message code="request.step.navigation.next"/></a>
       ...
       <div id="document">
         ...
         <div class="navTab">
           ...
           <a id="prev-tab-document" class="prev-tab" href="#rules"><g:message code="request.step.navigation.previous"/></a>
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/recreationActivityRegistrationRequest/validation0" />
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="rarr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
