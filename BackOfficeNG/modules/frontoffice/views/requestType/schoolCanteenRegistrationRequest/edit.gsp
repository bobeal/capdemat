...
<html>
  ...
  <body>
    ...
    <h2 class="request-creation"> <g:message code="scrr.label" /></h2>
    <p><g:message code="scrr.description" /></p> 
    <p><g:message code="request.duration.label" /><strong> : <g:message code="scrr.duration.value" /></strong></p>
    <p>
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${['registration', 'firstStep'].contains(currentStep) ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="scrr.step.registration.label" /> *
          </strong>
        ...
        <li class="${currentStep == 'rules' ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="scrr.step.rules.label" /> *
          </strong>
       ...
       <div id="registration">
         <form method="post"  id="stepForm-registration" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="scrr.step.registration.label" />
             <span><g:message code="scrr.step.registration.desc" /></span>
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/schoolCanteenRegistrationRequest/registration" />         
       ...
       <div id="rules">
         <form method="post"  id="stepForm-rules" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="scrr.step.rules.label" />
             <span><g:message code="scrr.step.rules.desc" /></span>
             <span class="error">${stepStates?.rules?.errorMsg}</span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
  
            <g:render template="/frontofficeRequestType/schoolCanteenRegistrationRequest/rules" />         
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/schoolCanteenRegistrationRequest/validation0" />
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="scrr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
