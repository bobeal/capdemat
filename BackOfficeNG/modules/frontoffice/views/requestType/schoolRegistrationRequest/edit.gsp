       ...
       <div id="registration">
         <form method="post"  id="stepForm-registration" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="srr.step.registration.label" />
             <span><g:message code="srr.step.registration.desc" /></span>
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/schoolRegistrationRequest/registration" />         
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="srr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
