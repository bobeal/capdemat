  ...
  <body>
    <g:set var="requestTypeInfo">
      {"label": "${requestTypeLabel}"
        ,"steps": [  "requester-required",  "cadastre-required",  "document",  "validation-required"  ]
      }
    </g:set>
    ...
    <h2 class="request-creation"> <g:message code="scr.label" /></h2>
    <p><g:message code="scr.description" /></p> 
    <p><g:message code="request.duration.label" /><strong> : <g:message code="scr.duration.value" /></strong></p>
    <p>
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${['requester', 'firstStep'].contains(currentStep) ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="scr.step.requester.label" /> *
          </strong>
        ...
        <li class="${currentStep == 'cadastre' ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="scr.step.cadastre.label" /> *
          </strong>
     ...
     <div class="yui-content">
       ...
       <div id="requester">
         <form method="post"  id="stepForm-requester" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="scr.step.requester.label" />
             <span><g:message code="scr.step.requester.desc" /></span>
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/sewerConnectionRequest/requester" />         
       ...
       <div id="cadastre">
         <form method="post"  id="stepForm-cadastre" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="scr.step.cadastre.label" />
             <span><g:message code="scr.step.cadastre.desc" /></span>
             <span class="error">${stepStates?.cadastre?.errorMsg}</span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
  
            <g:render template="/frontofficeRequestType/sewerConnectionRequest/cadastre" />         
         ...
         <div class="navTab">
           ...
           <a id="next-tab-cadastre" class="next-tab" href="#document"><g:message code="request.step.navigation.next"/></a>
       ...
       <div id="document">
         ...
         <div class="navTab">
           ...
           <a id="prev-tab-document" class="prev-tab" href="#cadastre"><g:message code="request.step.navigation.previous"/></a>
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/sewerConnectionRequest/validation0" />
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="scr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
