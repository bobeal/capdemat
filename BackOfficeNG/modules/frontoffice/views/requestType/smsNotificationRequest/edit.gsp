     ...
     <div class="yui-content">
       ...
       <div id="subscription">
         <form method="POST"  id="stepForm-subscription" action="<g:createLink action="step" />">
           <h3>
             ...
             <span class="error"><g:message code="${stepStates?.subscription?.errorMsg}" /></span>
           </h3>
       ...
       <div id="document">
         ...
         <div class="navTab">
           ...
           <a id="prev-tab" href="#subscription"><g:message code="request.step.navigation.previous"/></a>
