  ...
  <body>
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${['subscription', 'firstStep'].contains(currentStep) ? 'selected' : ''}">
  
          <a href="#subscription"><em>
     ...
     <div class="yui-content">
       ...
       <div id="subscription">
         <form method="post"  id="stepForm-subscription" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/smsNotificationRequest/subscription" />         
  
           </div>
           <div class="error" id="stepForm-subscription-error"> </div>
           <!-- Input submit-->
           <input type="hidden" name="requestTypeInfo" value="${requestTypeInfo}" />
           <input type="hidden" name="uuidString" value="${uuidString}" />
  
           <input type="submit" id="submit-step-subscription" name="submit-step-subscription" class="submit-step" value="${message(code:'action.validate')}" />
  
         </form>
         <div class="navTab">
  
  
           <a id="next-tab-subscription" class="next-tab" href="#document"><g:message code="request.step.navigation.next"/></a>
  
         </div>
         <g:if test="${helps.subscription != null}">       
       ...
       <div id="document">
         ...
         <div class="navTab">
           ...
           <a id="prev-tab-document" class="prev-tab" href="#subscription"><g:message code="request.step.navigation.previous"/></a>
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/smsNotificationRequest/validation0" />
