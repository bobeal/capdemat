    ...
    <label class="required"><g:message code="sgr.property.futureSchoolIsAbroad.label" /> *  <span><g:message code="sgr.property.futureSchoolIsAbroad.help" /></span></label>
            ...
            <ul class="required">
              ...
              <li>
                <input type="radio" class="required condition-willDoAbroadInternship-trigger validate-boolean" title="" value="${it}" name="futureSchoolIsAbroad" ${it == rqt.futureSchoolIsAbroad ? 'checked="checked"': ''} />
    ...
    <label class="required condition-willDoAbroadInternship-filled"><g:message code="sgr.property.abroadInternshipSchoolName.label" /> *  <span><g:message code="sgr.property.abroadInternshipSchoolName.help" /></span></label>
    
            <input type="text" name="abroadInternshipSchoolName" value="${rqt.abroadInternshipSchoolName}" 
                    class="required condition-willDoAbroadInternship-filled validate-string" title="<g:message code="sgr.property.abroadInternshipSchoolName.validationError" />"  />
            
  

  
    <label class="required condition-willDoAbroadInternship-filled"><g:message code="sgr.property.abroadInternshipSchoolAddress.label" /> *  <span><g:message code="sgr.property.abroadInternshipSchoolAddress.help" /></span></label>
    
            <input type="text" name="abroadInternshipSchoolAddress" value="${rqt.abroadInternshipSchoolAddress}" 
                    class="required condition-willDoAbroadInternship-filled validate-string" title="<g:message code="sgr.property.abroadInternshipSchoolAddress.validationError" />"  />
            
  

  
    <label class="required condition-willDoAbroadInternship-filled"><g:message code="sgr.property.abroadInternshipSchoolCountry.label" /> *  <span><g:message code="sgr.property.abroadInternshipSchoolCountry.help" /></span></label>
    
            <select name="abroadInternshipSchoolCountry" class="required condition-willDoAbroadInternship-filled validate-not-first" title="<g:message code="sgr.property.abroadInternshipSchoolCountry.validationError" />">
