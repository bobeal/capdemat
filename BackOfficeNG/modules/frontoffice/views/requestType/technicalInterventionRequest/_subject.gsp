    ...
    <label class="required"><g:message code="tir.property.interventionPlace.label" /> *  <span><g:message code="tir.property.interventionPlace.help" /></span></label>
            ...
            <input type="text" class="line1" value="${rqt.interventionPlace?.streetNumber}" maxlength="5" name="interventionPlace.streetNumber"/>
            ...
            <input type="text" class="line1 required" value="${rqt.interventionPlace?.postalCode}" maxlength="5" name="interventionPlace.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
