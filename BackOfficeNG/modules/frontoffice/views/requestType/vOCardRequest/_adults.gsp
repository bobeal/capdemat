...
<div class="collection-fieldset required validation-scope">  
  ...
  <fieldset class="collection-fieldset-add required">
    ...
    <div class="address-fieldset required">
      ...
      <input type="text" value="${editList?.adults?.adress?.additionalDeliveryInformation}" maxlength="38" name="_individuals.adults[${listIndex}].adress.additionalDeliveryInformation"/>
    ...
    <div class="adress-fieldset required">
    ...
    <input type="hidden" name="objectToManage" value="individuals" />
