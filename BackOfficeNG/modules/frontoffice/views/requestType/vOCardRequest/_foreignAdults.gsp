...
<div class="account-fieldset required validation-scope">
  ...
  <fieldset class="account-fieldset-add">
    ...
    <div class="yui-g">
      <div class="yui-u first">
        ...
        <select name="_individuals.tutors[${listIndex}].title" class="required validate-not-first" title="<g:message code="homeFolder.adult.property.title.validationError" />">
          ...
          <g:each in="${['Mister','Madam','Miss','Agency']}">
            <option value="fr.cg95.cvq.business.users.TitleType_${it}" ${it == editList?.tutors?.title?.toString() ? 'selected="selected"': ''}><g:capdematEnumToField var="${it}" i18nKeyPrefix="homeFolder.adult.title" /></option>
          </g:each>
        </select>

        <label class="required"><g:message code="homeFolder.individual.property.lastName" /></label>
        <input type="text" name="_individuals.tutors[${listIndex}].lastName" value="${editList?.tutors?.lastName}"
        ...
        <input type="text" name="_individuals.tutors[${listIndex}].firstName" value="${editList?.tutors?.firstName}"
        ...
        <select name="_individuals.tutors[${listIndex}].familyStatus" class="required validate-not-first" title="<g:message code="homeFolder.adult.property.familyStatus.validationError" />">
          ...
          <g:each in="${['Married','Single','Divorced','Widow','CommonLawMarriage','Pacs','Other']}">
            <option value="fr.cg95.cvq.business.users.FamilyStatusType_${it}" ${it == editList?.tutors?.familyStatus?.toString() ? 'selected="selected"': ''}><g:capdematEnumToField var="${it}" i18nKeyPrefix="homeFolder.adult.familyStatus" /></option>
          </g:each>
        </select>
        ...
        <input type="text" name="_individuals.tutors[${listIndex}].email" value="${editList?.tutors?.email}"
        ...
        <div class="address-fieldset one-required">
          ...
          <input type="text" name="_individuals.tutors[${listIndex}].homePhone" value="${editList?.tutors?.homePhone}"
          ...
          <input type="text" name="_individuals.tutors[${listIndex}].mobilePhone" value="${editList?.tutors?.mobilePhone}"
          ...
          <input type="text" name="_individuals.tutors[${listIndex}].officePhone" value="${editList?.tutors?.officePhone}"
      ...
      <div class="yui-u">
        ...
        <div class="address-fieldset required">
          ...
          <input type="text" value="${editList?.tutors?.adress?.additionalDeliveryInformation}" maxlength="38" name="_individuals.tutors[${listIndex}].adress.additionalDeliveryInformation"/>
          <label><g:message code="address.property.additionalGeographicalInformation" /></label>
          <input type="text" value="${editList?.tutors?.adress?.additionalGeographicalInformation}" maxlength="38" name="_individuals.tutors[${listIndex}].adress.additionalGeographicalInformation"/>
          <label><g:message code="address.property.streetNumber" /> - <strong><g:message code="address.property.streetName" /></strong></label>
          <input type="text" class="line1" value="${editList?.tutors?.adress?.streetNumber}" maxlength="5" name="_individuals.tutors[${listIndex}].adress.streetNumber"/>
          <input type="text" class="line2 required" value="${editList?.tutors?.adress?.streetName}" maxlength="32" name="_individuals.tutors[${listIndex}].adress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
          <label><g:message code="address.property.placeNameOrService" /></label>
          <input type="text" value="${editList?.tutors?.adress?.placeNameOrService}" maxlength="38" name="_individuals.tutors[${listIndex}].adress.placeNameOrService"/>
          <label class="required"><g:message code="address.property.postalCode" /> - <g:message code="address.property.city" /></label>
          <input type="text" class="line1 required validate-postalcode" value="${editList?.tutors?.adress?.postalCode}" maxlength="5" name="_individuals.tutors[${listIndex}].adress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
          <input type="text" class="line2 required validate-city" value="${editList?.tutors?.adress?.city}" maxlength="32" name="_individuals.tutors[${listIndex}].adress.city" title="<g:message code="address.property.city.validationError" />" />
          <label><g:message code="address.property.countryName" /></label>
          <input type="text" value="${editList?.tutors?.adress?.countryName}" maxlength="38" name="_individuals.tutors[${listIndex}].adress.countryName"/>
        </div>
      </div>
    </div>
    ...
    <g:if test="${editList?.name == 'tutors'}">
      <input type="submit" id="submit-collectionModify-foreignAdults-tutors[${listIndex}]" name="submit-collectionModify-foreignAdults-tutors[${listIndex}]" value="${message(code:'action.save')}" />
      <input type="submit" id="submit-collectionCancel-foreignAdults-tutors[${listIndex}]" name="submit-collectionCancel-foreignAdults-tutors[${listIndex}]" value="${message(code:'action.cancel')}" />
    </g:if>
    <g:else>
      <input type="submit" id="submit-collectionAdd-foreignAdults-tutors[${listIndex}]" name="submit-collectionAdd-foreignAdults-tutors[${listIndex}]" value="${message(code:'action.add')}" />
    </g:else>
  </fieldset>
  <div class="error" id="stepForm-adults-error"> </div>
    ...
    <fieldset class="account-fieldset-edit">
      <h4>
        ...
        <input type="submit" value="${message(code:'action.modify')}" name="submit-collectionEdit-foreignAdults-tutors[${index}]" />
        <input type="submit" value="${message(code:'action.remove')}" name="submit-collectionDelete-foreignAdults-tutors[${index}]" />
      </h4> 
      <dl>
        <!--
