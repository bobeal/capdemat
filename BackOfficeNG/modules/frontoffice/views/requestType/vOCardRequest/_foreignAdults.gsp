    ...
    <div class="yui-g">
      <div class="yui-u first">
        ...
        <div class="address-fieldset">
          <label for="_individuals.foreignAdults.${listIndex}.homePhone"><g:message code="homeFolder.adult.property.homePhone" /></label>
          ...
          <label for="_individuals.foreignAdults.${listIndex}.mobilePhone"><g:message code="homeFolder.adult.property.mobilePhone" /></label>
          ...
          <label for="_individuals.foreignAdults.${listIndex}.officePhone"><g:message code="homeFolder.adult.property.officePhone" /></label>
      ...
      <div class="yui-u">
        ...
        <div class="address-fieldset required">
          ...
          <input type="text" value="${editList?.foreignAdults?.adress?.additionalDeliveryInformation}" maxlength="38" id="_individuals.foreignAdults.${listIndex}.adress.additionalDeliveryInformation" name="_individuals.foreignAdults[${listIndex}].adress.additionalDeliveryInformation" />  
          ...
          <input type="text" value="${editList?.foreignAdults?.adress?.additionalGeographicalInformation}" maxlength="38" id="_individuals.foreignAdults.${listIndex}.adress.additionalGeographicalInformation" name="_individuals.foreignAdults[${listIndex}].adress.additionalGeographicalInformation" />
          ...
          <input type="text" class="line1" value="${editList?.foreignAdults?.adress?.streetNumber}" size="5" maxlength="5" id="_individuals.foreignAdults.${listIndex}.adress.streetNumber" name="_individuals.foreignAdults[${listIndex}].adress.streetNumber" />
          <input type="text" class="line2 required" value="${editList?.foreignAdults?.adress?.streetName}" maxlength="32" id="_individuals.foreignAdults.${listIndex}.adress.streetName" name="_individuals.foreignAdults[${listIndex}].adress.streetName" title="<g:message code="address.property.streetName.validationError" />" />
          ...
          <input type="text" value="${editList?.foreignAdults?.adress?.placeNameOrService}" maxlength="38" id="_individuals.foreignAdults.${listIndex}.adress.placeNameOrService" name="_individuals.foreignAdults[${listIndex}].adress.placeNameOrService" />
          ...
          <input type="text" class="line1 required" value="${editList?.foreignAdults?.adress?.postalCode}" size="5" maxlength="5" id="_individuals.foreignAdults.${listIndex}.adress.postalCode" name="_individuals.foreignAdults[${listIndex}].adress.postalCode" title="<g:message code="address.property.postalCode.validationError" />" />
          <input type="text" class="line2 required" value="${editList?.foreignAdults?.adress?.city}" maxlength="32" id="_individuals.foreignAdults.${listIndex}.adress.city" name="_individuals.foreignAdults[${listIndex}].adress.city" title="<g:message code="address.property.city.validationError" />" />
          <label for="_individuals.foreignAdults.${listIndex}.adress.countryName"><g:message code="address.property.countryName" /></label>
          <input type="text" value="${editList?.foreignAdults?.adress?.countryName}" maxlength="38" id="_individuals.foreignAdults.${listIndex}.adress.countryName" name="_individuals.foreignAdults[${listIndex}].adress.countryName" />
        </div>
      </div>
    </div>
