        ...
        if (response.status == "ok") {
          ...
          myDataTable.subscribe("checkboxClickEvent", 
              function(oArgs) {
                  ...
                  zcc.doAjaxCall(url,[this,elRecord,elCheckbox],handleAssociateDocumentToRequestTypeSuccess);
              }
          );
      }
        
      zcc.doAjaxCall('/loadAllDocumentTypes/' + requestTypeId,  [requestTypeId],handleLoadAllDocumentTypesSuccess);
  }
