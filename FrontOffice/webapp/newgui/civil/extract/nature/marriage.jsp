	...
	<cvqf:form name="Nature" action="#" >
      <fieldset class="fieldset_zone">
        <ul class="insert_list">
          ...
          <li class="text_row">
			<label for="marriageHusbandLastName" class="label">Nom de l'époux<span class="required">*</span></label>
            <cvqf:text name="marriageHusbandLastName" mode="" maxlength="38"/>
          </li>
          <li class="text_row">
			<label for="marriageHusbandFirstNames" class="label">Prénom(s) de l'époux<span class="required">*</span></label>
            <cvqf:text name="marriageHusbandFirstNames" mode=""/>
          </li>
          <li class="text_row">
			<label for="marriageWifeLastName" class="label">Nom de l'épouse<span class="required">*</span></label>
            <cvqf:text name="marriageWifeLastName" mode="" maxlength="38"/>
          </li>
          <li class="text_row">
			<label for="marriageWifeFirstNames" class="label">Prénom(s) de l'épouse<span class="required">*</span></label>
	...
	<script type="text/javascript">
		function validationData() {
   		  this.requesterQuality = new Function("key","this.label='Qualité du demandeur'; this.msg=null; this.required=false; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
     		  ...
     		  this.marriageHusbandLastName = new Function("key","this.label='Nom de l&quote;époux'; this.msg=null; this.required=true; this.mask=/[A-Z.]*/; this.minlength=0; this.maxlength=38; this.transform='uppercase'; this.type=null; return this[key];");
     		  this.marriageHusbandFirstNames = new Function("key","this.label='Prénom(s) de l&quote;époux'; this.msg=null; this.required=true; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
     		  this.marriageWifeLastName = new Function("key","this.label='Nom de l&quote;épouse'; this.msg=null; this.required=true; this.mask=/[A-Z.]*/; this.minlength=0; this.maxlength=38; this.transform='uppercase'; this.type=null; return this[key];");
     		  this.marriageWifeFirstNames = new Function("key","this.label='Prénom(s) de l&quote;épouse'; this.msg=null; this.required=true; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
