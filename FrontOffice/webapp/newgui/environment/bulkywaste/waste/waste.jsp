...
<%@ taglib uri="/cvq-forms" prefix="cvqf" %>
	...
	<cvqf:form name="Waste" action="#" >
      <fieldset class="fieldset_zone">
        <h3 class="fieldset_subtitle">Type d'encombrants<span class="required">*</span> :</h3>
        <ul class="insert_list">
            <cvqf:check name="bulkyWasteType" mode="blockrequired" repository="bulkywaste">
            </cvqf:check>
        </ul>
      </fieldset>
      <fieldset class="fieldset_zone">
      ...
      <fieldset class="fieldset_zone">
        <h3 class="fieldset_subtitle">Si l'adresse de collecte des encombrants est différente, merci de la préciser :</h3>
        <ul class="insert_list">
          <li class="text_row">
	...
	<script type="text/javascript">
		function validationData() {
   		  	  		  this.bulkyWasteType = new Function("key","this.label='Type d&quote;encombrants'; this.msg=null; this.required=true; this.minlength=0; this.maxlength=0; this.type='list:Other'; return this[key];");
