...
<%@ taglib uri="/cvq-forms" prefix="cvqf" %>
      ...
      <fieldset class="fieldset_zone">
        <ul class="insert_list">
          ...
          <li class="select_row">
            ...
            <cvqf:select name="fatherBirthCountry" mode="">
          ...
          <li class="select_row">
            ...
            <cvqf:select name="fatherNationality" mode="">
          ...
          <li class="text_row">
			<label for="motherLastName" class="label">Nom de jeune fille de la mère<span class="required">*</span></label>
            <cvqf:text name="motherLastName" mode="" maxlength="38"/>
          </li>
          <li class="text_row">
			<label for="motherFirstName" class="label">Prénom de la mère<span class="required">*</span></label>
            <cvqf:text name="motherFirstName" mode="" maxlength="38"/>
          </li>
          <li class="date_row">
			<label for="motherBirthDate" class="label">Date de naissance de la mère<span class="required">*</span></label>
            <cvqf:text name="motherBirthDate" mode="" maxlength="10"/>
          </li>
          <li class="text_row">
			<label for="motherBirthCity" class="label">Ville de naissance de la mère<span class="required">*</span></label>
            <cvqf:text name="motherBirthCity" mode=""/>
          </li>
          <li class="select_row">
			<label for="motherBirthDepartment" class="label">Département de naissance de la mère</label>
            <cvqf:select name="motherBirthDepartment" mode="">
          ...
          <li class="select_row">
            ...
            <cvqf:select name="motherBirthCountry" mode="">
              <option value="">Choisissez un pays</option>
              <option value="Unknown">Inconnu</option>
              <option value="af">Afghanistan (AF)</option>
              <option value="za">Afrique du Sud (ZA)</option>
          ...
          <li class="select_row">
			<label for="motherNationality" class="label">Nationalité de la mère<span class="required">*</span></label>
            <cvqf:select name="motherNationality" mode="">
              <option value="">Choisissez une nationalité</option>
              <option value="None">Aucune</option>
              <option value="af">Afghan(e)</option>
              <option value="za">Sud-africain(e)</option>
	...
	<script type="text/javascript">
		function validationData() {
   		  this.fatherLastName = new Function("key","this.label='Nom du père'; this.msg=null; this.required=false; this.mask=/[A-Z.]*/; this.minlength=0; this.maxlength=38; this.transform='uppercase'; this.type=null; return this[key];");
     		  this.fatherFirstName = new Function("key","this.label='Prénom du père'; this.msg=null; this.required=false; this.mask=/[A-Z]?.*/; this.minlength=0; this.maxlength=38; this.transform='firstupper'; this.type=null; return this[key];");
     		  this.fatherBirthDate = new Function("key","this.label='Date de naissance du père'; this.msg=null; this.required=false; this.mask=/[0-9]{1,2}[\\/][0-9]{1,2}[\\/][0-9]{4}/; this.minlength=0; this.maxlength=10; this.transform='date'; this.type=null; return this[key];");
     		  this.fatherBirthCity = new Function("key","this.label='Ville de naissance du père'; this.msg=null; this.required=false; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
     		  this.fatherBirthDepartment = new Function("key","this.label='Département de naissance du père'; this.msg=null; this.required=false; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
     		  this.fatherBirthCountry = new Function("key","this.label='Pays de naissance du père'; this.msg=null; this.required=false; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
     		  this.fatherNationality = new Function("key","this.label='Nationalité du père'; this.msg=null; this.required=false; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
     		  this.motherLastName = new Function("key","this.label='Nom de jeune fille de la mère'; this.msg=null; this.required=true; this.mask=/[A-Z.]*/; this.minlength=0; this.maxlength=38; this.transform='uppercase'; this.type=null; return this[key];");
     		  this.motherFirstName = new Function("key","this.label='Prénom de la mère'; this.msg=null; this.required=true; this.mask=/[A-Z]?.*/; this.minlength=0; this.maxlength=38; this.transform='firstupper'; this.type=null; return this[key];");
     		  this.motherBirthDate = new Function("key","this.label='Date de naissance de la mère'; this.msg=null; this.required=true; this.mask=/[0-9]{1,2}[\\/][0-9]{1,2}[\\/][0-9]{4}/; this.minlength=0; this.maxlength=10; this.transform='date'; this.type=null; return this[key];");
     		  this.motherBirthCity = new Function("key","this.label='Ville de naissance de la mère'; this.msg=null; this.required=true; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
     		  this.motherBirthDepartment = new Function("key","this.label='Département de naissance de la mère'; this.msg=null; this.required=false; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
     		  this.motherBirthCountry = new Function("key","this.label='Pays de naissance de la mère'; this.msg=null; this.required=false; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
     		  this.motherNationality = new Function("key","this.label='Nationalité de la mère'; this.msg=null; this.required=true; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
  		}
        updateDisplay("fatherBirthDepartment");
        updateDisplay("fatherBirthCountry");
        updateDisplay("fatherNationality");
        updateDisplay("motherBirthDepartment");
        updateDisplay("motherBirthCountry");
        updateDisplay("motherNationality");
