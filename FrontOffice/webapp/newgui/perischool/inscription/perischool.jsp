...
<%@ taglib uri="/cvq-forms" prefix="cvqf" %>
	...
	<cvqf:form name="Inscription" action="#" >
      ...
      <fieldset class="fieldset_zone">
        <h3 class="fieldset_subtitle">Activités périscolaires<span class="required">*</span> :</h3>
        <ul class="insert_list">
            <cvqf:check name="perischoolActivity" mode="" repository="activityList">
            </cvqf:check>
        </ul>
      </fieldset>
	</cvqf:form>
	<script type="text/javascript">
		function validationData() {
   		  		  this.perischoolActivity = new Function("key","this.label='Activités périscolaires'; this.msg=null; this.required=true; this.minlength=0; this.maxlength=0; this.type='list'; return this[key];");
  		}
        updateDisplay("perischoolActivity");
