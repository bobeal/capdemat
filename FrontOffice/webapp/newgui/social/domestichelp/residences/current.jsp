...
<%@ taglib uri="/cvq-forms" prefix="cvqf" %>
      ...
      <fieldset class="fieldset_zone">
        ...
        <ul class="insert_list">
          ...
          <li class="phone_row">
            ...
            <cvqf:text name="currentDwellingCurrentDwellingPersonalPhone" mode="" maxlength="10"/>
          </li>
          <li class="select_row">
			<label for="currentDwellingCurrentDwellingType" class="label">Nature de l'habitation<span class="required">*</span></label>
          ...
          <li class="date_row">
			<label for="currentDwellingCurrentDwellingArrivalDate" class="label">Date d'arrivée<span class="required">*</span></label>
            <cvqf:text name="currentDwellingCurrentDwellingArrivalDate" mode="" maxlength="10"/>
          </li>
        </ul>
        <ul class="insert_list" id="Domicile">
          <li class="select_row">
			<label for="currentDwellingCurrentDwellingStatus" class="label">Statut Habitation<span class="required">*</span></label>
          ...
          <li class="text_row">
			<label for="currentDwellingCurrentDwellingRoomNumber" class="label">Nombre de pièces<span class="required">*</span></label>
            <cvqf:text name="currentDwellingCurrentDwellingRoomNumber" mode="" maxlength="10"/>
          </li>
          <li class="text_row">
			<label for="currentDwellingCurrentDwellingNetFloorArea" class="label">Surface habitable<span class="required">*</span></label>
	...
	<script type="text/javascript">
	  ...
	  this.currentDwellingCurrentDwellingAddressCity = new Function("key","this.label='Localité'; this.msg=null; this.transform='uppercase'; this.required=true; this.minlength=0; this.maxlength=32; this.type=null; return this[key];");
     		  this.currentDwellingCurrentDwellingPersonalPhone = new Function("key","this.label='Téléphone personnel'; this.msg=null; this.required=false; this.mask=/^0[1-9][0-9]{8}/; this.minlength=0; this.maxlength=10; this.type=null; return this[key];");
     		  this.currentDwellingCurrentDwellingType = new Function("key","this.label='Nature de l&quote;habitation'; this.msg=null; this.required=true; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
     		  this.currentDwellingCurrentDwellingArrivalDate = new Function("key","this.label='Date d&quote;arrivée'; this.msg=null; this.required=true; this.mask=/[0-9]{1,2}[\\/][0-9]{1,2}[\\/][0-9]{4}/; this.minlength=0; this.maxlength=10; this.transform='date'; this.type=null; return this[key];");
     		  this.currentDwellingCurrentDwellingStatus = new Function("key","this.label='Statut Habitation'; this.msg=null; this.required=true; this.minlength=0; this.maxlength=0; this.type=null; return this[key];");
     		  this.currentDwellingCurrentDwellingRoomNumber = new Function("key","this.label='Nombre de pièces'; this.msg=null; this.required=true; this.mask=/^[0-9]+$/; this.minlength=0; this.maxlength=10; this.type=null; return this[key];");
     		  this.currentDwellingCurrentDwellingNetFloorArea = new Function("key","this.label='Surface habitable'; this.msg=null; this.required=true; this.mask=/^[0-9]+$/; this.minlength=0; this.maxlength=10; this.type=null; return this[key];");
  		}
