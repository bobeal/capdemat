 ...
 */
public class SelectTag extends CvqFormBodyTag {
	...
	public int doEndTag() throws JspException {
        if (display()) try {
            if (!writeTag("select","end",this)) {
    			...
    			Collection listItems = (Collection)pageContext.getSession().getAttribute(getRepository());
    ...
    private String getOptionLine(String value, ReferentialData data) {
        String line = "";
        if ((getMode() == null) || !getMode().equalsIgnoreCase("static")) {
        ...
        } else if ((value != null) && data.getKey().equals(value)) {
            // Only printout the label of the current value
            line = data.getValue();
