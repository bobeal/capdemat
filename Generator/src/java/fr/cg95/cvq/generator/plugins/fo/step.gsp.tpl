  ...
  def displayWidget(element, valuePrefix, namePrefix) {
      ...
      def widgets = [
        ...
        ,'address' :
            ...
            <input type="hidden" value="" id="${IdRefNamePrefix}${element.javaFieldName}_streetMatriculation" name="${IdRefNamePrefix}${element.javaFieldName}.streetMatriculation" />
            ...
            <input type="hidden" value="" id="${IdRefNamePrefix}${element.javaFieldName}_cityInseeCode" name="${IdRefNamePrefix}${element.javaFieldName}.cityInseeCode" />
