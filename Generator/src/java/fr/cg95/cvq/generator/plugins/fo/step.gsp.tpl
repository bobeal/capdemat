  ...
  def displayWidget(element, valuePrefix, namePrefix) {
      ...
      def widgets = [
        ...
        ,'address' :
            ...
            <input type="hidden" value="\${${valuePrefix}.${element.javaFieldName}?.streetMatriculation}" id="${IdRefNamePrefix}${element.javaFieldName}.streetMatriculation" name="${IdRefNamePrefix}${element.javaFieldName}.streetMatriculation" />
            ...
            <input type="hidden" value="\${${valuePrefix}.${element.javaFieldName}?.cityInseeCode}" id="${IdRefNamePrefix}${element.javaFieldName}.cityInseeCode" name="${IdRefNamePrefix}${element.javaFieldName}.cityInseeCode" />
