...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="OtherIndividualType">
    <xsl:param name="localizationService"></xsl:param>
    ...
    <fo:table xsl:use-attribute-sets="request.field.inline.table">
      ...
      <fo:table-body>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
              <xsl:if test="string(cse:LastName)">
                <xsl:value-of select="cse:LastName" />
              </xsl:if>
              <xsl:if test="not(string(cse:LastName))">&#160;</xsl:if>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-body>
    ...
    <fo:table xsl:use-attribute-sets="request.field.inline.table">
      ...
      <fo:table-body>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
              <xsl:if test="string(cse:FirstName)">
                <xsl:value-of select="cse:FirstName" />
              </xsl:if>
              <xsl:if test="not(string(cse:FirstName))">&#160;</xsl:if>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-body>
    ...
    <fo:table xsl:use-attribute-sets="request.field.inline.table">
      ...
      <fo:table-body>
        <fo:table-row>
          <fo:table-cell>
            <fo:block xsl:use-attribute-sets="request.field.inline.label">Adresse*</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
              <xsl:choose>
                <xsl:when test="cse:Address and cse:Address != ''">
                  <xsl:value-of select="cse:Address" />
                </xsl:when>
                <xsl:otherwise>
                  <xsl:text>&#160;</xsl:text>
                </xsl:otherwise>
    ...
    <fo:table xsl:use-attribute-sets="request.field.inline.table">
      ...
      <fo:table-body>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
              <xsl:if test="string(cse:HomePhone)">
                <xsl:value-of select="cse:HomePhone" />
              </xsl:if>
              <xsl:if test="not(string(cse:HomePhone))">&#160;</xsl:if>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block xsl:use-attribute-sets="request.field.inline.label">Tél. portable</fo:block>
          ...
          <fo:table-cell>
            <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
              <xsl:if test="string(cse:OfficePhone)">
                <xsl:value-of select="cse:OfficePhone" />
              </xsl:if>
              <xsl:if test="not(string(cse:OfficePhone))">&#160;</xsl:if>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-body>
    ...
    <fo:table xsl:use-attribute-sets="request.field.inline.table">
      ...
      <fo:table-body>
        <fo:table-row>
          <fo:table-cell>
            <fo:block xsl:use-attribute-sets="request.field.inline.label">Type</fo:block>
          </fo:table-cell>

          <xsl:variable name="personType" select="cse:Type" />
          <xsl:for-each select="locservice:getEnumsDataNode($localizationService,'http://www.cg95.fr/cvq/schema/cse','SchoolOtherIndividualType','fr')//ref:data[@name = 'SchoolOtherIndividualType']/ref:entry">
            <fo:table-cell>
              <fo:block xsl:use-attribute-sets="request.field.checkbox.value">
                <xsl:choose>
                  <xsl:when test="$personType = @key">X</xsl:when>
                  <xsl:otherwise>&#160;</xsl:otherwise>
                </xsl:choose>
              </fo:block>
            </fo:table-cell>
