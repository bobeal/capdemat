	...
	<fo:flow flow-name="xsl-region-body">
	  ...
	  <fo:block>
	    <xsl:call-template name="requestHeader">
	      <xsl:with-param name="RequestName">Demande d'enlèvement des déchets verts</xsl:with-param>
	    ...
	    <fo:block>
	      <fo:leader leader-pattern="space" />
              ...
              <fo:leader leader-pattern="space" />
                  ...
                  <fo:block xsl:use-attribute-sets="request.section.header">Type de végétaux</fo:block>
	    <fo:block>
	      <fo:leader leader-pattern="space" />
	    </fo:block>
