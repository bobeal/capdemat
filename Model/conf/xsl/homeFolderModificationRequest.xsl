...
<xsl:stylesheet version="1.0" 
  xmlns:hfmr="http://www.cg95.fr/cvq/schema/hfmr" 
	...
	<fo:flow flow-name="xsl-region-body">
	  ...
	  <fo:block>
	    <xsl:call-template name="requestHeader">
	      <xsl:with-param name="RequestName">Demande de modification de foyer</xsl:with-param>
      ...
      <fo:block>
	    ...
	    <xsl:call-template name="requestFooter">
	      <xsl:with-param name="RequestId">
            <xsl:value-of select="hfmr:HomeFolderModificationRequest/cvq:Id"/>
          </xsl:with-param>
	      <xsl:with-param name="CreationDate">
            <xsl:value-of select="hfmr:HomeFolderModificationRequest/cvq:CreationDate"/>
          </xsl:with-param>
	    </xsl:call-template>
