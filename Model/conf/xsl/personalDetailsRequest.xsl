...
<xsl:stylesheet version="1.0" 
  xmlns:pdr="http://www.cg95.fr/cvq/schema/pdr" 
	...
	<fo:flow flow-name="xsl-region-body">
	  ...
	  <fo:block>
	    <xsl:call-template name="requestHeader">
	      <xsl:with-param name="RequestName">Demande de copie intégrale ou extrait d'acte d'état civil</xsl:with-param>
	      ...
	      <fo:leader leader-pattern="space" />
              ...
              <xsl:variable name="enum_tokens">
                <xsl:call-template name="split-string">
                        <xsl:with-param name="string" select="//pdr:Certificate/text()"/>
                      </xsl:call-template>
              </xsl:variable>
                    <fo:table-column column-width="100pt" />
      
              <xsl:for-each select="locservice:getEnumsDataNode($localizationService,'http://www.cg95.fr/cvq/schema/pdr','CertificateType','fr')//ref:data[@name = 'CertificateType']/ref:entry">
			...
			<xsl:choose>
              ...
              <xsl:variable name="enum_tokens">
                <xsl:call-template name="split-string">
                        <xsl:with-param name="string" select="//pdr:Format/text()"/>
                      </xsl:call-template>
              </xsl:variable>
                    <fo:table-column column-width="100pt" />
      
              <xsl:for-each select="locservice:getEnumsDataNode($localizationService,'http://www.cg95.fr/cvq/schema/pdr','CertificateFormatType','fr')//ref:data[@name = 'CertificateFormatType']/ref:entry">
                <xsl:if test="not(position() &gt; ($mod_column + 1))">
                  <fo:table-column column-width="30pt" />
                  <fo:table-column column-width="proportional-column-width(1) - 30pt"/>
                </xsl:if>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.char_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:Copies and //pdr:Copies != ''">
                                    <xsl:value-of select="//pdr:Copies" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:Usage and //pdr:Usage != ''">
                                    <xsl:value-of select="//pdr:Usage" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
	    ...
	    <fo:block>
	      <fo:leader leader-pattern="space" />
              ...
              <xsl:variable name="enum_tokens">
                <xsl:call-template name="split-string">
                        <xsl:with-param name="string" select="//pdr:RequesterQuality/text()"/>
                      </xsl:call-template>
              </xsl:variable>
      
              <xsl:for-each select="locservice:getEnumsDataNode($localizationService,'http://www.cg95.fr/cvq/schema/pdr','RequesterQualityType','fr')//ref:data[@name = 'RequesterQualityType']/ref:entry">
                <xsl:if test="not(position() &gt; ($mod_column + 1))">
                  <fo:table-column column-width="30pt" />
                  <fo:table-column column-width="proportional-column-width(1) - 30pt"/>
                </xsl:if>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:RequesterQualityPrecision and //pdr:RequesterQualityPrecision != ''">
                                    <xsl:value-of select="//pdr:RequesterQualityPrecision" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
              ...
              <fo:block break-after="page"/>
                ...
                <xsl:if test="//pdr:Certificate/text() = 'Birth'">
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:BirthLastName and //pdr:BirthLastName != ''">
                                    <xsl:value-of select="//pdr:BirthLastName" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:BirthFirstNames and //pdr:BirthFirstNames != ''">
                                    <xsl:value-of select="//pdr:BirthFirstNames" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
		        ...
		        <xsl:with-param name="DateToDisplay">
		          <xsl:value-of select="//pdr:BirthDate"/>
		        </xsl:with-param>
	              </xsl:call-template>
			    </fo:block>
		  </fo:table-cell>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:BirthCity and //pdr:BirthCity != ''">
                                    <xsl:value-of select="//pdr:BirthCity" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:BirthPostalCode and //pdr:BirthPostalCode != ''">
                                    <xsl:value-of select="//pdr:BirthPostalCode" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
              ...
              <fo:leader leader-pattern="space" />
                ...
                <xsl:if test="//pdr:Certificate/text() = 'Marriage'">
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:MarriageHusbandLastName and //pdr:MarriageHusbandLastName != ''">
                                    <xsl:value-of select="//pdr:MarriageHusbandLastName" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:MarriageHusbandFirstNames and //pdr:MarriageHusbandFirstNames != ''">
                                    <xsl:value-of select="//pdr:MarriageHusbandFirstNames" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:MarriageWifeLastName and //pdr:MarriageWifeLastName != ''">
                                    <xsl:value-of select="//pdr:MarriageWifeLastName" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:MarriageWifeFirstNames and //pdr:MarriageWifeFirstNames != ''">
                                    <xsl:value-of select="//pdr:MarriageWifeFirstNames" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                	              <xsl:call-template name="cvq:DisplayDate">
		        <xsl:with-param name="DateToDisplay">
		          <xsl:value-of select="//pdr:MarriageDate"/>
		        </xsl:with-param>
	              </xsl:call-template>
			    </fo:block>
		  </fo:table-cell>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:MarriageCity and //pdr:MarriageCity != ''">
                                    <xsl:value-of select="//pdr:MarriageCity" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:MarriagePostalCode and //pdr:MarriagePostalCode != ''">
                                    <xsl:value-of select="//pdr:MarriagePostalCode" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
              ...
              <fo:leader leader-pattern="space" />
                ...
                <xsl:if test="//pdr:Certificate/text() = 'Death'">
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:DeathLastName and //pdr:DeathLastName != ''">
                                    <xsl:value-of select="//pdr:DeathLastName" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:DeathFirstNames and //pdr:DeathFirstNames != ''">
                                    <xsl:value-of select="//pdr:DeathFirstNames" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                	              <xsl:call-template name="cvq:DisplayDate">
		        <xsl:with-param name="DateToDisplay">
		          <xsl:value-of select="//pdr:DeathDate"/>
		        </xsl:with-param>
	              </xsl:call-template>
			    </fo:block>
		  </fo:table-cell>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:DeathCity and //pdr:DeathCity != ''">
                                    <xsl:value-of select="//pdr:DeathCity" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:DeathPostalCode and //pdr:DeathPostalCode != ''">
                                    <xsl:value-of select="//pdr:DeathPostalCode" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
              ...
              <fo:leader leader-pattern="space" />
                ...
                <xsl:if test="//pdr:Format/text() = 'ExtractWithRelationship' or //pdr:Format/text() = 'FullCopy'">
	    ...
	    <fo:block>
	      <fo:leader leader-pattern="space" />
              ...
              <xsl:variable name="enum_tokens">
                <xsl:call-template name="split-string">
                        <xsl:with-param name="string" select="//pdr:Relationship/text()"/>
                      </xsl:call-template>
              </xsl:variable>
                    <fo:table-column column-width="100pt" />
      
              <xsl:for-each select="locservice:getEnumsDataNode($localizationService,'http://www.cg95.fr/cvq/schema/pdr','RelationshipType','fr')//ref:data[@name = 'RelationshipType']/ref:entry">
                <xsl:if test="not(position() &gt; ($mod_column + 1))">
                  <fo:table-column column-width="30pt" />
                  <fo:table-column column-width="proportional-column-width(1) - 30pt"/>
                </xsl:if>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:FatherLastName and //pdr:FatherLastName != ''">
                                    <xsl:value-of select="//pdr:FatherLastName" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:FatherFirstNames and //pdr:FatherFirstNames != ''">
                                    <xsl:value-of select="//pdr:FatherFirstNames" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:MotherMaidenName and //pdr:MotherMaidenName != ''">
                                    <xsl:value-of select="//pdr:MotherMaidenName" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
		...
		<fo:table-row>
		  ...
		  <fo:table-cell>
        		    <fo:block xsl:use-attribute-sets="request.field.inline.string_value">
                                      <xsl:choose>
                        <xsl:when test="//pdr:MotherFirstNames and //pdr:MotherFirstNames != ''">
                                    <xsl:value-of select="//pdr:MotherFirstNames" />
                                  </xsl:when>
                        <xsl:otherwise>
                          <xsl:text>&#160;</xsl:text>
                        </xsl:otherwise>
	    ...
	    <xsl:call-template name="requestFooter">
	      <xsl:with-param name="RequestId">
            <xsl:value-of select="pdr:PersonalDetailsRequest/cvq:Id"/>
          </xsl:with-param>
	      <xsl:with-param name="CreationDate">
            <xsl:value-of select="pdr:PersonalDetailsRequest/cvq:CreationDate"/>
          </xsl:with-param>
	    </xsl:call-template>
