	...
	<fo:flow flow-name="xsl-region-body">
	  ...
	  <fo:block>
	    <xsl:call-template name="requestHeader">
	      <xsl:with-param name="RequestName">Demande d'inscription d'un enfant à des petites vacances</xsl:with-param>
	    ...
	    <xsl:call-template name="requestFooter">
	      <xsl:with-param name="RequestId">
            <xsl:value-of select="vrr:VacationsRegistrationRequest/cvq:Id"/>
          </xsl:with-param>
	      <xsl:with-param name="CreationDate">
            <xsl:value-of select="vrr:VacationsRegistrationRequest/cvq:CreationDate"/>
          </xsl:with-param>
	    </xsl:call-template>
