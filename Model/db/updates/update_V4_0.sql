...
delete from request_form where id in (select request_form_id from forms where request_type_id = (select id from request_type where label = 'Vacations Registration'));
delete from forms where request_type_id = (select id from request_type where label = 'Vacations Registration');
