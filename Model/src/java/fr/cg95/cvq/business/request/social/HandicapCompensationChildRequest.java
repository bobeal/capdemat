    ...
    public final XmlObject modelToXml() {
        ...
        if (familyDependents != null) {
            ...
            while (familyDependentsIt.hasNext()) {
                HccrFamilyDependent object = (HccrFamilyDependent) familyDependentsIt.next();
                familyDependentsTypeTab[i] = (HccrFamilyDependentType) object.modelToXml();
                i = i + 1;
            }
        ...
        if (otherFolders != null) {
            ...
            while (otherFoldersIt.hasNext()) {
                HccrOtherFolder object = (HccrOtherFolder) otherFoldersIt.next();
                otherFoldersTypeTab[i] = (HccrOtherFolderType) object.modelToXml();
                i = i + 1;
            }
        ...
        if (homeIntervenants != null) {
            ...
            while (homeIntervenantsIt.hasNext()) {
                HccrHomeIntervenant object = (HccrHomeIntervenant) homeIntervenantsIt.next();
                homeIntervenantsTypeTab[i] = (HccrHomeIntervenantType) object.modelToXml();
                i = i + 1;
            }
        ...
        if (additionalFee != null) {
            ...
            while (additionalFeeIt.hasNext()) {
                HccrAdditionalFee object = (HccrAdditionalFee) additionalFeeIt.next();
                additionalFeeTypeTab[i] = (HccrAdditionalFeeType) object.modelToXml();
                i = i + 1;
            }
        ...
        if (familyAssistanceMembers != null) {
            ...
            while (familyAssistanceMembersIt.hasNext()) {
                HccrFamilyAssistanceMember object = (HccrFamilyAssistanceMember) familyAssistanceMembersIt.next();
                familyAssistanceMembersTypeTab[i] = (HccrFamilyAssistanceMemberType) object.modelToXml();
                i = i + 1;
            }
        ...
        if (professionals != null) {
            ...
            while (professionalsIt.hasNext()) {
                HccrProfessional object = (HccrProfessional) professionalsIt.next();
                professionalsTypeTab[i] = (HccrProfessionalType) object.modelToXml();
                i = i + 1;
            }
        ...
        if (careServices != null) {
            ...
            while (careServicesIt.hasNext()) {
                HccrCareService object = (HccrCareService) careServicesIt.next();
                careServicesTypeTab[i] = (HccrCareServiceType) object.modelToXml();
                i = i + 1;
            }
        ...
        if (otherBenefits != null) {
            ...
            while (otherBenefitsIt.hasNext()) {
                HccrOtherBenefit object = (HccrOtherBenefit) otherBenefitsIt.next();
                otherBenefitsTypeTab[i] = (HccrOtherBenefitType) object.modelToXml();
                i = i + 1;
            }
    ...
    public static HandicapCompensationChildRequest xmlToModel(HandicapCompensationChildRequestDocument handicapCompensationChildRequestDoc) {
        ...
        if ( handicapCompensationChildRequestXml.sizeOfFamilyDependentsArray() > 0) {
            for (int i = 0; i < handicapCompensationChildRequestXml.getFamilyDependentsArray().length; i++) {
                familyDependentsList.add(HccrFamilyDependent.xmlToModel(handicapCompensationChildRequestXml.getFamilyDependentsArray(i)));
            }
        }
        ...
        if ( handicapCompensationChildRequestXml.sizeOfOtherFoldersArray() > 0) {
            for (int i = 0; i < handicapCompensationChildRequestXml.getOtherFoldersArray().length; i++) {
                otherFoldersList.add(HccrOtherFolder.xmlToModel(handicapCompensationChildRequestXml.getOtherFoldersArray(i)));
            }
        }
        ...
        if ( handicapCompensationChildRequestXml.sizeOfHomeIntervenantsArray() > 0) {
            for (int i = 0; i < handicapCompensationChildRequestXml.getHomeIntervenantsArray().length; i++) {
                homeIntervenantsList.add(HccrHomeIntervenant.xmlToModel(handicapCompensationChildRequestXml.getHomeIntervenantsArray(i)));
            }
        }
        ...
        if ( handicapCompensationChildRequestXml.sizeOfAdditionalFeeArray() > 0) {
            for (int i = 0; i < handicapCompensationChildRequestXml.getAdditionalFeeArray().length; i++) {
                additionalFeeList.add(HccrAdditionalFee.xmlToModel(handicapCompensationChildRequestXml.getAdditionalFeeArray(i)));
            }
        }
        ...
        if ( handicapCompensationChildRequestXml.sizeOfFamilyAssistanceMembersArray() > 0) {
            for (int i = 0; i < handicapCompensationChildRequestXml.getFamilyAssistanceMembersArray().length; i++) {
                familyAssistanceMembersList.add(HccrFamilyAssistanceMember.xmlToModel(handicapCompensationChildRequestXml.getFamilyAssistanceMembersArray(i)));
            }
        }
        ...
        if ( handicapCompensationChildRequestXml.sizeOfProfessionalsArray() > 0) {
            for (int i = 0; i < handicapCompensationChildRequestXml.getProfessionalsArray().length; i++) {
                professionalsList.add(HccrProfessional.xmlToModel(handicapCompensationChildRequestXml.getProfessionalsArray(i)));
            }
        }
        ...
        if ( handicapCompensationChildRequestXml.sizeOfCareServicesArray() > 0) {
            for (int i = 0; i < handicapCompensationChildRequestXml.getCareServicesArray().length; i++) {
                careServicesList.add(HccrCareService.xmlToModel(handicapCompensationChildRequestXml.getCareServicesArray(i)));
            }
        }
        ...
        if ( handicapCompensationChildRequestXml.sizeOfOtherBenefitsArray() > 0) {
            for (int i = 0; i < handicapCompensationChildRequestXml.getOtherBenefitsArray().length; i++) {
                otherBenefitsList.add(HccrOtherBenefit.xmlToModel(handicapCompensationChildRequestXml.getOtherBenefitsArray(i)));
            }
        }
