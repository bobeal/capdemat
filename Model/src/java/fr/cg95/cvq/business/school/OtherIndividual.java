...
public class OtherIndividual implements Serializable {
    ...
    public static fr.cg95.cvq.xml.school.OtherIndividualType modelToXml(OtherIndividual otherIndividual) {

        fr.cg95.cvq.xml.school.OtherIndividualType otherIndividualType =
            fr.cg95.cvq.xml.school.OtherIndividualType.Factory.newInstance();
        ...
        otherIndividualType.setType(fr.cg95.cvq.xml.school.SchoolOtherIndividualType.Enum.forString(otherIndividual.getType().toString()));

        return otherIndividualType;
    }

    public static OtherIndividual xmlToModel(fr.cg95.cvq.xml.school.OtherIndividualType otherIndividualType) {
