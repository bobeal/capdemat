...
public class HandicapAllowanceRequest extends Request implements Serializable { 
    ...
    public final XmlObject modelToXml() {
        ...
        if (familyDependents != null) {
            fr.cg95.cvq.xml.social.HarFamilyDependentType[] familyDependentsTypeTab = new fr.cg95.cvq.xml.social.HarFamilyDependentType[familyDependents.size()];
        ...
        if (this.paymentAgencyBeneficiary != null)
            paymentAgencyTypePaymentAgency.setPaymentAgencyBeneficiary(fr.cg95.cvq.xml.social.HarPaymentAgencyBeneficiaryType.Enum.forString(this.paymentAgencyBeneficiary.toString()));
        ...
        if (this.requestInformationRequesterProfile != null)
            requestInformationTypeRequestInformation.setRequestInformationRequesterProfile(fr.cg95.cvq.xml.social.HarRequestInformationProfileType.Enum.forString(this.requestInformationRequesterProfile.toString()));
        if (this.requestInformationKind != null)
            requestInformationTypeRequestInformation.setRequestInformationKind(fr.cg95.cvq.xml.social.HarRequestInformationKindType.Enum.forString(this.requestInformationKind.toString()));
        ...
        if (this.adultLegalAccessKind != null)
            adultLegalAccessTypeAdultLegalAccess.setAdultLegalAccessKind(fr.cg95.cvq.xml.social.HarAdultLegalAccessKindType.Enum.forString(this.adultLegalAccessKind.toString()));
        ...
        if (this.dwellingReceptionType != null)
            dwellingTypeDwelling.setDwellingReceptionType(fr.cg95.cvq.xml.social.HarDwellingReceptionType.Enum.forString(this.dwellingReceptionType.toString()));
        ...
        if (this.dwellingReceptionNaming != null)
            dwellingTypeDwelling.setDwellingReceptionNaming(fr.cg95.cvq.xml.social.HarDwellingReceptionType.Enum.forString(this.dwellingReceptionNaming.toString()));
        ...
        if (this.adultLegalAccessRepresentativeKind != null)
            adultLegalAccessTypeAdultLegalAccess.setAdultLegalAccessRepresentativeKind(fr.cg95.cvq.xml.social.HarAdultLegalAccessRepresentativeKindType.Enum.forString(this.adultLegalAccessRepresentativeKind.toString()));
        ...
        if (this.lessThan20ParentalAuthorityHolder != null)
            lessThan20ParentalAuthorityTypeLessThan20ParentalAuthority.setLessThan20ParentalAuthorityHolder(fr.cg95.cvq.xml.social.HarLessThan20ParentalAuthorityHolderType.Enum.forString(this.lessThan20ParentalAuthorityHolder.toString()));
        ...
        if (this.socialSecurityMemberShipKind != null)
            socialSecurityTypeSocialSecurity.setSocialSecurityMemberShipKind(fr.cg95.cvq.xml.social.HarSocialSecurityMemberShipKindType.Enum.forString(this.socialSecurityMemberShipKind.toString()));
        ...
        if (this.dwellingKind != null)
            dwellingTypeDwelling.setDwellingKind(fr.cg95.cvq.xml.social.HarDwellingKindType.Enum.forString(this.dwellingKind.toString()));
    ...
    public static HandicapAllowanceRequest xmlToModel(HandicapAllowanceRequestDocument handicapAllowanceRequestDoc) {
        ...
        if (handicapAllowanceRequestXml.getPaymentAgency().getPaymentAgencyBeneficiary() != null)
            handicapAllowanceRequest.setPaymentAgencyBeneficiary(fr.cg95.cvq.business.social.HarPaymentAgencyBeneficiaryType.forString(handicapAllowanceRequestXml.getPaymentAgency().getPaymentAgencyBeneficiary().toString()));
        else
            handicapAllowanceRequest.setPaymentAgencyBeneficiary(fr.cg95.cvq.business.social.HarPaymentAgencyBeneficiaryType.getDefaultHarPaymentAgencyBeneficiaryType());
        ...
        if (handicapAllowanceRequestXml.getRequestInformation().getRequestInformationRequesterProfile() != null)
            handicapAllowanceRequest.setRequestInformationRequesterProfile(fr.cg95.cvq.business.social.HarRequestInformationProfileType.forString(handicapAllowanceRequestXml.getRequestInformation().getRequestInformationRequesterProfile().toString()));
        else
            handicapAllowanceRequest.setRequestInformationRequesterProfile(fr.cg95.cvq.business.social.HarRequestInformationProfileType.getDefaultHarRequestInformationProfileType());
        if (handicapAllowanceRequestXml.getRequestInformation().getRequestInformationKind() != null)
            handicapAllowanceRequest.setRequestInformationKind(fr.cg95.cvq.business.social.HarRequestInformationKindType.forString(handicapAllowanceRequestXml.getRequestInformation().getRequestInformationKind().toString()));
        else
            handicapAllowanceRequest.setRequestInformationKind(fr.cg95.cvq.business.social.HarRequestInformationKindType.getDefaultHarRequestInformationKindType());
        ...
        if (handicapAllowanceRequestXml.getAdultLegalAccess().getAdultLegalAccessKind() != null)
            handicapAllowanceRequest.setAdultLegalAccessKind(fr.cg95.cvq.business.social.HarAdultLegalAccessKindType.forString(handicapAllowanceRequestXml.getAdultLegalAccess().getAdultLegalAccessKind().toString()));
        else
            handicapAllowanceRequest.setAdultLegalAccessKind(fr.cg95.cvq.business.social.HarAdultLegalAccessKindType.getDefaultHarAdultLegalAccessKindType());
        ...
        if (handicapAllowanceRequestXml.getDwelling().getDwellingReceptionType() != null)
            handicapAllowanceRequest.setDwellingReceptionType(fr.cg95.cvq.business.social.HarDwellingReceptionType.forString(handicapAllowanceRequestXml.getDwelling().getDwellingReceptionType().toString()));
        else
            handicapAllowanceRequest.setDwellingReceptionType(fr.cg95.cvq.business.social.HarDwellingReceptionType.getDefaultHarDwellingReceptionType());
        ...
        if (handicapAllowanceRequestXml.getDwelling().getDwellingReceptionNaming() != null)
            handicapAllowanceRequest.setDwellingReceptionNaming(fr.cg95.cvq.business.social.HarDwellingReceptionType.forString(handicapAllowanceRequestXml.getDwelling().getDwellingReceptionNaming().toString()));
        else
            handicapAllowanceRequest.setDwellingReceptionNaming(fr.cg95.cvq.business.social.HarDwellingReceptionType.getDefaultHarDwellingReceptionType());
        ...
        if (handicapAllowanceRequestXml.getAdultLegalAccess().getAdultLegalAccessRepresentativeKind() != null)
            handicapAllowanceRequest.setAdultLegalAccessRepresentativeKind(fr.cg95.cvq.business.social.HarAdultLegalAccessRepresentativeKindType.forString(handicapAllowanceRequestXml.getAdultLegalAccess().getAdultLegalAccessRepresentativeKind().toString()));
        else
            handicapAllowanceRequest.setAdultLegalAccessRepresentativeKind(fr.cg95.cvq.business.social.HarAdultLegalAccessRepresentativeKindType.getDefaultHarAdultLegalAccessRepresentativeKindType());
        ...
        if (handicapAllowanceRequestXml.getLessThan20ParentalAuthority().getLessThan20ParentalAuthorityHolder() != null)
            handicapAllowanceRequest.setLessThan20ParentalAuthorityHolder(fr.cg95.cvq.business.social.HarLessThan20ParentalAuthorityHolderType.forString(handicapAllowanceRequestXml.getLessThan20ParentalAuthority().getLessThan20ParentalAuthorityHolder().toString()));
        else
            handicapAllowanceRequest.setLessThan20ParentalAuthorityHolder(fr.cg95.cvq.business.social.HarLessThan20ParentalAuthorityHolderType.getDefaultHarLessThan20ParentalAuthorityHolderType());
        ...
        if (handicapAllowanceRequestXml.getSocialSecurity().getSocialSecurityMemberShipKind() != null)
            handicapAllowanceRequest.setSocialSecurityMemberShipKind(fr.cg95.cvq.business.social.HarSocialSecurityMemberShipKindType.forString(handicapAllowanceRequestXml.getSocialSecurity().getSocialSecurityMemberShipKind().toString()));
        else
            handicapAllowanceRequest.setSocialSecurityMemberShipKind(fr.cg95.cvq.business.social.HarSocialSecurityMemberShipKindType.getDefaultHarSocialSecurityMemberShipKindType());
        ...
        if (handicapAllowanceRequestXml.getDwelling().getDwellingKind() != null)
            handicapAllowanceRequest.setDwellingKind(fr.cg95.cvq.business.social.HarDwellingKindType.forString(handicapAllowanceRequestXml.getDwelling().getDwellingKind().toString()));
        else
            handicapAllowanceRequest.setDwellingKind(fr.cg95.cvq.business.social.HarDwellingKindType.getDefaultHarDwellingKindType());
     ...
     *  class="fr.cg95.cvq.business.social.HarFamilyDependent"
     */
    ...
    private fr.cg95.cvq.business.social.HarPaymentAgencyBeneficiaryType paymentAgencyBeneficiary;

    public final void setPaymentAgencyBeneficiary(final fr.cg95.cvq.business.social.HarPaymentAgencyBeneficiaryType paymentAgencyBeneficiary) {
     ...
     */
    public final fr.cg95.cvq.business.social.HarPaymentAgencyBeneficiaryType getPaymentAgencyBeneficiary() {
    ...
    private fr.cg95.cvq.business.social.HarRequestInformationProfileType requestInformationRequesterProfile;

    public final void setRequestInformationRequesterProfile(final fr.cg95.cvq.business.social.HarRequestInformationProfileType requestInformationRequesterProfile) {
     ...
     */
    public final fr.cg95.cvq.business.social.HarRequestInformationProfileType getRequestInformationRequesterProfile() {
        return this.requestInformationRequesterProfile;
    }

    private fr.cg95.cvq.business.social.HarRequestInformationKindType requestInformationKind;

    public final void setRequestInformationKind(final fr.cg95.cvq.business.social.HarRequestInformationKindType requestInformationKind) {
     ...
     */
    public final fr.cg95.cvq.business.social.HarRequestInformationKindType getRequestInformationKind() {
    ...
    private fr.cg95.cvq.business.social.HarAdultLegalAccessKindType adultLegalAccessKind;

    public final void setAdultLegalAccessKind(final fr.cg95.cvq.business.social.HarAdultLegalAccessKindType adultLegalAccessKind) {
     ...
     */
    public final fr.cg95.cvq.business.social.HarAdultLegalAccessKindType getAdultLegalAccessKind() {
    ...
    private fr.cg95.cvq.business.social.HarDwellingReceptionType dwellingReceptionType;

    public final void setDwellingReceptionType(final fr.cg95.cvq.business.social.HarDwellingReceptionType dwellingReceptionType) {
     ...
     */
    public final fr.cg95.cvq.business.social.HarDwellingReceptionType getDwellingReceptionType() {
    ...
    private fr.cg95.cvq.business.social.HarDwellingReceptionType dwellingReceptionNaming;

    public final void setDwellingReceptionNaming(final fr.cg95.cvq.business.social.HarDwellingReceptionType dwellingReceptionNaming) {
     ...
     */
    public final fr.cg95.cvq.business.social.HarDwellingReceptionType getDwellingReceptionNaming() {
    ...
    private fr.cg95.cvq.business.social.HarAdultLegalAccessRepresentativeKindType adultLegalAccessRepresentativeKind;

    public final void setAdultLegalAccessRepresentativeKind(final fr.cg95.cvq.business.social.HarAdultLegalAccessRepresentativeKindType adultLegalAccessRepresentativeKind) {
     ...
     */
    public final fr.cg95.cvq.business.social.HarAdultLegalAccessRepresentativeKindType getAdultLegalAccessRepresentativeKind() {
    ...
    private fr.cg95.cvq.business.social.HarLessThan20ParentalAuthorityHolderType lessThan20ParentalAuthorityHolder;

    public final void setLessThan20ParentalAuthorityHolder(final fr.cg95.cvq.business.social.HarLessThan20ParentalAuthorityHolderType lessThan20ParentalAuthorityHolder) {
     ...
     */
    public final fr.cg95.cvq.business.social.HarLessThan20ParentalAuthorityHolderType getLessThan20ParentalAuthorityHolder() {
    ...
    private fr.cg95.cvq.business.social.HarSocialSecurityMemberShipKindType socialSecurityMemberShipKind;

    public final void setSocialSecurityMemberShipKind(final fr.cg95.cvq.business.social.HarSocialSecurityMemberShipKindType socialSecurityMemberShipKind) {
     ...
     */
    public final fr.cg95.cvq.business.social.HarSocialSecurityMemberShipKindType getSocialSecurityMemberShipKind() {
    ...
    private fr.cg95.cvq.business.social.HarDwellingKindType dwellingKind;

    public final void setDwellingKind(final fr.cg95.cvq.business.social.HarDwellingKindType dwellingKind) {
     ...
     */
    public final fr.cg95.cvq.business.social.HarDwellingKindType getDwellingKind() {
