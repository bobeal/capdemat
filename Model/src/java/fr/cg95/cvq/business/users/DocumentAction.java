...
public class DocumentAction implements Serializable {
    ...
    /** full constructor */
    public DocumentAction(Long agentId, String label, String note, Date date, fr.cg95.cvq.business.users.DocumentState resultingState, fr.cg95.cvq.business.users.Document document) {
