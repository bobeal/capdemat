...
public abstract class Request implements Serializable {
    ...
    /** full constructor */
    public Request(Date creationDate, Date lastModificationDate, RequestState state, DataState dataState, MeansOfContact meansOfContact, RequestStep step, Adult requester, RequestType requestType, Set documents, Set actions, Set notes, HomeFolder homeFolder) {
     ...
     *  class="fr.cg95.cvq.business.users.RequestAction"
     */
     ...
     *  column="request_id"
     * @hibernate.one-to-many
     *  class="fr.cg95.cvq.business.users.RequestNote"
     */
    public Set getNotes() {
        return this.notes;
    }
