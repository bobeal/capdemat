...
public class SmsNotificationRequestServiceTest extends ServiceTestCase {
	...
	request.setRequester(homeFolder.getHomeFolderResponsible());
        ...
        Set authorizedSubjects = iSmsNotificationRequestService.getAuthorizedSubjects(homeFolderId).keySet();

	SmsNotificationRequestDocument requestDoc =
		(SmsNotificationRequestDocument) request.modelToXml();
	Long requestId = iSmsNotificationRequestService.create(requestDoc.getDomNode());

        // close current session and re-open a new one
        continueWithNewTransaction();
        
        Map newAuthorizedSubjectsMap = iSmsNotificationRequestService.getAuthorizedSubjects(homeFolderId);
	...
	startTransaction();
        ...
        SmsNotificationRequestDocument requestDoc = 
            (SmsNotificationRequestDocument) request.modelToXml();
        Long requestId =
             iSmsNotificationRequestService.create(requestDoc.getDomNode());
