...
public class BirthDetailsRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = getApplicationBean("birthDetailsRequestService");
    }
    ...
    public void testWithHomeFolderPojo()
        ...
        BirthDetailsRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request);
        BirthDetailsRequest requestFromDb = (BirthDetailsRequest) requestSearchService.getById(requestId);
