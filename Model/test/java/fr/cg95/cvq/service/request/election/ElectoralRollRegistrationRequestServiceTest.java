...
public class ElectoralRollRegistrationRequestServiceTest extends RequestTestCase {
    ...
    @Resource(name="electoralRollRegistrationRequestService")
    ...
    protected ElectoralRollRegistrationRequest fillMeARequest() {
        ElectoralRollRegistrationRequest request = new ElectoralRollRegistrationRequest();
              ...
              if ("SubjectOldCity".length() > 5)
                ...
                request.setSubjectAddressOutsideCity(BusinessObjectsFactory.gimmeAddress("1", "Unit test address", "Paris", "75012"));
    ...
    public void testWithHomeFolderPojo()
        ...
        ElectoralRollRegistrationRequest requestFromDb = (ElectoralRollRegistrationRequest) requestSearchService.getById(requestId, true);
