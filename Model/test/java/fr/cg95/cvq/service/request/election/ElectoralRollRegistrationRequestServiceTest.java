...
public class ElectoralRollRegistrationRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = getApplicationBean("electoralRollRegistrationRequestService");
    }
    ...
    protected ElectoralRollRegistrationRequest fillMeARequest() {
        ElectoralRollRegistrationRequest request = new ElectoralRollRegistrationRequest();
              ...
              if ("SubjectOldCity".length() > 5)
                ...
                request.setSubjectAddressOutsideCity(BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012"));
    ...
    public void testWithHomeFolderPojo()
        ...
        ElectoralRollRegistrationRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request);
        ElectoralRollRegistrationRequest requestFromDb = (ElectoralRollRegistrationRequest) requestSearchService.getById(requestId);
    ...
    public void testWithoutHomeFolder()
        ...
        ElectoralRollRegistrationRequestFeeder
