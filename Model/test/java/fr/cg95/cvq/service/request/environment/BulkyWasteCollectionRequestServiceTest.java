...
public class BulkyWasteCollectionRequestServiceTest extends ServiceTestCase {
    ...
    protected void onSetUp() throws Exception {
        ...
        iBulkyWasteCollectionRequestService = 
            (IBulkyWasteCollectionRequestService) cac.getBean(StringUtils.uncapitalize("BulkyWasteCollectionRequest") + "Service");
    }
    ...
    protected void completeValidateAndDelete(BulkyWasteCollectionRequest request) 
        ...
        iBulkyWasteCollectionRequestService.complete(request.getId());
        iBulkyWasteCollectionRequestService.validate(request.getId());
	...
	request.setRequester(homeFolder.getHomeFolderResponsible());
        BulkyWasteCollectionRequestFeeder.setSubject(request, homeFolder);

        Set authorizedSubjects = iBulkyWasteCollectionRequestService.getAuthorizedSubjects(homeFolderId).keySet();

	BulkyWasteCollectionRequestDocument requestDoc =
		(BulkyWasteCollectionRequestDocument) request.modelToXml();
	Long requestId = iBulkyWasteCollectionRequestService.create(requestDoc.getDomNode());

        // close current session and re-open a new one
        continueWithNewTransaction();
        
        Map newAuthorizedSubjectsMap = iBulkyWasteCollectionRequestService.getAuthorizedSubjects(homeFolderId);
	...
	startTransaction();
        ...
        BulkyWasteCollectionRequestFeeder.setSubject(request, null);

        BulkyWasteCollectionRequestDocument requestDoc = 
            (BulkyWasteCollectionRequestDocument) request.modelToXml();
        Long requestId =
             iBulkyWasteCollectionRequestService.create(requestDoc.getDomNode());
