...
public class LibraryRegistrationRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = getApplicationBean("libraryRegistrationRequestService");
    }
    ...
    public void testWithHomeFolderPojo()
        ...
        LibraryRegistrationRequest requestFromDb = (LibraryRegistrationRequest) requestSearchService.getById(requestId);
