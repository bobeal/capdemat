 ...
 */
public class MusicSchoolRegistrationRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = getApplicationBean("musicSchoolRegistrationRequestService");
    }
    ...
    public void testWithHomeFolderPojo()
        ...
        MusicSchoolRegistrationRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request);
        MusicSchoolRegistrationRequest requestFromDb = (MusicSchoolRegistrationRequest) requestSearchService.getById(requestId);
    ...
    public void testWithoutHomeFolder()
        ...
        MusicSchoolRegistrationRequestFeeder
