 ...
 */
public class HolidaySecurityRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = getApplicationBean("holidaySecurityRequestService");
    }

    protected HolidaySecurityRequest fillMeARequest() {
    ...
    public void testWithHomeFolderPojo()
        ...
        HolidaySecurityRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request);
        HolidaySecurityRequest requestFromDb = (HolidaySecurityRequest) requestSearchService.getById(requestId);
