 ...
 */
public class HomeEmergencyRegistrationRequestServiceTest extends RequestTestCase {
    
    @Resource(name="homeEmergencyRegistrationRequestService")
    protected IRequestService requestService;

    protected HomeEmergencyRegistrationRequest fillMeARequest() {
        HomeEmergencyRegistrationRequest request = new HomeEmergencyRegistrationRequest();
        ...
        HomeEmergencyRegistrationRequestFeeder.feed(request);
        return request;
    }

    protected void completeValidateAndDelete(HomeEmergencyRegistrationRequest request)
    ...
    public void testWithHomeFolderPojo()
        ...
        //////////////////////////////
        HomeEmergencyRegistrationRequest request = fillMeARequest();
