 ...
 */
public class LearningActivitiesDiscoveryRegistrationRequestServiceTest extends RequestTestCase {
    
    @Resource(name="learningActivitiesDiscoveryRegistrationRequestService")
    protected IRequestService requestService;

    protected LearningActivitiesDiscoveryRegistrationRequest fillMeARequest() {
        LearningActivitiesDiscoveryRegistrationRequest request = new LearningActivitiesDiscoveryRegistrationRequest();
        ...
        LearningActivitiesDiscoveryRegistrationRequestFeeder.feed(request);
        return request;
    }

    protected void completeValidateAndDelete(LearningActivitiesDiscoveryRegistrationRequest request)
    ...
    public void testWithHomeFolderPojo()
        ...
        //////////////////////////////
        LearningActivitiesDiscoveryRegistrationRequest request = fillMeARequest();
        request.setRequesterId(SecurityContext.getCurrentUserId());
        request.setHomeFolderId(homeFolderId);
        LearningActivitiesDiscoveryRegistrationRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request, null);
        LearningActivitiesDiscoveryRegistrationRequest requestFromDb = (LearningActivitiesDiscoveryRegistrationRequest) requestSearchService.getById(requestId, true);
    ...
    public void testWithoutHomeFolder()
        ...
        LearningActivitiesDiscoveryRegistrationRequestFeeder
