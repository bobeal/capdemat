...
public class RecreationActivityRegistrationRequestServiceTest extends RequestTestCase {
    ...
    @Resource(name="recreationActivityRegistrationRequestService")
    ...
    public void testWithHomeFolderPojo()
        ...
        RecreationActivityRegistrationRequest requestFromDb = (RecreationActivityRegistrationRequest) requestSearchService.getById(requestId, true);
