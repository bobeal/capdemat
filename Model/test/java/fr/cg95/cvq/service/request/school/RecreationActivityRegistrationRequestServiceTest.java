...
public class RecreationActivityRegistrationRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = getApplicationBean("recreationActivityRegistrationRequestService");
    }
    ...
    public void testWithHomeFolderPojo()
        ...
        RecreationActivityRegistrationRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request);
        RecreationActivityRegistrationRequest requestFromDb = (RecreationActivityRegistrationRequest) requestSearchService.getById(requestId);
    ...
    public void testWithoutHomeFolder()
        ...
        RecreationActivityRegistrationRequestFeeder
