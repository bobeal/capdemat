...
public class SchoolCanteenRegistrationRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = 
            getApplicationBean(StringUtils.uncapitalize("SchoolCanteenRegistrationRequest") + "Service");
    }
    ...
    public void testWithHomeFolderPojo()
         ...
         SchoolCanteenRegistrationRequest requestFromDb =
        	 	(SchoolCanteenRegistrationRequest) requestSearchService.getById(requestId);
