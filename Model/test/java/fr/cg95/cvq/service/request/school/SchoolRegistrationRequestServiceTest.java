...
public class SchoolRegistrationRequestServiceTest extends RequestTestCase {
    ...
    public void testWithHomeFolderPojo()
        ...
        SchoolRegistrationRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request);
        SchoolRegistrationRequest requestFromDb = (SchoolRegistrationRequest) requestSearchService.getById(requestId, true);
    ...
    public void testWithoutHomeFolder()
        ...
        SchoolRegistrationRequestFeeder
