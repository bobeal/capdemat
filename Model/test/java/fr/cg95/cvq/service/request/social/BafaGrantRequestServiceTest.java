        ...
        BafaGrantRequest request = new BafaGrantRequest();
              ...
              if ("AccountHolderFirstName".length() > 38)
               ...
               request.setAccountHolderEdemandeId("AccountHolderEdemandeId");
                ...
                request.setInternshipInstituteAddress(BusinessObjectsFactory.gimmeAddress("1", "Unit test address", "Paris", "75012"));
              ...
              if ("SubjectBirthCity".length() > 32)
               ...
               request.setInternshipInstituteName("InternshipInstituteName");
              ...
              if ("AccountHolderLastName".length() > 38)
                ...
                request.setSubjectAddress(BusinessObjectsFactory.gimmeAddress("1", "Unit test address", "Paris", "75012"));
