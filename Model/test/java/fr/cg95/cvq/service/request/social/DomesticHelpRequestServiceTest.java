...
public class DomesticHelpRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = getApplicationBean("domesticHelpRequestService");
    }
    ...
    public void testWithHomeFolderPojo()
        ...
        DomesticHelpRequest requestFromDb = (DomesticHelpRequest) requestSearchService.getById(requestId);
