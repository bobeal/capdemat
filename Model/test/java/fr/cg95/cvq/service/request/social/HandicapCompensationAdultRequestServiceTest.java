...
public class HandicapCompensationAdultRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = getApplicationBean("handicapCompensationAdultRequestService");
    }
    ...
    public void testWithHomeFolderPojo()
        ...
        HandicapCompensationAdultRequest requestFromDb = (HandicapCompensationAdultRequest) requestSearchService.getById(requestId);
