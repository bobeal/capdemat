...
import fr.cg95.cvq.business.request.social.HcarDwellingReceptionKindType;
import fr.cg95.cvq.business.request.social.HcarLegalAccessKindType;
...
import fr.cg95.cvq.business.request.social.HcarProfessionalStatusEnvironmentType;
 ...
 */
public class HandicapCompensationAdultRequestServiceTest extends ServiceTestCase {

    protected IHandicapCompensationAdultRequestService iHandicapCompensationAdultRequestService;

    @Override
    protected void onSetUp() throws Exception {
    	super.onSetUp();
        iHandicapCompensationAdultRequestService = 
            (IHandicapCompensationAdultRequestService) getBean(StringUtils.uncapitalize("HandicapCompensationAdultRequest") + "Service");
    }
    ...
    protected HandicapCompensationAdultRequest fillMeARequest() {
        ...
        request.setFormationCurrentFormation("FormationCurrentFormation");
                request.setStudiesAssistanceUnderDisability(Boolean.valueOf(true));
                            Address ProfessionalSupportSocialServiceAddress = BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012");
            request.setProfessionalSupportSocialServiceAddress(ProfessionalSupportSocialServiceAddress);
    ...
    protected void completeValidateAndDelete(HandicapCompensationAdultRequest request) 
        ...
        iHandicapCompensationAdultRequestService.addDocument(request.getId(), documentId);
        Set<RequestDocument> documentsSet =
            iHandicapCompensationAdultRequestService.getAssociatedDocuments(request.getId());
        ...
        // delete request
        iHandicapCompensationAdultRequestService.delete(request.getId());
    }
    ...
    public void testWithHomeFolderPojo()
         ...
         HandicapCompensationAdultRequestFeeder.setSubject(request, 
             iHandicapCompensationAdultRequestService.getSubjectPolicy(), null, homeFolder);
         
         Long requestId =
              iHandicapCompensationAdultRequestService.create(request);

         HandicapCompensationAdultRequest requestFromDb =
        	 	(HandicapCompensationAdultRequest) iHandicapCompensationAdultRequestService.getById(requestId);
    ...
    public void testWithoutHomeFolder()
        throws CvqException, CvqObjectNotFoundException,
	      ...
	      if (!iHandicapCompensationAdultRequestService.supportUnregisteredCreation())
	         return;
        ...
        HandicapCompensationAdultRequestFeeder.setSubject(request, 
            iHandicapCompensationAdultRequestService.getSubjectPolicy(), requester, null);

        Long requestId =
             iHandicapCompensationAdultRequestService.create(request, requester, requester);
