...
public class HandicapCompensationAdultRequestServiceTest extends ServiceTestCase {
    ...
    protected HandicapCompensationAdultRequest fillMeARequest() throws CvqException {
    ...
    protected void completeValidateAndDelete(HandicapCompensationAdultRequest request) 
        ...
        iHandicapCompensationAdultRequestService.complete(request.getId());
        iHandicapCompensationAdultRequestService.validate(request.getId());
