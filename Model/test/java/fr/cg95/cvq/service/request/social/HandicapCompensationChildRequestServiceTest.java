...
import fr.cg95.cvq.business.request.social.HccrDwellingReceptionKindType;
import fr.cg95.cvq.business.request.social.HccrHomeSchoolingKindType;
import fr.cg95.cvq.business.request.social.HccrPaymentAgencyBeneficiaryType;
import fr.cg95.cvq.business.request.social.HccrProfessionalStatusEnvironmentType;
import fr.cg95.cvq.business.request.social.HccrProfessionalStatusKindType;
import fr.cg95.cvq.business.request.social.HccrSchoolingKindType;
import fr.cg95.cvq.business.request.social.HccrSocialSecurityMemberShipKindType;
import fr.cg95.cvq.business.request.social.HccrSubjectParentalAuthorityHolderType;
 ...
 */
public class HandicapCompensationChildRequestServiceTest extends ServiceTestCase {

    protected IHandicapCompensationChildRequestService iHandicapCompensationChildRequestService;

    @Override
    protected void onSetUp() throws Exception {
    	super.onSetUp();
        iHandicapCompensationChildRequestService = 
            (IHandicapCompensationChildRequestService) getBean(StringUtils.uncapitalize("HandicapCompensationChildRequest") + "Service");
    }
    ...
    protected HandicapCompensationChildRequest fillMeARequest() {
        ...
        request.setFatherFirstName("FatherFirstName");
                                Address SchoolingHomeSchoolingAccompanistAddress = BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012");
            request.setSchoolingHomeSchoolingAccompanistAddress(SchoolingHomeSchoolingAccompanistAddress);
        ...
        request.setSchoolingSchoolName("SchoolingSchoolName");
                                Address DwellingSocialReceptionAddress = BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012");
            request.setDwellingSocialReceptionAddress(DwellingSocialReceptionAddress);
        ...
        request.setMotherJob("MotherJob");
                                Address SchoolingSchoolAddress = BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012");
            request.setSchoolingSchoolAddress(SchoolingSchoolAddress);
        ...
        request.setHealthDoctorLastName("HealthDoctorLastName");
                                Address SocialServiceAddress = BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012");
            request.setSocialServiceAddress(SocialServiceAddress);
        ...
        request.setStudiesAssistanceUnderDisabilityDetails("StudiesAssistanceUnderDisabilityDetails");
                                Address PaymentAgencyAddress = BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012");
            request.setPaymentAgencyAddress(PaymentAgencyAddress);
            ...
            request.setProjectRequestsDisabilityCostAllocation(Boolean.valueOf(true));
                            Address SocialSecurityAgencyAddress = BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012");
            request.setSocialSecurityAgencyAddress(SocialSecurityAgencyAddress);
    	                                Address ProfessionalStatusAddress = BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012");
            request.setProfessionalStatusAddress(ProfessionalStatusAddress);
        ...
        request.setProfessionalStatusProfession("ProfessionalStatusProfession");
                                Address DwellingReceptionAddress = BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012");
            request.setDwellingReceptionAddress(DwellingReceptionAddress);
        ...
        request.setProfessionalStatusElectiveFunctionDetails("ProfessionalStatusElectiveFunctionDetails");
                request.setFacilitiesAnimalAid(Boolean.valueOf(true));
                            Address StudiesHighSchoolAddress = BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012");
            request.setStudiesHighSchoolAddress(StudiesHighSchoolAddress);
    ...
    protected void completeValidateAndDelete(HandicapCompensationChildRequest request) 
        ...
        iHandicapCompensationChildRequestService.addDocument(request.getId(), documentId);
        Set<RequestDocument> documentsSet =
            iHandicapCompensationChildRequestService.getAssociatedDocuments(request.getId());
        ...
        // delete request
        iHandicapCompensationChildRequestService.delete(request.getId());
    }
    ...
    public void testWithHomeFolderPojo()
         ...
         HandicapCompensationChildRequestFeeder.setSubject(request, 
             iHandicapCompensationChildRequestService.getSubjectPolicy(), null, homeFolder);
         
         Long requestId =
              iHandicapCompensationChildRequestService.create(request);

         HandicapCompensationChildRequest requestFromDb =
        	 	(HandicapCompensationChildRequest) iHandicapCompensationChildRequestService.getById(requestId);
    ...
    public void testWithoutHomeFolder()
        throws CvqException, CvqObjectNotFoundException,
	      ...
	      if (!iHandicapCompensationChildRequestService.supportUnregisteredCreation())
	         return;
        ...
        HandicapCompensationChildRequestFeeder.setSubject(request, 
            iHandicapCompensationChildRequestService.getSubjectPolicy(), requester, null);

        Long requestId =
             iHandicapCompensationChildRequestService.create(request, requester, requester);
