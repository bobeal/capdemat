...
public class HandicapCompensationChildRequestServiceTest extends ServiceTestCase {
    ...
    protected HandicapCompensationChildRequest fillMeARequest() throws CvqException {
    ...
    protected void completeValidateAndDelete(HandicapCompensationChildRequest request) 
        ...
        iHandicapCompensationChildRequestService.complete(request.getId());
        iHandicapCompensationChildRequestService.validate(request.getId());
