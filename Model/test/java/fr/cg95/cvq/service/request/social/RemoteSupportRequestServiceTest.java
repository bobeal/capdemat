...
public class RemoteSupportRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = getApplicationBean("remoteSupportRequestService");
    }
    ...
    public void testWithHomeFolderPojo()
        ...
        RemoteSupportRequest requestFromDb = (RemoteSupportRequest) requestSearchService.getById(requestId);
