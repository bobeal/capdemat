...
public class TechnicalInterventionRequestServiceTest extends RequestTestCase {
    ...
    @Resource(name="technicalInterventionRequestService")
    ...
    protected TechnicalInterventionRequest fillMeARequest() {
        TechnicalInterventionRequest request = new TechnicalInterventionRequest();
               ...
               request.setInterventionDescription("InterventionDescription");
                ...
                request.setInterventionPlace(BusinessObjectsFactory.gimmeAddress("1", "Unit test address", "Paris", "75012"));
    ...
    public void testWithHomeFolderPojo()
        ...
        TechnicalInterventionRequest requestFromDb = (TechnicalInterventionRequest) requestSearchService.getById(requestId, true);
