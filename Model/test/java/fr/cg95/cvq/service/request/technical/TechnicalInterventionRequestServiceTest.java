 ...
 */
public class TechnicalInterventionRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = getApplicationBean("technicalInterventionRequestService");
    }

    protected TechnicalInterventionRequest fillMeARequest() {
        TechnicalInterventionRequest request = new TechnicalInterventionRequest();
               ...
               request.setInterventionDescription("InterventionDescription");
                ...
                request.setInterventionPlace(BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012"));
    ...
    public void testWithHomeFolderPojo()
        ...
        TechnicalInterventionRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request);
        TechnicalInterventionRequest requestFromDb = (TechnicalInterventionRequest) requestSearchService.getById(requestId);
    ...
    public void testWithoutHomeFolder()
        ...
        TechnicalInterventionRequestFeeder
