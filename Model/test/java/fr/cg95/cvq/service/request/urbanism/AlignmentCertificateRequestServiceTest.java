...
public class AlignmentCertificateRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = getApplicationBean("alignmentCertificateRequestService");
    }
    ...
    public void testWithHomeFolderPojo()
        ...
        AlignmentCertificateRequest requestFromDb = (AlignmentCertificateRequest) requestSearchService.getById(requestId);
