 ...
 */
public class AlignmentNumberingConnectionRequestServiceTest extends RequestTestCase {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        requestService = getApplicationBean("alignmentNumberingConnectionRequestService");
    }

    protected AlignmentNumberingConnectionRequest fillMeARequest() {
        AlignmentNumberingConnectionRequest request = new AlignmentNumberingConnectionRequest();
        ...
        AlignmentNumberingConnectionRequestFeeder.feed(request);
        return request;
    }

    protected void completeValidateAndDelete(AlignmentNumberingConnectionRequest request)
