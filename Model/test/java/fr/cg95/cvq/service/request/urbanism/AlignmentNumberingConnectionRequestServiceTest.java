 ...
 */
public class AlignmentNumberingConnectionRequestServiceTest extends ServiceTestCase {

    protected IAlignmentNumberingConnectionRequestService iAlignmentNumberingConnectionRequestService;

    protected void onSetUp() throws Exception {
    	super.onSetUp();
        iAlignmentNumberingConnectionRequestService = 
            (IAlignmentNumberingConnectionRequestService) getBean(StringUtils.uncapitalize("AlignmentNumberingConnectionRequest") + "Service");
    }

    protected AlignmentNumberingConnectionRequest fillMeARequest() throws CvqException {
        ...
        AlignmentNumberingConnectionRequest request = new AlignmentNumberingConnectionRequest();
          request.setIsNumbering(Boolean.valueOf(true));
                            Address OtherAddress = BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012");
            request.setOtherAddress(OtherAddress);
    ...
    protected void completeValidateAndDelete(AlignmentNumberingConnectionRequest request) 
        ...
        iAlignmentNumberingConnectionRequestService.addDocument(request.getId(), documentId);
        Set<RequestDocument> documentsSet =
            iAlignmentNumberingConnectionRequestService.getAssociatedDocuments(request.getId());
        ...
        // delete request
        iAlignmentNumberingConnectionRequestService.delete(request.getId());
    }
    ...
    public void testWithHomeFolderPojo()
         ...
         AlignmentNumberingConnectionRequestFeeder.setSubject(request, 
             iAlignmentNumberingConnectionRequestService.getSubjectPolicy(), null, homeFolder);
         
         Long requestId =
              iAlignmentNumberingConnectionRequestService.create(request);

         AlignmentNumberingConnectionRequest requestFromDb =
        	 	(AlignmentNumberingConnectionRequest) iAlignmentNumberingConnectionRequestService.getById(requestId);
    ...
    public void testWithoutHomeFolder()
        throws CvqException, CvqObjectNotFoundException,
	      ...
	      if (!iAlignmentNumberingConnectionRequestService.supportUnregisteredCreation())
	         return;
        ...
        AlignmentNumberingConnectionRequestFeeder.setSubject(request, 
            iAlignmentNumberingConnectionRequestService.getSubjectPolicy(), requester, null);

        Long requestId =
             iAlignmentNumberingConnectionRequestService.create(request, requester, requester);
