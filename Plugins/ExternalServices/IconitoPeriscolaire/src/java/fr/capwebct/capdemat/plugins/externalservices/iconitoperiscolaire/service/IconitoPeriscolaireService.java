...
public class IconitoPeriscolaireService extends ExternalProviderServiceAdapter {
    ...
    public Map<String, List<ExternalAccountItem>> getAccountsByHomeFolder(Long homeFolderId, 
        ...
        FamilyAccountsResponseDocument familyAccountsResponseDocument = 
            (FamilyAccountsResponseDocument) iconitoPeriscolaireServiceClient.getFamilyAccounts(farDocument);
    ...
    public void loadDepositAccountDetails(ExternalDepositAccountItem edai) throws CvqException {
        ...
        AccountDetailsResponseDocument accountDetailsDocument = (AccountDetailsResponseDocument) 
            iconitoPeriscolaireServiceClient.loadAccountDetails(accountDetailsRequestDocument);
    ...
    public void loadInvoiceDetails(ExternalInvoiceItem eii) throws CvqException {
        ...
        InvoiceDetailsResponseDocument invoiceDetailsResponseDocument = (InvoiceDetailsResponseDocument) 
            iconitoPeriscolaireServiceClient.loadInvoiceDetails(invoiceDetailsRequestDocument);
    ...
    public void creditHomeFolderAccounts(Collection<PurchaseItem> purchaseItems, String cvqReference,
        ...
        iconitoPeriscolaireServiceClient.creditAccount(creditAccountRequestDocument);
    }
    ...
    public Map<Date, String> getConsumptions(Long key, Date dateFrom, Date dateTo)
        ...
        GetConsumptionsResponseDocument getConsumptionsResponseDocument = 
            (GetConsumptionsResponseDocument) iconitoPeriscolaireServiceClient.getConsumptions(getConsumptionsRequestDocument);
    ...
    public void setIconitoPeriscolaireServiceClient(IconitoPeriscolaireServiceClient iconitoPeriscolaireServiceClient) {
        this.iconitoPeriscolaireServiceClient = iconitoPeriscolaireServiceClient;
    }
}
